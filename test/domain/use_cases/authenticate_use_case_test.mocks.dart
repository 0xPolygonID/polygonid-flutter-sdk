...
import 'package:polygonid_flutter_sdk/identity/domain/entities/private_identity_entity.dart'
    as _i5;
import 'package:polygonid_flutter_sdk/identity/domain/entities/proof_entity.dart'
    as _i7;
...
class MockIden3commRepository extends _i1.Mock
  ...
  _i3.Future<String> getAuthToken({
    ...
    required _i7.ProofEntity? gistProof,
  ...
  _i3.Future<String> getAuthResponse({
    ...
    required _i4.AuthIden3MessageEntity? request,
    required List<_i8.JWZProofEntity>? scope,
    String? pushUrl,
    String? pushToken,
...
///
/// See the documentation for Mockito's code generation for more information.
class MockGetProofsUseCase extends _i1.Mock implements _i9.GetProofsUseCase {
  MockGetProofsUseCase() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i3.Future<List<_i8.JWZProofEntity>> execute(
          {required _i9.GetProofsParam? param}) =>
      (super.noSuchMethod(
        Invocation.method(
          #execute,
          [],
        ...
        returnValue:
            _i3.Future<List<_i8.JWZProofEntity>>.value(<_i8.JWZProofEntity>[]),
      ) as _i3.Future<List<_i8.JWZProofEntity>>);
}
...
class MockGetAuthTokenUseCase extends _i1.Mock
    implements _i10.GetAuthTokenUseCase {
  MockGetAuthTokenUseCase() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i3.Future<String> execute({required _i10.GetAuthTokenParam? param}) =>
      (super.noSuchMethod(
        Invocation.method(
          #execute,
          [],
...
class MockGetEnvConfigUseCase extends _i1.Mock
    implements _i11.GetEnvConfigUseCase {
  MockGetEnvConfigUseCase() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i3.Future<String> execute({required _i11.PolygonIdConfig? param}) =>
      (super.noSuchMethod(
        Invocation.method(
          #execute,
          [],
...
class MockGetPackageNameUseCase extends _i1.Mock
    implements _i12.GetPackageNameUseCase {
...
class MockGetDidIdentifierUseCase extends _i1.Mock
    implements _i13.GetDidIdentifierUseCase {
  MockGetDidIdentifierUseCase() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i3.Future<String> execute({required _i13.GetDidIdentifierParam? param}) =>
      (super.noSuchMethod(
        Invocation.method(
          #execute,
          [],

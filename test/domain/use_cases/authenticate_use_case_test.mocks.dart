...
class MockIden3commRepository extends _i1.Mock
  ...
  @override
  _i3.Future<void> authenticate({String? url, String? authToken}) =>
      (super.noSuchMethod(
          Invocation.method(
...
class MockGetAuthTokenUseCase extends _i1.Mock
  ...
  @override
  _i3.Future<String> execute({_i9.GetAuthTokenParam? param}) =>
      (super.noSuchMethod(Invocation.method(#execute, [], {#param: param}),
          returnValue: Future<String>.value('')) as _i3.Future<String>);
}
...
class MockGetEnvConfigUseCase extends _i1.Mock
  ...
  @override
  _i3.Future<String> execute({_i10.PolygonIdConfig? param}) =>
      (super.noSuchMethod(Invocation.method(#execute, [], {#param: param}),
          returnValue: Future<String>.value('')) as _i3.Future<String>);
}
...
class MockGetPackageNameUseCase extends _i1.Mock
  ...
  @override
  _i3.Future<String> execute({dynamic param}) =>
      (super.noSuchMethod(Invocation.method(#execute, [], {#param: param}),
          returnValue: Future<String>.value('')) as _i3.Future<String>);
}
...
class MockGetDidIdentifierUseCase extends _i1.Mock
  ...
  @override
  _i3.Future<String> execute({_i12.GetDidIdentifierParam? param}) =>
      (super.noSuchMethod(Invocation.method(#execute, [], {#param: param}),
          returnValue: Future<String>.value('')) as _i3.Future<String>);
}

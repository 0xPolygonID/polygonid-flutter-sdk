...
String headerData = '{      '
    '"alg":"groth16",'
    '"circuitId":"auth",'
    '   "crit":["circuitId"],"typ":"application/iden3-zkp-json"}';
String headerBase64 =
...
void main() {
  test("Test JWZHeader encoding", () {
    JWZHeader header = JWZHeader.fromJson(json.decode(headerData));
    expect(header.encode(), headerBase64);
  });

  test("Test JWZPayload encoding", () {
    JWZPayload payload = JWZPayload.fromJson(json.decode(payloadData));
    expect(payload.encode(), payloadBase64);
  });

  test("Test JWZProof encoding", () {
    JWZProof proof = JWZProof.fromJson(json.decode(proofData));
    expect(proof.encode(), proofBase64);
  });

  test("Test JWZ encoding", () {
    JWZ jwz = JWZ(
        header: JWZHeader.fromJson(json.decode(headerData)),
        payload: JWZPayload.fromJson(json.decode(payloadData)),
        proof: JWZProof.fromJson(json.decode(proofData)));
    expect(jwz.encode(), jwzBase64);
  });
}

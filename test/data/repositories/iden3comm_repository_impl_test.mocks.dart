...
class MockJWZDataSource extends _i1.Mock implements _i8.JWZDataSource {
  ...
  _i7.Future<String> getAuthToken({
    ...
    required _i9.Uint8List? datFile,
    required _i9.Uint8List? zKeyFile,
  }) =>
      (super.noSuchMethod(
        Invocation.method(
          #getAuthToken,
...
class MockHexMapper extends _i1.Mock implements _i10.HexMapper {
  ...
  @override
  String mapFrom(_i9.Uint8List? from) => (super.noSuchMethod(
        Invocation.method(
          #mapFrom,
          [from],
        ),
  ...
  @override
  _i9.Uint8List mapTo(String? to) => (super.noSuchMethod(
        Invocation.method(
          #mapTo,
          [to],
        ),
...
class MockProofScopeDataSource extends _i1.Mock
  ...
  List<_i12.ProofScopeRequest> filteredProofScopeRequestList(
      ...
      (super.noSuchMethod(
        Invocation.method(
          #filteredProofScopeRequestList,
          [proofScopeRequestList],
        ),
  ...
  List<_i13.FilterEntity> proofScopeRulesQueryRequestFilters(
      ...
      (super.noSuchMethod(
        Invocation.method(
          #proofScopeRulesQueryRequestFilters,
          [proofScopeRulesQueryRequest],
        ),
        returnValue: <_i13.FilterEntity>[],
      ) as List<_i13.FilterEntity>);
  @override
  Map<String, dynamic> getFieldOperatorAndValues(
          _i12.ProofScopeRequest? scopeRequest) =>
      (super.noSuchMethod(
        Invocation.method(
          #getFieldOperatorAndValues,
          [scopeRequest],
        ),
...
class MockStorageClaimDataSource extends _i1.Mock
  ...
  @override
  _i7.Future<void> storeClaims({required List<_i4.ClaimDTO>? claims}) =>
      (super.noSuchMethod(
        Invocation.method(
          #storeClaims,
          [],
  ...
  @override
  _i7.Future<void> removeClaims({required List<String>? ids}) =>
      (super.noSuchMethod(
        Invocation.method(
          #removeClaims,
          [],
...
class MockFiltersMapper extends _i1.Mock implements _i17.FiltersMapper {
  ...
  @override
  _i5.Filter mapTo(List<_i13.FilterEntity>? to) => (super.noSuchMethod(
        Invocation.method(
          #mapTo,
          [to],
        ),
...
class MockAuthResponseMapper extends _i1.Mock
  ...
  @override
  String mapFrom(_i19.AuthResponse? from) => (super.noSuchMethod(
        Invocation.method(
          #mapFrom,
          [from],
        ),

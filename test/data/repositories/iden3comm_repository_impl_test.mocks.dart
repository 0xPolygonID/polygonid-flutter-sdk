...
class _FakeClaimEntity_2 extends _i1.Fake implements _i3.ClaimEntity {}

class _FakeClaimDTO_3 extends _i1.Fake implements _i4.ClaimDTO {}

class _FakeFilter_4 extends _i1.Fake implements _i5.Filter {}

class _FakeAuthRequest_5 extends _i1.Fake implements _i6.AuthRequest {}

/// A class which mocks [RemoteIden3commDataSource].
///
/// See the documentation for Mockito's code generation for more information.
class MockRemoteIden3commDataSource extends _i1.Mock
    implements _i7.RemoteIden3commDataSource {
  ...
  @override
  _i8.Future<_i2.Response> authWithToken({String? token, String? url}) =>
      (super.noSuchMethod(
...
///
/// See the documentation for Mockito's code generation for more information.
class MockJWZDataSource extends _i1.Mock implements _i9.JWZDataSource {
  MockJWZDataSource() {
    _i1.throwOnMissingStub(this);
  }
  ...
  _i8.Future<String> getAuthToken(
          {_i10.Uint8List? privateKey,
          String? authClaim,
          String? message,
          String? circuitId,
          _i10.Uint8List? datFile,
          _i10.Uint8List? zKeyFile}) =>
      (super.noSuchMethod(
...
class MockProofScopeDataSource extends _i1.Mock
    implements _i12.ProofScopeDataSource {
  ...
  Map<String, dynamic> getFieldOperatorAndValues(
          _i13.ProofScopeRequest? scopeRequest) =>
      (super.noSuchMethod(
...
class MockStorageClaimDataSource extends _i1.Mock
    implements _i14.StorageClaimDataSource {
  MockStorageClaimDataSource() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i8.Future<void> storeClaims({List<_i4.ClaimDTO>? claims}) => (super
      .noSuchMethod(Invocation.method(#storeClaims, [], {#claims: claims}),
          returnValue: Future<void>.value(),
          returnValueForMissingStub: Future<void>.value()) as _i8.Future<void>);
  @override
  _i8.Future<void> storeClaimsTransact(
          {_i5.DatabaseClient? transaction, List<_i4.ClaimDTO>? claims}) =>
      (super.noSuchMethod(
  ...
  _i8.Future<void> removeClaimsTransact(
          {_i5.DatabaseClient? transaction, List<String>? ids}) =>
      (super.noSuchMethod(
  ...
  _i8.Future<List<_i4.ClaimDTO>> getClaims({_i5.Filter? filter}) =>
      (super.noSuchMethod(Invocation.method(#getClaims, [], {#filter: filter}),
              returnValue: Future<List<_i4.ClaimDTO>>.value(<_i4.ClaimDTO>[]))
...
class MockClaimMapper extends _i1.Mock implements _i15.ClaimMapper {
  ...
  @override
  _i3.ClaimEntity mapFrom(_i4.ClaimDTO? from) =>
      (super.noSuchMethod(Invocation.method(#mapFrom, [from]),
          returnValue: _FakeClaimEntity_2()) as _i3.ClaimEntity);
  @override
  _i4.ClaimDTO mapTo(_i3.ClaimEntity? to) =>
      (super.noSuchMethod(Invocation.method(#mapTo, [to]),
          returnValue: _FakeClaimDTO_3()) as _i4.ClaimDTO);
}
...
class MockFiltersMapper extends _i1.Mock implements _i16.FiltersMapper {
  ...
  @override
  _i5.Filter mapTo(List<_i17.FilterEntity>? to) =>
      (super.noSuchMethod(Invocation.method(#mapTo, [to]),
          returnValue: _FakeFilter_4()) as _i5.Filter);
}
...
class MockAuthResponseMapper extends _i1.Mock
    implements _i18.AuthResponseMapper {
  MockAuthResponseMapper() {
    _i1.throwOnMissingStub(this);
  }

  @override
  String mapFrom(_i19.AuthResponse? from) =>
      (super.noSuchMethod(Invocation.method(#mapFrom, [from]), returnValue: '')
          as String);
}
...
///
/// See the documentation for Mockito's code generation for more information.
class MockAuthRequestMapper extends _i1.Mock implements _i20.AuthRequestMapper {
  MockAuthRequestMapper() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i6.AuthRequest mapTo(_i21.Iden3MessageEntity? to) =>
      (super.noSuchMethod(Invocation.method(#mapTo, [to]),
          returnValue: _FakeAuthRequest_5()) as _i6.AuthRequest);
}

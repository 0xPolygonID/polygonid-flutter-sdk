...
class MockStorageClaimDataSource extends _i1.Mock
  ...
  _i7.Future<void> storeClaimsTransact(
      ...
      (super.noSuchMethod(
          ...
          returnValueForMissingStub: Future<void>.value()) as _i7.Future<void>);
  @override
  _i7.Future<void> removeClaims({List<String>? ids}) =>
...
class MockFiltersMapper extends _i1.Mock implements _i15.FiltersMapper {
  ...
  @override
  _i5.Filter mapTo(List<_i16.FilterEntity>? to) =>
      (super.noSuchMethod(Invocation.method(#mapTo, [to]),
...
class MockAuthResponseMapper extends _i1.Mock
    implements _i17.AuthResponseMapper {
  MockAuthResponseMapper() {
    _i1.throwOnMissingStub(this);
  }

  @override
  String mapFrom(_i18.AuthResponse? from) =>
      (super.noSuchMethod(Invocation.method(#mapFrom, [from]), returnValue: '')
          as String);
}

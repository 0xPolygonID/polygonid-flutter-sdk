...
class _FakeWeb3Client_3 extends _i1.Fake implements _i5.Web3Client {}

class _FakeIdentityEntity_4 extends _i1.Fake implements _i6.IdentityEntity {}

class _FakeRhsNodeEntity_5 extends _i1.Fake implements _i7.RhsNodeEntity {}
...
class MockLibIdentityDataSource extends _i1.Mock
  ...
  _i9.Future<String> createSMT(
      ...
      (super.noSuchMethod(Invocation.method(#createSMT, [smtStorageRepository]),
          returnValue: Future<String>.value('')) as _i9.Future<String>);
  @override
  _i9.Future<String> getId(String? id) =>
...
class MockLocalIdentityDataSource extends _i1.Mock
  ...
  String getDidIdentifier(
          {String? identifier, String? networkName, String? networkEnv}) =>
      (super.noSuchMethod(
          Invocation.method(#getDidIdentifier, [], {
...
class MockRemoteIdentityDataSource extends _i1.Mock
  ...
  @override
  _i9.Future<_i3.RhsNodeDTO> fetchStateRoots({String? url}) =>
...
class MockStorageIdentityDataSource extends _i1.Mock
  ...
  @override
  _i9.Future<_i4.IdentityDTO> getIdentity({String? identifier}) =>
      (super.noSuchMethod(
  ...
  _i9.Future<void> storeIdentityTransact(
          {_i16.DatabaseClient? transaction,
          String? identifier,
  ...
  _i9.Future<void> removeIdentityTransact(
          {_i16.DatabaseClient? transaction, String? identifier}) =>
      (super.noSuchMethod(
...
class MockStorageKeyValueDataSource extends _i1.Mock
  ...
  @override
  _i9.Future<dynamic> get({String? key, _i16.DatabaseClient? database}) =>
      (super.noSuchMethod(
  ...
  _i9.Future<void> store(
          {String? key, dynamic value, _i16.DatabaseClient? database}) =>
      (super.noSuchMethod(
          Invocation.method(
          ...
          returnValueForMissingStub: Future<void>.value()) as _i9.Future<void>);
  @override
  _i9.Future<String?> remove({String? key, _i16.DatabaseClient? database}) =>
      (super.noSuchMethod(
...
class MockRPCDataSource extends _i1.Mock implements _i18.RPCDataSource {
  ...
  @override
  _i5.Web3Client get web3Client =>
      (super.noSuchMethod(Invocation.getter(#web3Client),
          returnValue: _FakeWeb3Client_3()) as _i5.Web3Client);
  @override
  _i9.Future<String> getState(String? id) =>
      (super.noSuchMethod(Invocation.method(#getState, [id]),
          returnValue: Future<String>.value('')) as _i9.Future<String>);
}
...
class MockIdentityDTOMapper extends _i1.Mock implements _i21.IdentityDTOMapper {
  ...
  @override
  _i6.IdentityEntity mapFrom(_i4.IdentityDTO? from) =>
      (super.noSuchMethod(Invocation.method(#mapFrom, [from]),
          returnValue: _FakeIdentityEntity_4()) as _i6.IdentityEntity);
}
...
class MockRhsNodeMapper extends _i1.Mock implements _i22.RhsNodeMapper {
  ...
  @override
  _i7.RhsNodeEntity mapFrom(_i3.RhsNodeDTO? from) =>
      (super.noSuchMethod(Invocation.method(#mapFrom, [from]),
          returnValue: _FakeRhsNodeEntity_5()) as _i7.RhsNodeEntity);
  @override
  _i3.RhsNodeDTO mapTo(_i7.RhsNodeEntity? to) =>
      (super.noSuchMethod(Invocation.method(#mapTo, [to]),

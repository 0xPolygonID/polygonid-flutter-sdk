...
// in polygonid_flutter_sdk/test/identity/domain/use_cases/identity/add_identity_use_case_test.dart.
...
/// A class which mocks [CreateIdentityUseCase].
///
/// See the documentation for Mockito's code generation for more information.
class MockCreateIdentityUseCase extends _i1.Mock
    implements _i8.CreateIdentityUseCase {
  MockCreateIdentityUseCase() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i7.Future<_i5.PrivateIdentityEntity> execute(
          {required _i8.CreateIdentityParam? param}) =>
      (super.noSuchMethod(
        Invocation.method(
          #execute,
          [],
        ...
        returnValue: _i7.Future<_i5.PrivateIdentityEntity>.value(
            _FakePrivateIdentityEntity_3(
          this,
          Invocation.method(
            #execute,
      ...
      ) as _i7.Future<_i5.PrivateIdentityEntity>);
}
...
class MockCreateIdentityStateUseCase extends _i1.Mock
  ...
  @override
  _i7.Future<void> execute({required _i9.CreateIdentityStateParam? param}) =>
      (super.noSuchMethod(
        Invocation.method(
          #execute,
          [],

...
// in polygonid_flutter_sdk/test/identity/domain/use_cases/get_identity_auth_claim_use_case_test.dart.
...
class MockGetAuthClaimUseCase extends _i1.Mock
  ...
  @override
  _i6.Future<List<String>> execute({required List<String>? param}) =>
      (super.noSuchMethod(
        Invocation.method(
          #execute,
          [],

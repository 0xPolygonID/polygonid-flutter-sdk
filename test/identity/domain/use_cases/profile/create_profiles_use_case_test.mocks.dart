...
// in polygonid_flutter_sdk/test/identity/domain/use_cases/profile/create_profiles_use_case_test.dart.
...
class MockIdentityRepository extends _i1.Mock
  ...
  @override
  _i6.Future<String> getPrivateKey({required String? secret}) =>
      (super.noSuchMethod(
        Invocation.method(
          #getPrivateKey,
          [],
  ...
  @override
  _i6.Future<void> removeIdentity({required String? genesisDid}) =>
      (super.noSuchMethod(
        Invocation.method(
          #removeIdentity,
          [],
...
class MockGetPublicKeysUseCase extends _i1.Mock
    implements _i7.GetPublicKeysUseCase {
...
class MockGetCurrentEnvDidIdentifierUseCase extends _i1.Mock
    implements _i8.GetCurrentEnvDidIdentifierUseCase {
  ...
  _i6.Future<String> execute(
          {required _i8.GetCurrentEnvDidIdentifierParam? param}) =>
      (super.noSuchMethod(
        Invocation.method(
          #execute,
          [],

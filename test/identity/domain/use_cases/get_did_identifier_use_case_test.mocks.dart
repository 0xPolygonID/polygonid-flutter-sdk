...
// in polygonid_flutter_sdk/test/identity/domain/use_cases/get_did_identifier_use_case_test.dart.
...
class _FakeTreeStateEntity_3 extends _i1.SmartFake
    implements _i5.TreeStateEntity {
  _FakeTreeStateEntity_3(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class MockGetGenesisStateUseCase extends _i1.Mock
    implements _i8.GetGenesisStateUseCase {
  MockGetGenesisStateUseCase() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i7.Future<_i5.TreeStateEntity> execute({required String? param}) =>
      (super.noSuchMethod(
        Invocation.method(
          #execute,
          [],
        ...
        returnValue:
            _i7.Future<_i5.TreeStateEntity>.value(_FakeTreeStateEntity_3(
          this,
          Invocation.method(
            #execute,
            [],
      ...
      ) as _i7.Future<_i5.TreeStateEntity>);
}

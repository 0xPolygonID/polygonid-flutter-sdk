...
// in polygonid_flutter_sdk/test/identity/data/data_sources/storage_identity_data_source_test.dart.
...
class MockWalletDataSource extends _i1.Mock implements _i9.WalletDataSource {
  ...
  @override
  _i4.Future<_i2.BjjWallet> createWallet({_i10.Uint8List? secret}) =>
      (super.noSuchMethod(
        Invocation.method(
          #createWallet,
          [],
  ...
  @override
  _i4.Future<_i2.BjjWallet> getWallet({required _i10.Uint8List? privateKey}) =>
      (super.noSuchMethod(
        Invocation.method(
          #getWallet,
          [],

...
class _FakeConnectionEntity_3 extends _i1.SmartFake
    implements _i4.ConnectionEntity {
  _FakeConnectionEntity_3(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class _FakeConnectionDTO_4 extends _i1.SmartFake implements _i5.ConnectionDTO {
  _FakeConnectionDTO_4(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class MockRemoteIden3commDataSource extends _i1.Mock
    implements _i6.RemoteIden3commDataSource {
  ...
  @override
  _i7.Future<_i2.Response> authWithToken({
  ...
  _i7.Future<_i3.ClaimDTO> fetchClaim({
    ...
    required String? did,
      ...
      (super.noSuchMethod(
        ...
        returnValue: _i7.Future<_i3.ClaimDTO>.value(_FakeClaimDTO_2(
          this,
          Invocation.method(
            #fetchClaim,
            [],
...
class MockLibPolygonIdCoreIden3commDataSource extends _i1.Mock
    implements _i8.LibPolygonIdCoreIden3commDataSource {
...
class MockLibBabyJubJubDataSource extends _i1.Mock
    implements _i9.LibBabyJubJubDataSource {
  MockLibBabyJubJubDataSource() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i7.Future<String> hashPoseidon(String? input1) => (super.noSuchMethod(
        Invocation.method(
          #hashPoseidon,
          [input1],
        ),
  ...
  @override
  _i7.Future<String> hashPoseidon2(
    String? input1,
    String? input2,
  ) =>
      (super.noSuchMethod(
  ...
  @override
  _i7.Future<String> hashPoseidon3(
    String? input1,
    String? input2,
    String? input3,
  ) =>
  ...
  @override
  _i7.Future<String> hashPoseidon4(
    String? input1,
    String? input2,
    String? input3,
    String? input4,
...
/// A class which mocks [StorageConnectionDataSource].
///
/// See the documentation for Mockito's code generation for more information.
class MockStorageConnectionDataSource extends _i1.Mock
    implements _i10.StorageConnectionDataSource {
  MockStorageConnectionDataSource() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i7.Future<void> storeConnections({
    required List<_i5.ConnectionDTO>? connections,
    required String? did,
  ...
  @override
  _i7.Future<void> storeConnectionsTransact({
    required _i11.DatabaseClient? transaction,
    required List<_i5.ConnectionDTO>? connections,
  }) =>
      (super.noSuchMethod(
        Invocation.method(
          #storeConnectionsTransact,
          [],
          {
  ...
  @override
  _i7.Future<void> removeConnections({
  ...
  @override
  _i7.Future<void> removeConnectionsTransact({
    required _i11.DatabaseClient? transaction,
    required List<String>? connectionIds,
  }) =>
      (super.noSuchMethod(
        Invocation.method(
          #removeConnectionsTransact,
          [],
          {
            #transaction: transaction,
            #connectionIds: connectionIds,
  ...
  @override
  _i7.Future<void> removeAllConnections({
    required String? did,
    required String? privateKey,
  }) =>
      (super.noSuchMethod(
  ...
  @override
  _i7.Future<void> removeAllConnectionsTransact(
          {required _i11.DatabaseClient? transaction}) =>
      (super.noSuchMethod(
        Invocation.method(
          #removeAllConnectionsTransact,
          [],
          {#transaction: transaction},
        ),
        returnValue: _i7.Future<void>.value(),
  ...
  @override
  _i7.Future<List<_i5.ConnectionDTO>> getConnections({
    required String? did,
    required String? privateKey,
  }) =>
      (super.noSuchMethod(
        ...
        returnValue:
            _i7.Future<List<_i5.ConnectionDTO>>.value(<_i5.ConnectionDTO>[]),
      ) as _i7.Future<List<_i5.ConnectionDTO>>);
}
...
class MockAuthResponseMapper extends _i1.Mock
    implements _i12.AuthResponseMapper {
  MockAuthResponseMapper() {
    _i1.throwOnMissingStub(this);
  }

  @override
  String mapFrom(_i13.AuthResponse? from) => (super.noSuchMethod(
        Invocation.method(
          #mapFrom,
          [from],
        ),
...
///
/// See the documentation for Mockito's code generation for more information.
class MockAuthInputsMapper extends _i1.Mock implements _i14.AuthInputsMapper {
  MockAuthInputsMapper() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i15.Uint8List mapFrom(String? from) => (super.noSuchMethod(
        Invocation.method(
          #mapFrom,
          [from],
        ),
...
///
/// See the documentation for Mockito's code generation for more information.
class MockAuthProofMapper extends _i1.Mock implements _i16.AuthProofMapper {
  MockAuthProofMapper() {
    _i1.throwOnMissingStub(this);
  }

  @override
  Map<String, dynamic> mapTo(_i17.ProofEntity? to) => (super.noSuchMethod(
        Invocation.method(
          #mapTo,
          [to],
        ),
...
///
/// See the documentation for Mockito's code generation for more information.
class MockGistProofMapper extends _i1.Mock implements _i18.GistProofMapper {
  MockGistProofMapper() {
    _i1.throwOnMissingStub(this);
  }

  @override
  Map<String, dynamic> mapTo(_i19.GistProofEntity? to) => (super.noSuchMethod(
        Invocation.method(
          #mapTo,
          [to],
        ),
...
///
/// See the documentation for Mockito's code generation for more information.
class MockQMapper extends _i1.Mock implements _i20.QMapper {
  MockQMapper() {
    _i1.throwOnMissingStub(this);
  }
...
/// A class which mocks [ConnectionMapper].
///
/// See the documentation for Mockito's code generation for more information.
class MockConnectionMapper extends _i1.Mock implements _i21.ConnectionMapper {
  MockConnectionMapper() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.ConnectionEntity mapFrom(_i5.ConnectionDTO? from) => (super.noSuchMethod(
        Invocation.method(
          #mapFrom,
          [from],
        ),
        returnValue: _FakeConnectionEntity_3(
          this,
          Invocation.method(
            #mapFrom,
            [from],
      ...
      ) as _i4.ConnectionEntity);
  @override
  _i5.ConnectionDTO mapTo(_i4.ConnectionEntity? to) => (super.noSuchMethod(
        Invocation.method(
          #mapTo,
          [to],
        ),
        returnValue: _FakeConnectionDTO_4(
          this,
          Invocation.method(
            #mapTo,
            [to],

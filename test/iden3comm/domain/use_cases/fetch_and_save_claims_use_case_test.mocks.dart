...
// in polygonid_flutter_sdk/test/iden3comm/domain/use_cases/fetch_and_save_claims_use_case_test.dart.
...
/// A class which mocks [GetClaimRevocationStatusUseCase].
///
/// See the documentation for Mockito's code generation for more information.
class MockGetClaimRevocationStatusUseCase extends _i1.Mock
    implements _i10.GetClaimRevocationStatusUseCase {
  MockGetClaimRevocationStatusUseCase() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.Future<Map<String, dynamic>> execute({required _i2.ClaimEntity? param}) =>
      (super.noSuchMethod(
        Invocation.method(
          #execute,
          [],

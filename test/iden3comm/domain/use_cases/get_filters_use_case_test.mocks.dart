...
class MockIsProofCircuitSupportedUseCase extends _i1.Mock
    implements _i14.IsProofCircuitSupportedUseCase {
...
class MockGetProofRequestsUseCase extends _i1.Mock
    implements _i15.GetProofRequestsUseCase {
  MockGetProofRequestsUseCase() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.Future<List<_i12.ProofRequestEntity>> execute(
          {required _i16.Iden3MessageEntity? param}) =>
      (super.noSuchMethod(
        Invocation.method(
          #execute,
          [],
        ...
        returnValue: _i4.Future<List<_i12.ProofRequestEntity>>.value(
            <_i12.ProofRequestEntity>[]),
      ) as _i4.Future<List<_i12.ProofRequestEntity>>);
}

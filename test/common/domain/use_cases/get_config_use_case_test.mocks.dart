...
// in polygonid_flutter_sdk/test/common/domain/use_cases/get_config_use_case_test.dart.
...
///
/// See the documentation for Mockito's code generation for more information.
class MockGetEnvUseCase extends _i1.Mock implements _i6.GetEnvUseCase {
  MockGetEnvUseCase() {
    _i1.throwOnMissingStub(this);
  }

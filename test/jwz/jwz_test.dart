...
void main() {
  ...
  group("JWZToken", () {
    setUp(() async {
      DynamicLibrary.open("android/src/main/jniLibs/libbabyjubjub.so");
    ...
    test("JWZProver prove", () async {
      JWZToken token = JWZToken.withJWZ(
          jwz: JWZMocks.jwz, prover: prover, preparer: preparer);
  ...
  test("JWZProver verify", () async {
    JWZToken token = JWZToken.fromBase64(
        data: compacted, prover: prover, preparer: preparer);
    var verificationKey =

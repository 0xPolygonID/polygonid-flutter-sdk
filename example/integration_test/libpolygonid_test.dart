...
void main() {
  ...
  group('Test polygonId core lib iden3comm functions', () {
    final pidCoreIden3comm = PolygonIdCoreIden3comm(stacktraceManager);

    testWidgets('PolygonIdCoreIdentity get Auth Inputs',
        (WidgetTester tester) async {
      expect(
        pidCoreIden3comm.getAuthInputs(PolygonIdCoreMocks.authV2InputJson),
  ...
  group('Test polygonId core lib proof functions', () {
    final pidCoreProof = PolygonIdCoreProof(stacktraceManager);
    ...
    testWidgets('PolygonIdCoreIdentity get sig proofs inputs',
      ...
      expect(
        ...
        equals(PolygonIdCoreMocks.sigV2OutputJson),
      );
    });

...
class CredentialCredentialProofIssuerMTP {
  final String? type;
  ...
  CredentialCredentialProofIssuerMTP({
    this.type,
    this.h_index,
    this.h_value,
    this.issuer,
  ...
  /// @returns [CredentialCredentialProofIssuerMTP]
  factory CredentialCredentialProofIssuerMTP.fromJson(
    ...
    if (json != null) {
      ...
      return CredentialCredentialProofIssuerMTP(
          type: json['@type'],

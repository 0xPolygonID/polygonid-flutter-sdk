...
class CredentialCredentialSchema {
  final String? id;
  final String? type;

  CredentialCredentialSchema({this.id, this.type});

  /// Creates an instance from the given json
  ///
  /// @param [Map<String, dynamic>] json
  /// @returns [CredentialCredentialSchema]
  factory CredentialCredentialSchema.fromJson(Map<String, dynamic> json) {
    return CredentialCredentialSchema(
      id: json['@id'],
      type: json['type'],
    );
  }

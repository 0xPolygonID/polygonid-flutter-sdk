...
class CredentialCredentialProofMTP {
  final bool? existence;
  final List<String>? siblings;

  CredentialCredentialProofMTP({
    this.existence,
    this.siblings,
  });
  ...
  /// @returns [CredentialCredentialProofMTP]
  factory CredentialCredentialProofMTP.fromJson(Map<String, dynamic> json) {
    return CredentialCredentialProofMTP(
      existence: json['existence'],
      siblings: (json['siblings'] as List).map((e) => e as String).toList(),
    );
  }

  Map<String, dynamic> toJson() => {
        'existence': existence,
        'siblings': siblings?.map((e) => e.toString()).toList(),
      };
}

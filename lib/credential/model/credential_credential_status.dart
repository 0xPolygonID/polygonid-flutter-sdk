...
class CredentialCredentialStatus {
  final String? id;
  final String? type;

  CredentialCredentialStatus({this.id, this.type});

  /// Creates an instance from the given json
  ///
  /// @param [Map<String, dynamic>] json
  /// @returns [CredentialCredentialStatus]
  factory CredentialCredentialStatus.fromJson(Map<String, dynamic> json) {
    return CredentialCredentialStatus(
      id: json['id'],
      type: json['type'],
    );
  }

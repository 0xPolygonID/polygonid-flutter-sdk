...
class AuthBodyCredentialsRequest {
  final String? id;
  final String? description;

  AuthBodyCredentialsRequest({this.id, this.description});

  /// Creates an instance from the given json
  ///
  /// @param [Map<String, dynamic>] json
  /// @returns [AuthBodyCredentialsRequest]
  factory AuthBodyCredentialsRequest.fromJson(Map<String, dynamic> json) {
    return AuthBodyCredentialsRequest(
      id: json['id'],
  ...
  @override
  String toString() =>
      "[AuthBodyCredentialsRequest] {id: $id, description: $description}";

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is AuthBodyCredentialsRequest &&

...
class ProofScopeRulesRequest {
  ...
  /// @returns [ProofScopeRulesRequest]
  factory ProofScopeRulesRequest.fromJson(Map<String, dynamic> json) {
  ...
  @override
  String toString() =>
      "[ProofScopeRulesRequest] {audience: $audience, challenge: $challenge, query: $query}";

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is ProofScopeRulesRequest &&

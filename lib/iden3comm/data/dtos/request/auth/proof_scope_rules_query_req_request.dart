...
class ProofScopeRulesQueryReqRequest {
  final Map<String, int>? birthday;

  ProofScopeRulesQueryReqRequest({
    this.birthday,
  });
  ...
  /// @returns [ProofScopeRulesQueryReqRequest]
  factory ProofScopeRulesQueryReqRequest.fromJson(Map<String, dynamic> json) {
    //ProofScopeRulesQueryReqBirthdayRequest? birthday =
    //    ProofScopeRulesQueryReqBirthdayRequest.fromJson(json['birthday']);
    return ProofScopeRulesQueryReqRequest(

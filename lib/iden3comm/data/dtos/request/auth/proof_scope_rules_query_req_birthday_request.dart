...
class ProofScopeRulesQueryReqBirthdayRequest {
  final int? lt;

  ProofScopeRulesQueryReqBirthdayRequest({
    this.lt,
  });
  ...
  /// @returns [ProofScopeRulesQueryReqBirthdayRequest]
  factory ProofScopeRulesQueryReqBirthdayRequest.fromJson(
      Map<String, dynamic> json) {
    return ProofScopeRulesQueryReqBirthdayRequest(
      lt: json['\$lt'],
    );
  }

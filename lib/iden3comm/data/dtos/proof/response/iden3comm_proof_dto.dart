...
@JsonSerializable()
class Iden3commProofDTO extends ZKProofEntity {
  final int id;
  ...
  factory Iden3commProofDTO.fromJson(Map<String, dynamic> json) =>
      _$Iden3commProofDTOFromJson(json);

  Map<String, dynamic> toJson() => _$Iden3commProofDTOToJson(this);

  @override
  List<Object?> get props => [id, circuitId, proof, pubSignals];
}

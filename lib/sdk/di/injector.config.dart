...
import 'package:archive/archive.dart' as _i66;
...
import 'package:polygonid_flutter_sdk/common/data/repositories/package_info_repository_impl.dart'
    as _i38;
import 'package:polygonid_flutter_sdk/common/domain/domain_logger.dart' as _i41;
...
import 'package:polygonid_flutter_sdk/proof/libs/polygonidcore/pidcore_proof.dart'
    as _i85;
import 'package:polygonid_flutter_sdk/proof/libs/prover/prover.dart' as _i45;
...
import 'package:polygonid_flutter_sdk/sdk/error_handling.dart' as _i71;
...
import 'package:polygonid_flutter_sdk/sdk/polygon_id_sdk.dart' as _i40;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt $initSDKGetIt({
    ...
    gh.factoryAsync<_i37.PackageInfoDataSource>(() async =>
        _i37.PackageInfoDataSource(await getAsync<_i36.PackageInfo>()));
    gh.factoryAsync<_i38.PackageInfoRepositoryImpl>(() async =>
        _i38.PackageInfoRepositoryImpl(
            await getAsync<_i37.PackageInfoDataSource>()));
    gh.factory<_i39.PolygonIdCore>(() => _i39.PolygonIdCore());
    gh.factory<_i40.PolygonIdSdk>(() => channelModule.polygonIdSdk);
    gh.factory<_i41.PolygonIdSdkLogger>(() => loggerModule.sdkLogger);
    gh.factory<_i42.PrivateKeyMapper>(() => _i42.PrivateKeyMapper());
    gh.factory<_i43.ProofCircuitDataSource>(
        () => _i43.ProofCircuitDataSource());
    gh.lazySingleton<_i44.ProofGenerationStepsStreamManager>(
        () => _i44.ProofGenerationStepsStreamManager());
    gh.factory<_i45.ProverLib>(() => _i45.ProverLib());
    gh.factory<_i46.ProverLibWrapper>(() => _i46.ProverLibWrapper());
    gh.factory<_i47.QMapper>(() => _i47.QMapper());
    gh.factory<_i48.RevocationStatusMapper>(
        () => _i48.RevocationStatusMapper());
    ...
    gh.lazySingleton<_i50.StacktraceManager>(() => _i50.StacktraceManager());
    ...
    gh.factory<_i52.TreeStateMapper>(() => _i52.TreeStateMapper());
    gh.factory<_i53.TreeTypeMapper>(() => _i53.TreeTypeMapper());
    gh.factory<_i54.WalletLibWrapper>(() => _i54.WalletLibWrapper());
    gh.factoryParam<_i55.Web3Client, String, dynamic>((
      rpcUrl,
      _,
    ) =>
        networkModule.web3client(rpcUrl));
    gh.factory<_i56.WitnessAuthV2Lib>(() => _i56.WitnessAuthV2Lib());
    gh.factory<_i57.WitnessIsolatesWrapper>(
        () => _i57.WitnessIsolatesWrapper());
    gh.factory<_i58.WitnessLinkedMultiQuery10>(
        () => _i58.WitnessLinkedMultiQuery10());
    gh.factory<_i59.WitnessMTPV2Lib>(() => _i59.WitnessMTPV2Lib());
    gh.factory<_i60.WitnessMTPV2OnchainLib>(
        () => _i60.WitnessMTPV2OnchainLib());
    gh.factory<_i61.WitnessSigV2Lib>(() => _i61.WitnessSigV2Lib());
    gh.factory<_i62.WitnessSigV2OnchainLib>(
        () => _i62.WitnessSigV2OnchainLib());
    gh.factory<_i63.WitnessV3Lib>(() => _i63.WitnessV3Lib());
    gh.factory<_i64.WitnessV3OnchainLib>(() => _i64.WitnessV3OnchainLib());
    gh.factory<_i65.ZKProofMapper>(() => _i65.ZKProofMapper());
    gh.factory<_i66.ZipDecoder>(() => filesManagerModule.zipDecoder());
    gh.factory<_i67.CircuitsDownloadDataSource>(
        () => _i67.CircuitsDownloadDataSource(gh<_i15.Dio>()));
    gh.factoryAsync<_i68.CircuitsFilesDataSource>(() async =>
        _i68.CircuitsFilesDataSource(await getAsync<_i16.Directory>()));
    ...
    gh.factory<_i70.ClaimStoreRefWrapper>(() => _i70.ClaimStoreRefWrapper(
        gh<_i13.StoreRef<String, Map<String, Object?>>>(
            instanceName: 'claimStore')));
    gh.factory<_i71.ErrorHandling>(
        () => _i71.ErrorHandling(gh<_i50.StacktraceManager>()));
    gh.factory<_i72.GetIden3MessageUseCase>(
        () => _i72.GetIden3MessageUseCase(gh<_i50.StacktraceManager>()));
    gh.factory<_i73.GetProofQueryUseCase>(
        () => _i73.GetProofQueryUseCase(gh<_i50.StacktraceManager>()));
    gh.factory<_i74.Iden3MessageDataSource>(
        () => _i74.Iden3MessageDataSource(gh<_i50.StacktraceManager>()));
    gh.factory<_i75.Iden3commProofMapper>(
        () => _i75.Iden3commProofMapper(gh<_i28.Iden3commVPProofMapper>()));
    ...
    gh.factory<_i79.JWZMapper>(
        () => _i79.JWZMapper(gh<_i50.StacktraceManager>()));
    ...
    gh.factoryAsync<_i81.PackageInfoRepository>(() async =>
        repositoriesModule.packageInfoRepository(
            await getAsync<_i38.PackageInfoRepositoryImpl>()));
    gh.factory<_i82.PolygonIdCoreCredential>(
        () => _i82.PolygonIdCoreCredential(gh<_i50.StacktraceManager>()));
    gh.factory<_i83.PolygonIdCoreIden3comm>(
        () => _i83.PolygonIdCoreIden3comm(gh<_i50.StacktraceManager>()));
    gh.factory<_i84.PolygonIdCoreIdentity>(
        () => _i84.PolygonIdCoreIdentity(gh<_i50.StacktraceManager>()));
    gh.factory<_i85.PolygonIdCoreProof>(
        () => _i85.PolygonIdCoreProof(gh<_i50.StacktraceManager>()));
    gh.factory<_i86.PolygonIdFlutterChannel>(() => _i86.PolygonIdFlutterChannel(
          gh<_i40.PolygonIdSdk>(),
          gh<_i3.MethodChannel>(),
        ));
    gh.factory<_i87.ProofRequestFiltersMapper>(
        () => _i87.ProofRequestFiltersMapper(gh<_i50.StacktraceManager>()));
    gh.factory<_i46.ProverLibDataSource>(
        () => _i46.ProverLibDataSource(gh<_i46.ProverLibWrapper>()));
    gh.factory<_i88.RemoteClaimDataSource>(() => _i88.RemoteClaimDataSource(
          gh<_i11.Client>(),
          gh<_i50.StacktraceManager>(),
        ));
    ...
    gh.factory<_i90.RemoteIdentityDataSource>(
        () => _i90.RemoteIdentityDataSource(gh<_i50.StacktraceManager>()));
    gh.factory<_i91.RhsNodeMapper>(
        () => _i91.RhsNodeMapper(gh<_i49.RhsNodeTypeMapper>()));
    ...
    gh.factory<_i70.StorageClaimDataSource>(
        () => _i70.StorageClaimDataSource(gh<_i70.ClaimStoreRefWrapper>()));
    ...
    gh.factory<_i54.WalletDataSource>(
        () => _i54.WalletDataSource(gh<_i54.WalletLibWrapper>()));
    gh.factory<_i57.WitnessDataSource>(
        () => _i57.WitnessDataSource(gh<_i57.WitnessIsolatesWrapper>()));
    ...
    gh.factory<_i106.SMTRepositoryImpl>(() => _i106.SMTRepositoryImpl(
          ...
          gh<_i76.StorageSMTDataSource>(),
          gh<_i31.LibBabyJubJubDataSource>(),
          gh<_i53.TreeTypeMapper>(),
          gh<_i52.TreeStateMapper>(),
        ));
    ...
    gh.factory<_i109.CredentialRepositoryImpl>(
        () => _i109.CredentialRepositoryImpl(
              ...
              gh<_i70.StorageClaimDataSource>(),
    ...
    gh.factory<_i116.Iden3commRepositoryImpl>(
        () => _i116.Iden3commRepositoryImpl(
              gh<_i74.Iden3MessageDataSource>(),
              gh<_i89.RemoteIden3commDataSource>(),
              ...
              gh<_i47.QMapper>(),
              gh<_i79.JWZMapper>(),
              gh<_i75.Iden3commProofMapper>(),
              gh<_i72.GetIden3MessageUseCase>(),
              gh<_i50.StacktraceManager>(),
            ));
    ...
    gh.factoryAsync<_i137.IdentityRepositoryImpl>(
        () async => _i137.IdentityRepositoryImpl(
              ...
              gh<_i51.StateIdentifierMapper>(),
              gh<_i94.SecureStorageProfilesDataSource>(),
            ));
    gh.factoryAsync<_i138.ProofRepositoryImpl>(
        () async => _i138.ProofRepositoryImpl(
              gh<_i57.WitnessDataSource>(),
              gh<_i46.ProverLibDataSource>(),
              gh<_i103.LibPolygonIdCoreProofDataSource>(),
              gh<_i23.GistMTProofDataSource>(),
              gh<_i43.ProofCircuitDataSource>(),
              gh<_i90.RemoteIdentityDataSource>(),
              gh<_i32.LocalContractFilesDataSource>(),
              gh<_i67.CircuitsDownloadDataSource>(),
              await getAsync<_i119.RPCDataSource>(),
              gh<_i8.CircuitTypeMapper>(),
              gh<_i65.ZKProofMapper>(),
              gh<_i69.ClaimMapper>(),
              gh<_i48.RevocationStatusMapper>(),
              gh<_i4.AuthProofMapper>(),
              await getAsync<_i68.CircuitsFilesDataSource>(),
              await getAsync<_i113.GetEnvUseCase>(),
              gh<_i50.StacktraceManager>(),
            ));
    ...
    gh.factoryAsync<_i166.Proof>(() async => _i166.Proof(
          ...
          gh<_i44.ProofGenerationStepsStreamManager>(),

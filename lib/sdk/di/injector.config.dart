...
import '../credential_wallet.dart' as _i66;
import '../iden3comm.dart' as _i64;
import '../identity_wallet.dart' as _i60;
import '../proof_generation.dart' as _i53;
import 'injector.dart' as _i67; // ignore_for_file: unnecessary_lambdas
...
_i1.GetIt $initSDKGetIt(_i1.GetIt get,
  ...
  gh.factory<_i28.RemoteIdentityDataSource>(
      () => _i28.RemoteIdentityDataSource(get<_i7.Client>()));
  gh.factory<_i29.SMTMemoryStorageRepositoryImpl>(() =>
      _i29.SMTMemoryStorageRepositoryImpl(
          get<_i30.Hash>(), get<Map<_i30.Hash, _i21.Node>>()));
  ...
  gh.factoryAsync<_i45.IdentityRepositoryImpl>(() async =>
      _i45.IdentityRepositoryImpl(
          ...
          get<_i28.RemoteIdentityDataSource>(),
  ...
  gh.factoryAsync<_i64.Iden3comm>(() async =>
      _i64.Iden3comm(await get.getAsync<_i62.AuthenticateUseCase>()));
  gh.factoryAsync<_i65.FetchAndSaveClaimsUseCase>(() async =>
      _i65.FetchAndSaveClaimsUseCase(
          await get.getAsync<_i63.GetAuthTokenUseCase>(),
          await get.getAsync<_i43.CredentialRepository>()));
  gh.factoryAsync<_i66.CredentialWallet>(() async => _i66.CredentialWallet(
      await get.getAsync<_i65.FetchAndSaveClaimsUseCase>(),
...
class _$DatabaseModule extends _i67.DatabaseModule {}

class _$RepositoriesModule extends _i67.RepositoriesModule {}

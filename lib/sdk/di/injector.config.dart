...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt $initSDKGetIt({
    ...
    gh.factoryAsync<_i160.GetGistMTProofUseCase>(
        () async => _i160.GetGistMTProofUseCase(
              await getAsync<_i150.ProofRepository>(),
              await getAsync<_i149.IdentityRepository>(),
              await getAsync<_i114.GetSelectedChainUseCase>(),
    ...
    gh.factoryAsync<_i161.GetIdentitiesUseCase>(
        () async => _i161.GetIdentitiesUseCase(
              await getAsync<_i149.IdentityRepository>(),
              gh<_i51.StacktraceManager>(),
            ));
    ...
    gh.factoryAsync<_i175.RemoveInteractionsUseCase>(
        () async => _i175.RemoveInteractionsUseCase(
              await getAsync<_i117.InteractionRepository>(),
              await getAsync<_i172.GetIdentityUseCase>(),
            ));
    gh.factoryAsync<_i176.AddInteractionUseCase>(
        () async => _i176.AddInteractionUseCase(
              await getAsync<_i117.InteractionRepository>(),
              gh<_i7.CheckProfileValidityUseCase>(),
              await getAsync<_i172.GetIdentityUseCase>(),
              gh<_i51.StacktraceManager>(),
            ));
    gh.factoryAsync<_i177.CheckProfileAndDidCurrentEnvUseCase>(
        () async => _i177.CheckProfileAndDidCurrentEnvUseCase(
              gh<_i7.CheckProfileValidityUseCase>(),
              await getAsync<_i114.GetSelectedChainUseCase>(),
              await getAsync<_i170.GetDidIdentifierUseCase>(),
              gh<_i51.StacktraceManager>(),
            ));
    gh.factoryAsync<_i178.FetchOnchainClaimsUseCase>(
        () async => _i178.FetchOnchainClaimsUseCase(
              await getAsync<_i126.FetchOnchainClaimUseCase>(),
              await getAsync<_i177.CheckProfileAndDidCurrentEnvUseCase>(),
              await getAsync<_i113.GetEnvUseCase>(),
              await getAsync<_i114.GetSelectedChainUseCase>(),
              await getAsync<_i170.GetDidIdentifierUseCase>(),
              await getAsync<_i158.GetDidUseCase>(),
    ...
    gh.factoryAsync<_i179.GenerateIden3commProofUseCase>(
        () async => _i179.GenerateIden3commProofUseCase(
              ...
              await getAsync<_i172.GetIdentityUseCase>(),
              gh<_i128.GetAuthClaimUseCase>(),
              await getAsync<_i160.GetGistMTProofUseCase>(),
              await getAsync<_i158.GetDidUseCase>(),
    ...
    gh.factoryAsync<_i186.UpdateInteractionUseCase>(
        () async => _i186.UpdateInteractionUseCase(
              ...
              gh<_i7.CheckProfileValidityUseCase>(),
              await getAsync<_i172.GetIdentityUseCase>(),
              await getAsync<_i176.AddInteractionUseCase>(),
            ));
    ...
    gh.factoryAsync<_i203.Iden3comm>(() async => _i203.Iden3comm(
          ...
          await getAsync<_i178.FetchOnchainClaimsUseCase>(),
          gh<_i73.GetIden3MessageUseCase>(),
          ...
          await getAsync<_i176.AddInteractionUseCase>(),
          await getAsync<_i175.RemoveInteractionsUseCase>(),
    ...
    gh.factoryAsync<_i208.Identity>(() async => _i208.Identity(
          ...
          await getAsync<_i172.GetIdentityUseCase>(),
          await getAsync<_i161.GetIdentitiesUseCase>(),

...
import 'package:polygonid_flutter_sdk/common/data/repositories/package_info_repository_impl.dart'
    as _i41;
import 'package:polygonid_flutter_sdk/common/domain/domain_logger.dart' as _i44;
...
import 'package:polygonid_flutter_sdk/proof/libs/polygonidcore/pidcore_proof.dart'
    as _i90;
import 'package:polygonid_flutter_sdk/proof/libs/prover/prover.dart' as _i49;
...
import 'package:polygonid_flutter_sdk/sdk/error_handling.dart' as _i75;
...
import 'package:polygonid_flutter_sdk/sdk/polygon_id_sdk.dart' as _i43;
import 'package:polygonid_flutter_sdk/sdk/polygonid_flutter_channel.dart'
    as _i91;
import 'package:polygonid_flutter_sdk/sdk/proof.dart' as _i171;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt $initSDKGetIt({
    ...
    gh.factory<_i25.GistMTProofMapper>(() => _i25.GistMTProofMapper());
    ...
    gh.factoryAsync<_i40.PackageInfoDataSource>(() async =>
        _i40.PackageInfoDataSource(await getAsync<_i39.PackageInfo>()));
    gh.factoryAsync<_i41.PackageInfoRepositoryImpl>(() async =>
        _i41.PackageInfoRepositoryImpl(
            await getAsync<_i40.PackageInfoDataSource>()));
    gh.factory<_i42.PolygonIdCore>(() => _i42.PolygonIdCore());
    gh.factory<_i43.PolygonIdSdk>(() => channelModule.polygonIdSdk);
    gh.factory<_i44.PolygonIdSdkLogger>(() => loggerModule.sdkLogger);
    gh.factory<_i45.PoseidonHashMapper>(
        () => _i45.PoseidonHashMapper(gh<_i26.HexMapper>()));
    gh.factory<_i46.PrivateKeyMapper>(() => _i46.PrivateKeyMapper());
    gh.factory<_i47.ProofCircuitDataSource>(
        () => _i47.ProofCircuitDataSource());
    gh.lazySingleton<_i48.ProofGenerationStepsStreamManager>(
        () => _i48.ProofGenerationStepsStreamManager());
    gh.factory<_i49.ProverLib>(() => _i49.ProverLib());
    gh.factory<_i50.ProverLibWrapper>(() => _i50.ProverLibWrapper());
    gh.factory<_i51.QMapper>(() => _i51.QMapper());
    gh.factory<_i52.RevocationStatusMapper>(
        () => _i52.RevocationStatusMapper());
    gh.factory<_i53.RhsNodeTypeMapper>(() => _i53.RhsNodeTypeMapper());
    gh.factoryParam<_i13.SembastCodec, String, dynamic>((
      privateKey,
      _,
    ) =>
        databaseModule.getCodec(privateKey));
    gh.lazySingleton<_i54.StacktraceManager>(() => _i54.StacktraceManager());
    gh.factory<_i55.StateIdentifierMapper>(() => _i55.StateIdentifierMapper());
    ...
    gh.factory<_i56.TreeStateMapper>(() => _i56.TreeStateMapper());
    gh.factory<_i57.TreeTypeMapper>(() => _i57.TreeTypeMapper());
    gh.factory<_i58.WalletLibWrapper>(() => _i58.WalletLibWrapper());
    gh.factoryParam<_i59.Web3Client, String, dynamic>((
      rpcUrl,
      _,
    ) =>
        networkModule.web3client(rpcUrl));
    gh.factory<_i60.WitnessAuthV2Lib>(() => _i60.WitnessAuthV2Lib());
    gh.factory<_i61.WitnessIsolatesWrapper>(
        () => _i61.WitnessIsolatesWrapper());
    gh.factory<_i62.WitnessLinkedMultiQuery10>(
        () => _i62.WitnessLinkedMultiQuery10());
    gh.factory<_i63.WitnessMTPV2Lib>(() => _i63.WitnessMTPV2Lib());
    gh.factory<_i64.WitnessMTPV2OnchainLib>(
        () => _i64.WitnessMTPV2OnchainLib());
    gh.factory<_i65.WitnessSigV2Lib>(() => _i65.WitnessSigV2Lib());
    gh.factory<_i66.WitnessSigV2OnchainLib>(
        () => _i66.WitnessSigV2OnchainLib());
    gh.factory<_i67.WitnessV3Lib>(() => _i67.WitnessV3Lib());
    gh.factory<_i68.WitnessV3OnchainLib>(() => _i68.WitnessV3OnchainLib());
    gh.factory<_i69.ZKProofMapper>(() => _i69.ZKProofMapper());
    gh.factory<_i70.ZipDecoder>(() => filesManagerModule.zipDecoder());
    gh.factory<_i71.CircuitsDownloadDataSource>(
        () => _i71.CircuitsDownloadDataSource(gh<_i15.Dio>()));
    gh.factoryAsync<_i72.CircuitsFilesDataSource>(() async =>
        _i72.CircuitsFilesDataSource(await getAsync<_i16.Directory>()));
    ...
    gh.factory<_i74.ClaimStoreRefWrapper>(() => _i74.ClaimStoreRefWrapper(
        gh<_i13.StoreRef<String, Map<String, Object?>>>(
            instanceName: 'claimStore')));
    gh.factory<_i75.ErrorHandling>(
        () => _i75.ErrorHandling(gh<_i54.StacktraceManager>()));
    gh.factory<_i76.GetIden3MessageUseCase>(
        () => _i76.GetIden3MessageUseCase(gh<_i54.StacktraceManager>()));
    gh.factory<_i77.GetProofQueryUseCase>(
        () => _i77.GetProofQueryUseCase(gh<_i54.StacktraceManager>()));
    gh.factory<_i78.Iden3MessageDataSource>(
        () => _i78.Iden3MessageDataSource(gh<_i54.StacktraceManager>()));
    gh.factory<_i79.Iden3commProofMapper>(
        () => _i79.Iden3commProofMapper(gh<_i29.Iden3commVPProofMapper>()));
    ...
    gh.factory<_i81.IdentityStoreRefWrapper>(() => _i81.IdentityStoreRefWrapper(
        gh<_i13.StoreRef<String, Map<String, Object?>>>(
            instanceName: 'identityStore')));
    gh.factory<_i82.InteractionStoreRefWrapper>(() =>
        _i82.InteractionStoreRefWrapper(
            gh<_i13.StoreRef<String, Map<String, Object?>>>(
                instanceName: 'interactionStore')));
    gh.factory<_i83.JWZMapper>(
        () => _i83.JWZMapper(gh<_i54.StacktraceManager>()));
    gh.factory<_i84.KeyValueStoreRefWrapper>(() => _i84.KeyValueStoreRefWrapper(
        gh<_i13.StoreRef<String, dynamic>>(instanceName: 'keyValueStore')));
    gh.factory<_i85.NodeMapper>(() => _i85.NodeMapper(
          gh<_i38.NodeTypeMapper>(),
          gh<_i37.NodeTypeEntityMapper>(),
          gh<_i36.NodeTypeDTOMapper>(),
        ));
    gh.factoryAsync<_i86.PackageInfoRepository>(() async =>
        repositoriesModule.packageInfoRepository(
            await getAsync<_i41.PackageInfoRepositoryImpl>()));
    gh.factory<_i87.PolygonIdCoreCredential>(
        () => _i87.PolygonIdCoreCredential(gh<_i54.StacktraceManager>()));
    gh.factory<_i88.PolygonIdCoreIden3comm>(
        () => _i88.PolygonIdCoreIden3comm(gh<_i54.StacktraceManager>()));
    gh.factory<_i89.PolygonIdCoreIdentity>(
        () => _i89.PolygonIdCoreIdentity(gh<_i54.StacktraceManager>()));
    gh.factory<_i90.PolygonIdCoreProof>(
        () => _i90.PolygonIdCoreProof(gh<_i54.StacktraceManager>()));
    gh.factory<_i91.PolygonIdFlutterChannel>(() => _i91.PolygonIdFlutterChannel(
          gh<_i43.PolygonIdSdk>(),
          gh<_i3.MethodChannel>(),
        ));
    gh.factory<_i92.ProofRequestFiltersMapper>(
        () => _i92.ProofRequestFiltersMapper(gh<_i54.StacktraceManager>()));
    gh.factory<_i50.ProverLibDataSource>(
        () => _i50.ProverLibDataSource(gh<_i50.ProverLibWrapper>()));
    gh.factory<_i93.RemoteClaimDataSource>(() => _i93.RemoteClaimDataSource(
          gh<_i11.Client>(),
          gh<_i54.StacktraceManager>(),
        ));
    gh.factory<_i94.RemoteIden3commDataSource>(
        () => _i94.RemoteIden3commDataSource(
              gh<_i15.Dio>(),
              gh<_i11.Client>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factory<_i95.RemoteIdentityDataSource>(
        () => _i95.RemoteIdentityDataSource(gh<_i54.StacktraceManager>()));
    gh.factory<_i96.RhsNodeMapper>(
        () => _i96.RhsNodeMapper(gh<_i53.RhsNodeTypeMapper>()));
    gh.factory<_i97.SecureDidProfileInfoStoreRefWrapper>(() =>
        _i97.SecureDidProfileInfoStoreRefWrapper(
            gh<_i13.StoreRef<String, Map<String, Object?>>>(
                instanceName: 'didProfileInfoStore')));
    gh.factory<_i98.SecureInteractionStoreRefWrapper>(() =>
        _i98.SecureInteractionStoreRefWrapper(
            gh<_i13.StoreRef<String, Map<String, Object?>>>(
                instanceName: 'interactionStore')));
    gh.factory<_i97.SecureStorageDidProfileInfoDataSource>(() =>
        _i97.SecureStorageDidProfileInfoDataSource(
            gh<_i97.SecureDidProfileInfoStoreRefWrapper>()));
    gh.factory<_i98.SecureStorageInteractionDataSource>(() =>
        _i98.SecureStorageInteractionDataSource(
            gh<_i98.SecureInteractionStoreRefWrapper>()));
    gh.factory<_i99.SecureStorageProfilesStoreRefWrapper>(() =>
        _i99.SecureStorageProfilesStoreRefWrapper(
            gh<_i13.StoreRef<String, Map<String, Object?>>>(
                instanceName: 'profilesStore')));
    gh.factory<_i74.StorageClaimDataSource>(
        () => _i74.StorageClaimDataSource(gh<_i74.ClaimStoreRefWrapper>()));
    gh.factoryAsync<_i81.StorageIdentityDataSource>(
        () async => _i81.StorageIdentityDataSource(
              await getAsync<_i13.Database>(),
              gh<_i81.IdentityStoreRefWrapper>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i82.StorageInteractionDataSource>(
        () async => _i82.StorageInteractionDataSource(
              await getAsync<_i13.Database>(),
              gh<_i82.InteractionStoreRefWrapper>(),
            ));
    gh.factoryAsync<_i84.StorageKeyValueDataSource>(
        () async => _i84.StorageKeyValueDataSource(
              await getAsync<_i13.Database>(),
              gh<_i84.KeyValueStoreRefWrapper>(),
            ));
    gh.factory<_i80.StorageSMTDataSource>(
        () => _i80.StorageSMTDataSource(gh<_i80.IdentitySMTStoreRefWrapper>()));
    gh.factory<_i58.WalletDataSource>(
        () => _i58.WalletDataSource(gh<_i58.WalletLibWrapper>()));
    gh.factory<_i61.WitnessDataSource>(
        () => _i61.WitnessDataSource(gh<_i61.WitnessIsolatesWrapper>()));
    gh.factoryAsync<_i100.ConfigRepositoryImpl>(() async =>
        _i100.ConfigRepositoryImpl(
            await getAsync<_i84.StorageKeyValueDataSource>()));
    gh.factory<_i101.DidProfileInfoRepositoryImpl>(
        () => _i101.DidProfileInfoRepositoryImpl(
              gh<_i97.SecureStorageDidProfileInfoDataSource>(),
              gh<_i22.FiltersMapper>(),
              gh<_i14.DidProfileInfoInteractedDidFilterMapper>(),
            ));
    gh.factoryAsync<_i102.GetPackageNameUseCase>(() async =>
        _i102.GetPackageNameUseCase(
            await getAsync<_i86.PackageInfoRepository>()));
    gh.factory<_i103.Iden3commCredentialRepositoryImpl>(
        () => _i103.Iden3commCredentialRepositoryImpl(
              gh<_i94.RemoteIden3commDataSource>(),
              gh<_i92.ProofRequestFiltersMapper>(),
              gh<_i73.ClaimMapper>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i104.InteractionRepositoryImpl>(
        () async => _i104.InteractionRepositoryImpl(
              gh<_i98.SecureStorageInteractionDataSource>(),
              await getAsync<_i82.StorageInteractionDataSource>(),
              gh<_i32.InteractionMapper>(),
              gh<_i22.FiltersMapper>(),
              gh<_i31.InteractionIdFilterMapper>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factory<_i105.LibPolygonIdCoreCredentialDataSource>(() =>
        _i105.LibPolygonIdCoreCredentialDataSource(
            gh<_i87.PolygonIdCoreCredential>()));
    gh.factory<_i106.LibPolygonIdCoreIden3commDataSource>(() =>
        _i106.LibPolygonIdCoreIden3commDataSource(
            gh<_i88.PolygonIdCoreIden3comm>()));
    gh.factory<_i107.LibPolygonIdCoreIdentityDataSource>(() =>
        _i107.LibPolygonIdCoreIdentityDataSource(
            gh<_i89.PolygonIdCoreIdentity>()));
    gh.factory<_i108.LibPolygonIdCoreWrapper>(
        () => _i108.LibPolygonIdCoreWrapper(gh<_i90.PolygonIdCoreProof>()));
    gh.factory<_i109.LocalClaimDataSource>(() => _i109.LocalClaimDataSource(
        gh<_i105.LibPolygonIdCoreCredentialDataSource>()));
    gh.factory<_i110.SMTDataSource>(() => _i110.SMTDataSource(
          gh<_i26.HexMapper>(),
          gh<_i33.LibBabyJubJubDataSource>(),
          gh<_i80.StorageSMTDataSource>(),
        ));
    gh.factory<_i111.SMTRepositoryImpl>(() => _i111.SMTRepositoryImpl(
          gh<_i110.SMTDataSource>(),
          gh<_i80.StorageSMTDataSource>(),
          gh<_i33.LibBabyJubJubDataSource>(),
          gh<_i85.NodeMapper>(),
          gh<_i57.TreeTypeMapper>(),
          gh<_i56.TreeStateMapper>(),
        ));
    gh.factory<_i99.SecureStorageProfilesDataSource>(() =>
        _i99.SecureStorageProfilesDataSource(
            gh<_i99.SecureStorageProfilesStoreRefWrapper>()));
    gh.factory<_i112.CacheCredentialDataSource>(() =>
        _i112.CacheCredentialDataSource(
            gh<_i105.LibPolygonIdCoreCredentialDataSource>()));
    gh.factoryAsync<_i113.ConfigRepository>(() async => repositoriesModule
        .configRepository(await getAsync<_i100.ConfigRepositoryImpl>()));
    gh.factory<_i114.CredentialRepositoryImpl>(
        () => _i114.CredentialRepositoryImpl(
              gh<_i93.RemoteClaimDataSource>(),
              gh<_i74.StorageClaimDataSource>(),
              gh<_i109.LocalClaimDataSource>(),
              gh<_i112.CacheCredentialDataSource>(),
              gh<_i73.ClaimMapper>(),
              gh<_i22.FiltersMapper>(),
              gh<_i27.IdFilterMapper>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factory<_i115.DidProfileInfoRepository>(() => repositoriesModule
        .didProfileInfoRepository(gh<_i101.DidProfileInfoRepositoryImpl>()));
    gh.factory<_i116.GetDidProfileInfoListUseCase>(() =>
        _i116.GetDidProfileInfoListUseCase(
            gh<_i115.DidProfileInfoRepository>()));
    gh.factory<_i117.GetDidProfileInfoUseCase>(() =>
        _i117.GetDidProfileInfoUseCase(gh<_i115.DidProfileInfoRepository>()));
    gh.factoryAsync<_i118.GetEnvUseCase>(() async => _i118.GetEnvUseCase(
          await getAsync<_i113.ConfigRepository>(),
          gh<_i54.StacktraceManager>(),
        ));
    gh.factoryAsync<_i119.GetSelectedChainUseCase>(
        () async => _i119.GetSelectedChainUseCase(
              await getAsync<_i113.ConfigRepository>(),
              await getAsync<_i118.GetEnvUseCase>(),
            ));
    gh.factory<_i120.Iden3commCredentialRepository>(() =>
        repositoriesModule.iden3commCredentialRepository(
            gh<_i103.Iden3commCredentialRepositoryImpl>()));
    gh.factory<_i121.Iden3commRepositoryImpl>(
        () => _i121.Iden3commRepositoryImpl(
              gh<_i78.Iden3MessageDataSource>(),
              gh<_i94.RemoteIden3commDataSource>(),
              gh<_i106.LibPolygonIdCoreIden3commDataSource>(),
              gh<_i33.LibBabyJubJubDataSource>(),
              gh<_i5.AuthResponseMapper>(),
              gh<_i4.AuthProofMapper>(),
              gh<_i25.GistMTProofMapper>(),
              gh<_i51.QMapper>(),
              gh<_i83.JWZMapper>(),
              gh<_i79.Iden3commProofMapper>(),
              gh<_i76.GetIden3MessageUseCase>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i122.InteractionRepository>(() async =>
        repositoriesModule.interactionRepository(
            await getAsync<_i104.InteractionRepositoryImpl>()));
    gh.factory<_i108.LibPolygonIdCoreProofDataSource>(
        () => _i108.LibPolygonIdCoreProofDataSource(
              gh<_i108.LibPolygonIdCoreWrapper>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i123.ListenAndStoreNotificationUseCase>(() async =>
        _i123.ListenAndStoreNotificationUseCase(
            await getAsync<_i122.InteractionRepository>()));
    gh.factoryAsync<_i124.RPCDataSource>(() async => _i124.RPCDataSource(
          await getAsync<_i119.GetSelectedChainUseCase>(),
          gh<_i54.StacktraceManager>(),
        ));
    gh.factory<_i125.RemoveDidProfileInfoUseCase>(() =>
        _i125.RemoveDidProfileInfoUseCase(
            gh<_i115.DidProfileInfoRepository>()));
    gh.factory<_i126.SMTRepository>(
        () => repositoriesModule.smtRepository(gh<_i111.SMTRepositoryImpl>()));
    gh.factoryAsync<_i127.SetEnvUseCase>(() async =>
        _i127.SetEnvUseCase(await getAsync<_i113.ConfigRepository>()));
    gh.factoryAsync<_i128.SetSelectedChainUseCase>(() async =>
        _i128.SetSelectedChainUseCase(
            await getAsync<_i113.ConfigRepository>()));
    gh.factory<_i129.AddDidProfileInfoUseCase>(() =>
        _i129.AddDidProfileInfoUseCase(gh<_i115.DidProfileInfoRepository>()));
    gh.factory<_i130.CredentialRepository>(() => repositoriesModule
        .credentialRepository(gh<_i114.CredentialRepositoryImpl>()));
    gh.factoryAsync<_i131.FetchOnchainClaimUseCase>(
        () async => _i131.FetchOnchainClaimUseCase(
              await getAsync<_i119.GetSelectedChainUseCase>(),
              await getAsync<_i118.GetEnvUseCase>(),
              gh<_i105.LibPolygonIdCoreCredentialDataSource>(),
    ...
    gh.factory<_i132.FetchSchemaUseCase>(() =>
        _i132.FetchSchemaUseCase(gh<_i120.Iden3commCredentialRepository>()));
    gh.factory<_i133.GetAuthClaimUseCase>(() => _i133.GetAuthClaimUseCase(
          gh<_i130.CredentialRepository>(),
          gh<_i54.StacktraceManager>(),
        ));
    gh.factory<_i134.GetClaimRevocationNonceUseCase>(() =>
        _i134.GetClaimRevocationNonceUseCase(gh<_i130.CredentialRepository>()));
    gh.factory<_i135.GetCredentialByIdUseCase>(
        () => _i135.GetCredentialByIdUseCase(gh<_i130.CredentialRepository>()));
    gh.factory<_i136.GetCredentialByPartialIdUseCase>(
        () => _i136.GetCredentialByPartialIdUseCase(
              gh<_i130.CredentialRepository>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factory<_i137.GetLatestStateUseCase>(() => _i137.GetLatestStateUseCase(
          gh<_i126.SMTRepository>(),
          gh<_i54.StacktraceManager>(),
        ));
    gh.factory<_i138.GetProofQueryContextUseCase>(
        () => _i138.GetProofQueryContextUseCase(
              gh<_i120.Iden3commCredentialRepository>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factory<_i139.GetProofRequestsUseCase>(
        () => _i139.GetProofRequestsUseCase(
              gh<_i138.GetProofQueryContextUseCase>(),
              gh<_i77.GetProofQueryUseCase>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factory<_i140.GetSchemasUseCase>(() =>
        _i140.GetSchemasUseCase(gh<_i120.Iden3commCredentialRepository>()));
    gh.factory<_i141.Iden3commRepository>(() => repositoriesModule
        .iden3commRepository(gh<_i121.Iden3commRepositoryImpl>()));
    gh.factoryAsync<_i142.IdentityRepositoryImpl>(
        () async => _i142.IdentityRepositoryImpl(
              gh<_i58.WalletDataSource>(),
              gh<_i95.RemoteIdentityDataSource>(),
              await getAsync<_i81.StorageIdentityDataSource>(),
              await getAsync<_i124.RPCDataSource>(),
              gh<_i34.LocalContractFilesDataSource>(),
              gh<_i33.LibBabyJubJubDataSource>(),
              gh<_i107.LibPolygonIdCoreIdentityDataSource>(),
              gh<_i19.EncryptionDbDataSource>(),
              gh<_i12.DestinationPathDataSource>(),
              gh<_i26.HexMapper>(),
              gh<_i46.PrivateKeyMapper>(),
              gh<_i30.IdentityDTOMapper>(),
              gh<_i96.RhsNodeMapper>(),
              gh<_i55.StateIdentifierMapper>(),
              gh<_i85.NodeMapper>(),
              gh<_i20.EncryptionKeyMapper>(),
              gh<_i99.SecureStorageProfilesDataSource>(),
            ));
    gh.factoryAsync<_i143.ProofRepositoryImpl>(
        () async => _i143.ProofRepositoryImpl(
              gh<_i61.WitnessDataSource>(),
              gh<_i50.ProverLibDataSource>(),
              gh<_i108.LibPolygonIdCoreProofDataSource>(),
              gh<_i24.GistMTProofDataSource>(),
              gh<_i47.ProofCircuitDataSource>(),
              gh<_i95.RemoteIdentityDataSource>(),
              gh<_i34.LocalContractFilesDataSource>(),
              gh<_i71.CircuitsDownloadDataSource>(),
              await getAsync<_i124.RPCDataSource>(),
              gh<_i8.CircuitTypeMapper>(),
              gh<_i69.ZKProofMapper>(),
              gh<_i73.ClaimMapper>(),
              gh<_i52.RevocationStatusMapper>(),
              gh<_i4.AuthProofMapper>(),
              await getAsync<_i72.CircuitsFilesDataSource>(),
              await getAsync<_i118.GetEnvUseCase>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factory<_i144.RemoveAllClaimsUseCase>(() => _i144.RemoveAllClaimsUseCase(
          gh<_i130.CredentialRepository>(),
          gh<_i54.StacktraceManager>(),
        ));
    gh.factory<_i145.RemoveClaimsUseCase>(() => _i145.RemoveClaimsUseCase(
          gh<_i130.CredentialRepository>(),
          gh<_i54.StacktraceManager>(),
        ));
    gh.factory<_i146.RemoveIdentityStateUseCase>(
        () => _i146.RemoveIdentityStateUseCase(
              gh<_i126.SMTRepository>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factory<_i147.SaveClaimsUseCase>(() => _i147.SaveClaimsUseCase(
          gh<_i130.CredentialRepository>(),
          gh<_i54.StacktraceManager>(),
        ));
    gh.factory<_i148.UpdateClaimUseCase>(() => _i148.UpdateClaimUseCase(
          gh<_i130.CredentialRepository>(),
          gh<_i54.StacktraceManager>(),
        ));
    gh.factory<_i149.CacheCredentialUseCase>(
        () => _i149.CacheCredentialUseCase(gh<_i130.CredentialRepository>()));
    gh.factoryAsync<_i150.CacheCredentialsUseCase>(
        () async => _i150.CacheCredentialsUseCase(
              gh<_i149.CacheCredentialUseCase>(),
              gh<_i54.StacktraceManager>(),
              await getAsync<_i118.GetEnvUseCase>(),
            ));
    gh.factory<_i151.CleanSchemaCacheUseCase>(
        () => _i151.CleanSchemaCacheUseCase(gh<_i141.Iden3commRepository>()));
    gh.factory<_i152.GetAuthChallengeUseCase>(
        () => _i152.GetAuthChallengeUseCase(
              gh<_i141.Iden3commRepository>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factory<_i153.GetJWZUseCase>(() => _i153.GetJWZUseCase(
          gh<_i141.Iden3commRepository>(),
          gh<_i54.StacktraceManager>(),
        ));
    gh.factoryAsync<_i154.IdentityRepository>(() async => repositoriesModule
        .identityRepository(await getAsync<_i142.IdentityRepositoryImpl>()));
    gh.factoryAsync<_i155.ProofRepository>(() async => repositoriesModule
        .proofRepository(await getAsync<_i143.ProofRepositoryImpl>()));
    gh.factoryAsync<_i156.ProveUseCase>(() async => _i156.ProveUseCase(
          await getAsync<_i155.ProofRepository>(),
          gh<_i54.StacktraceManager>(),
        ));
    gh.factoryAsync<_i157.SignMessageUseCase>(() async =>
        _i157.SignMessageUseCase(await getAsync<_i154.IdentityRepository>()));
    gh.factoryAsync<_i158.CancelDownloadCircuitsUseCase>(() async =>
        _i158.CancelDownloadCircuitsUseCase(
            await getAsync<_i155.ProofRepository>()));
    gh.factoryAsync<_i159.CircuitsFilesExistUseCase>(() async =>
        _i159.CircuitsFilesExistUseCase(
            await getAsync<_i155.ProofRepository>()));
    gh.factoryAsync<_i160.DownloadCircuitsUseCase>(() async =>
        _i160.DownloadCircuitsUseCase(await getAsync<_i155.ProofRepository>()));
    gh.factoryAsync<_i161.FetchStateRootsUseCase>(() async =>
        _i161.FetchStateRootsUseCase(
            await getAsync<_i154.IdentityRepository>()));
    gh.factoryAsync<_i162.GenerateZKProofUseCase>(
        () async => _i162.GenerateZKProofUseCase(
              await getAsync<_i155.ProofRepository>(),
              await getAsync<_i156.ProveUseCase>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i163.GetDidUseCase>(() async =>
        _i163.GetDidUseCase(await getAsync<_i154.IdentityRepository>()));
    gh.factoryAsync<_i164.GetGistMTProofUseCase>(
        () async => _i164.GetGistMTProofUseCase(
              await getAsync<_i155.ProofRepository>(),
              await getAsync<_i154.IdentityRepository>(),
              await getAsync<_i119.GetSelectedChainUseCase>(),
              await getAsync<_i163.GetDidUseCase>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i165.GetIdentitiesUseCase>(
        () async => _i165.GetIdentitiesUseCase(
              await getAsync<_i154.IdentityRepository>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i166.GetIdentityAuthClaimUseCase>(
        () async => _i166.GetIdentityAuthClaimUseCase(
              await getAsync<_i154.IdentityRepository>(),
              gh<_i133.GetAuthClaimUseCase>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i167.GetPrivateKeyUseCase>(
        () async => _i167.GetPrivateKeyUseCase(
              await getAsync<_i154.IdentityRepository>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i168.GetPublicKeysUseCase>(
        () async => _i168.GetPublicKeysUseCase(
              await getAsync<_i154.IdentityRepository>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i169.IsProofCircuitSupportedUseCase>(() async =>
        _i169.IsProofCircuitSupportedUseCase(
            await getAsync<_i155.ProofRepository>()));
    gh.factoryAsync<_i170.LoadCircuitUseCase>(
        () async => _i170.LoadCircuitUseCase(
              await getAsync<_i155.ProofRepository>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i171.Proof>(() async => _i171.Proof(
          await getAsync<_i162.GenerateZKProofUseCase>(),
          await getAsync<_i160.DownloadCircuitsUseCase>(),
          await getAsync<_i159.CircuitsFilesExistUseCase>(),
          gh<_i48.ProofGenerationStepsStreamManager>(),
          await getAsync<_i158.CancelDownloadCircuitsUseCase>(),
          gh<_i54.StacktraceManager>(),
        ));
    gh.factoryAsync<_i172.CreateIdentityStateUseCase>(
        () async => _i172.CreateIdentityStateUseCase(
              await getAsync<_i154.IdentityRepository>(),
              gh<_i126.SMTRepository>(),
              await getAsync<_i166.GetIdentityAuthClaimUseCase>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i173.FetchIdentityStateUseCase>(
        () async => _i173.FetchIdentityStateUseCase(
              await getAsync<_i154.IdentityRepository>(),
              await getAsync<_i119.GetSelectedChainUseCase>(),
              await getAsync<_i163.GetDidUseCase>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i174.GenerateNonRevProofUseCase>(
        () async => _i174.GenerateNonRevProofUseCase(
              await getAsync<_i154.IdentityRepository>(),
              gh<_i130.CredentialRepository>(),
              await getAsync<_i173.FetchIdentityStateUseCase>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i175.GetFiltersUseCase>(
        () async => _i175.GetFiltersUseCase(
              gh<_i120.Iden3commCredentialRepository>(),
              await getAsync<_i169.IsProofCircuitSupportedUseCase>(),
              gh<_i139.GetProofRequestsUseCase>(),
            ));
    gh.factoryAsync<_i176.GetGenesisStateUseCase>(
        () async => _i176.GetGenesisStateUseCase(
              await getAsync<_i154.IdentityRepository>(),
              gh<_i126.SMTRepository>(),
              await getAsync<_i166.GetIdentityAuthClaimUseCase>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i177.GetNonRevProofUseCase>(
        () async => _i177.GetNonRevProofUseCase(
              await getAsync<_i154.IdentityRepository>(),
              gh<_i130.CredentialRepository>(),
              await getAsync<_i173.FetchIdentityStateUseCase>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i178.GetClaimRevocationStatusUseCase>(
        () async => _i178.GetClaimRevocationStatusUseCase(
              gh<_i130.CredentialRepository>(),
              await getAsync<_i174.GenerateNonRevProofUseCase>(),
              await getAsync<_i177.GetNonRevProofUseCase>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i179.GetDidIdentifierUseCase>(
        () async => _i179.GetDidIdentifierUseCase(
              await getAsync<_i154.IdentityRepository>(),
              await getAsync<_i118.GetEnvUseCase>(),
              await getAsync<_i176.GetGenesisStateUseCase>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i180.GetIdentityUseCase>(
        () async => _i180.GetIdentityUseCase(
              await getAsync<_i154.IdentityRepository>(),
              await getAsync<_i163.GetDidUseCase>(),
              await getAsync<_i179.GetDidIdentifierUseCase>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i181.GetInteractionsUseCase>(
        () async => _i181.GetInteractionsUseCase(
              await getAsync<_i122.InteractionRepository>(),
              gh<_i7.CheckProfileValidityUseCase>(),
              await getAsync<_i180.GetIdentityUseCase>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i182.RemoveInteractionsUseCase>(
        () async => _i182.RemoveInteractionsUseCase(
              await getAsync<_i122.InteractionRepository>(),
              await getAsync<_i180.GetIdentityUseCase>(),
            ));
    gh.factoryAsync<_i183.AddInteractionUseCase>(
        () async => _i183.AddInteractionUseCase(
              await getAsync<_i122.InteractionRepository>(),
              gh<_i7.CheckProfileValidityUseCase>(),
              await getAsync<_i180.GetIdentityUseCase>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i184.CheckProfileAndDidCurrentEnvUseCase>(
        () async => _i184.CheckProfileAndDidCurrentEnvUseCase(
              gh<_i7.CheckProfileValidityUseCase>(),
              await getAsync<_i119.GetSelectedChainUseCase>(),
              await getAsync<_i179.GetDidIdentifierUseCase>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i185.FetchOnchainClaimsUseCase>(
        () async => _i185.FetchOnchainClaimsUseCase(
              await getAsync<_i131.FetchOnchainClaimUseCase>(),
              await getAsync<_i184.CheckProfileAndDidCurrentEnvUseCase>(),
              await getAsync<_i118.GetEnvUseCase>(),
              await getAsync<_i119.GetSelectedChainUseCase>(),
              await getAsync<_i179.GetDidIdentifierUseCase>(),
              await getAsync<_i163.GetDidUseCase>(),
              gh<_i147.SaveClaimsUseCase>(),
              gh<_i149.CacheCredentialUseCase>(),
              gh<_i34.LocalContractFilesDataSource>(),
              await getAsync<_i154.IdentityRepository>(),
              gh<_i115.DidProfileInfoRepository>(),
    ...
    gh.factoryAsync<_i186.GenerateIden3commProofUseCase>(
        () async => _i186.GenerateIden3commProofUseCase(
              await getAsync<_i154.IdentityRepository>(),
              gh<_i126.SMTRepository>(),
              await getAsync<_i155.ProofRepository>(),
              await getAsync<_i156.ProveUseCase>(),
              await getAsync<_i180.GetIdentityUseCase>(),
              gh<_i133.GetAuthClaimUseCase>(),
              await getAsync<_i164.GetGistMTProofUseCase>(),
              await getAsync<_i163.GetDidUseCase>(),
              await getAsync<_i157.SignMessageUseCase>(),
              gh<_i137.GetLatestStateUseCase>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i187.GetAuthInputsUseCase>(
        () async => _i187.GetAuthInputsUseCase(
              await getAsync<_i180.GetIdentityUseCase>(),
              gh<_i133.GetAuthClaimUseCase>(),
              await getAsync<_i157.SignMessageUseCase>(),
              await getAsync<_i164.GetGistMTProofUseCase>(),
    ...
    gh.factoryAsync<_i188.GetAuthTokenUseCase>(
        () async => _i188.GetAuthTokenUseCase(
              await getAsync<_i170.LoadCircuitUseCase>(),
              gh<_i153.GetJWZUseCase>(),
              gh<_i152.GetAuthChallengeUseCase>(),
              await getAsync<_i187.GetAuthInputsUseCase>(),
              await getAsync<_i156.ProveUseCase>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i189.GetCurrentEnvDidIdentifierUseCase>(
        () async => _i189.GetCurrentEnvDidIdentifierUseCase(
              await getAsync<_i119.GetSelectedChainUseCase>(),
              await getAsync<_i179.GetDidIdentifierUseCase>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i190.GetProfilesUseCase>(
        () async => _i190.GetProfilesUseCase(
              await getAsync<_i180.GetIdentityUseCase>(),
              await getAsync<_i184.CheckProfileAndDidCurrentEnvUseCase>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i191.RefreshCredentialUseCase>(
        () async => _i191.RefreshCredentialUseCase(
              gh<_i130.CredentialRepository>(),
              gh<_i54.StacktraceManager>(),
              await getAsync<_i180.GetIdentityUseCase>(),
              await getAsync<_i188.GetAuthTokenUseCase>(),
              gh<_i120.Iden3commCredentialRepository>(),
              gh<_i145.RemoveClaimsUseCase>(),
              gh<_i147.SaveClaimsUseCase>(),
            ));
    gh.factoryAsync<_i192.UpdateInteractionUseCase>(
        () async => _i192.UpdateInteractionUseCase(
              await getAsync<_i122.InteractionRepository>(),
              gh<_i7.CheckProfileValidityUseCase>(),
              await getAsync<_i180.GetIdentityUseCase>(),
              await getAsync<_i183.AddInteractionUseCase>(),
            ));
    gh.factoryAsync<_i193.BackupIdentityUseCase>(
        () async => _i193.BackupIdentityUseCase(
              await getAsync<_i180.GetIdentityUseCase>(),
              await getAsync<_i154.IdentityRepository>(),
              await getAsync<_i189.GetCurrentEnvDidIdentifierUseCase>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i194.CheckIdentityValidityUseCase>(
        () async => _i194.CheckIdentityValidityUseCase(
              await getAsync<_i167.GetPrivateKeyUseCase>(),
              await getAsync<_i189.GetCurrentEnvDidIdentifierUseCase>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i195.CreateIdentityUseCase>(
        () async => _i195.CreateIdentityUseCase(
              await getAsync<_i168.GetPublicKeysUseCase>(),
              await getAsync<_i189.GetCurrentEnvDidIdentifierUseCase>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i196.CreateProfilesUseCase>(
        () async => _i196.CreateProfilesUseCase(
              await getAsync<_i168.GetPublicKeysUseCase>(),
              await getAsync<_i189.GetCurrentEnvDidIdentifierUseCase>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i197.FetchAndSaveClaimsUseCase>(
        () async => _i197.FetchAndSaveClaimsUseCase(
              gh<_i120.Iden3commCredentialRepository>(),
              await getAsync<_i131.FetchOnchainClaimUseCase>(),
              await getAsync<_i184.CheckProfileAndDidCurrentEnvUseCase>(),
              await getAsync<_i118.GetEnvUseCase>(),
    ...
    gh.factoryAsync<_i198.FetchCredentialsUseCase>(
        () async => _i198.FetchCredentialsUseCase(
              await getAsync<_i119.GetSelectedChainUseCase>(),
              await getAsync<_i179.GetDidIdentifierUseCase>(),
              await getAsync<_i188.GetAuthTokenUseCase>(),
              gh<_i23.GetFetchRequestsUseCase>(),
    ...
    gh.factoryAsync<_i200.GetIden3commClaimsRevNonceUseCase>(
        () async => _i200.GetIden3commClaimsRevNonceUseCase(
              ...
              gh<_i134.GetClaimRevocationNonceUseCase>(),
              await getAsync<_i169.IsProofCircuitSupportedUseCase>(),
              gh<_i139.GetProofRequestsUseCase>(),
            ));
    gh.factoryAsync<_i201.GetIden3commClaimsUseCase>(
        () async => _i201.GetIden3commClaimsUseCase(
              gh<_i120.Iden3commCredentialRepository>(),
              await getAsync<_i199.GetClaimsUseCase>(),
              await getAsync<_i178.GetClaimRevocationStatusUseCase>(),
              gh<_i134.GetClaimRevocationNonceUseCase>(),
              gh<_i148.UpdateClaimUseCase>(),
              await getAsync<_i169.IsProofCircuitSupportedUseCase>(),
              gh<_i139.GetProofRequestsUseCase>(),
              gh<_i8.CircuitTypeMapper>(),
              gh<_i54.StacktraceManager>(),
    ...
    gh.factoryAsync<_i202.GetIden3commProofsUseCase>(
        () async => _i202.GetIden3commProofsUseCase(
              ...
              await getAsync<_i186.GenerateIden3commProofUseCase>(),
              await getAsync<_i169.IsProofCircuitSupportedUseCase>(),
              gh<_i139.GetProofRequestsUseCase>(),
              await getAsync<_i180.GetIdentityUseCase>(),
              gh<_i48.ProofGenerationStepsStreamManager>(),
              ...
              gh<_i145.RemoveClaimsUseCase>(),
              gh<_i147.SaveClaimsUseCase>(),
              await getAsync<_i191.RefreshCredentialUseCase>(),
            ));
    gh.factoryAsync<_i203.UpdateIdentityUseCase>(
        () async => _i203.UpdateIdentityUseCase(
              await getAsync<_i154.IdentityRepository>(),
              await getAsync<_i195.CreateIdentityUseCase>(),
              await getAsync<_i180.GetIdentityUseCase>(),
            ));
    gh.factoryAsync<_i204.AddIdentityUseCase>(
        () async => _i204.AddIdentityUseCase(
              await getAsync<_i154.IdentityRepository>(),
              await getAsync<_i195.CreateIdentityUseCase>(),
              await getAsync<_i172.CreateIdentityStateUseCase>(),
              gh<_i54.StacktraceManager>(),
            ));
    ...
    gh.factoryAsync<_i206.AddProfileUseCase>(
        () async => _i206.AddProfileUseCase(
              ...
              await getAsync<_i184.CheckProfileAndDidCurrentEnvUseCase>(),
              await getAsync<_i196.CreateProfilesUseCase>(),
              gh<_i107.LibPolygonIdCoreIdentityDataSource>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i207.AuthenticateUseCase>(
        () async => _i207.AuthenticateUseCase(
              ...
              await getAsync<_i118.GetEnvUseCase>(),
              await getAsync<_i119.GetSelectedChainUseCase>(),
              await getAsync<_i102.GetPackageNameUseCase>(),
              await getAsync<_i184.CheckProfileAndDidCurrentEnvUseCase>(),
              gh<_i48.ProofGenerationStepsStreamManager>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i208.Credential>(() async => _i208.Credential(
          ...
          gh<_i54.StacktraceManager>(),
          await getAsync<_i191.RefreshCredentialUseCase>(),
          gh<_i135.GetCredentialByIdUseCase>(),
          gh<_i136.GetCredentialByPartialIdUseCase>(),
          await getAsync<_i150.CacheCredentialsUseCase>(),
          gh<_i149.CacheCredentialUseCase>(),
        ));
    gh.factoryAsync<_i209.Iden3comm>(() async => _i209.Iden3comm(
          await getAsync<_i197.FetchAndSaveClaimsUseCase>(),
          await getAsync<_i185.FetchOnchainClaimsUseCase>(),
          gh<_i76.GetIden3MessageUseCase>(),
          gh<_i140.GetSchemasUseCase>(),
          gh<_i132.FetchSchemaUseCase>(),
          await getAsync<_i207.AuthenticateUseCase>(),
          await getAsync<_i175.GetFiltersUseCase>(),
          await getAsync<_i201.GetIden3commClaimsUseCase>(),
          await getAsync<_i200.GetIden3commClaimsRevNonceUseCase>(),
          await getAsync<_i202.GetIden3commProofsUseCase>(),
          await getAsync<_i181.GetInteractionsUseCase>(),
          await getAsync<_i183.AddInteractionUseCase>(),
          await getAsync<_i182.RemoveInteractionsUseCase>(),
          await getAsync<_i192.UpdateInteractionUseCase>(),
          gh<_i151.CleanSchemaCacheUseCase>(),
          gh<_i54.StacktraceManager>(),
          gh<_i129.AddDidProfileInfoUseCase>(),
          gh<_i117.GetDidProfileInfoUseCase>(),
          gh<_i116.GetDidProfileInfoListUseCase>(),
          gh<_i125.RemoveDidProfileInfoUseCase>(),
          await getAsync<_i188.GetAuthTokenUseCase>(),
          await getAsync<_i198.FetchCredentialsUseCase>(),
        ));
    gh.factoryAsync<_i210.RemoveProfileUseCase>(
        () async => _i210.RemoveProfileUseCase(
              ...
              await getAsync<_i184.CheckProfileAndDidCurrentEnvUseCase>(),
              await getAsync<_i196.CreateProfilesUseCase>(),
              gh<_i146.RemoveIdentityStateUseCase>(),
              gh<_i144.RemoveAllClaimsUseCase>(),
              gh<_i54.StacktraceManager>(),
            ));
    ...
    gh.factoryAsync<_i212.RemoveIdentityUseCase>(
        () async => _i212.RemoveIdentityUseCase(
              await getAsync<_i154.IdentityRepository>(),
              await getAsync<_i190.GetProfilesUseCase>(),
    ...
    gh.factoryAsync<_i214.Identity>(() async => _i214.Identity(
          await getAsync<_i194.CheckIdentityValidityUseCase>(),
          await getAsync<_i167.GetPrivateKeyUseCase>(),
          await getAsync<_i205.AddNewIdentityUseCase>(),
          await getAsync<_i213.RestoreIdentityUseCase>(),
          await getAsync<_i193.BackupIdentityUseCase>(),
          await getAsync<_i180.GetIdentityUseCase>(),
          await getAsync<_i165.GetIdentitiesUseCase>(),

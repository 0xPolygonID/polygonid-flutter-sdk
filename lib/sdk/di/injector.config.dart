...
import '../../domain/identity/repositories/identity_repository.dart' as _i26;
import '../../domain/identity/use_cases/create_identity_use_case.dart' as _i29;
import '../../domain/identity/use_cases/get_auth_token_use_case.dart' as _i30;
import '../../domain/identity/use_cases/get_current_identifier_use_case.dart'
    as _i31;
import '../../domain/identity/use_cases/get_identity_use_case.dart' as _i32;
import '../../domain/identity/use_cases/remove_current_identity_use_case.dart'
    as _i27;
import '../../domain/identity/use_cases/sign_message_use_case.dart' as _i28;
import '../../libs/circomlib.dart' as _i3;
import '../../libs/iden3corelib.dart' as _i11;
import '../credential_wallet.dart' as _i35;
import '../identity_wallet.dart' as _i33;
import 'injector.dart' as _i36; // ignore_for_file: unnecessary_lambdas
...
_i1.GetIt $initSDKGetIt(_i1.GetIt get,
  ...
  gh.factoryAsync<_i27.RemoveCurrentIdentityUseCase>(() async =>
      _i27.RemoveCurrentIdentityUseCase(
          await get.getAsync<_i26.IdentityRepository>()));
  gh.factoryAsync<_i28.SignMessageUseCase>(() async =>
      _i28.SignMessageUseCase(await get.getAsync<_i26.IdentityRepository>()));
  gh.factoryAsync<_i29.CreateIdentityUseCase>(() async =>
      _i29.CreateIdentityUseCase(
          await get.getAsync<_i26.IdentityRepository>()));
  gh.factoryAsync<_i30.GetAuthTokenUseCase>(() async =>
      _i30.GetAuthTokenUseCase(await get.getAsync<_i26.IdentityRepository>()));
  gh.factoryAsync<_i31.GetCurrentIdentifierUseCase>(() async =>
      _i31.GetCurrentIdentifierUseCase(
          await get.getAsync<_i26.IdentityRepository>()));
  gh.factoryAsync<_i32.GetIdentityUseCase>(() async =>
      _i32.GetIdentityUseCase(await get.getAsync<_i26.IdentityRepository>()));
  gh.factoryAsync<_i33.IdentityWallet>(() async => _i33.IdentityWallet(
      await get.getAsync<_i29.CreateIdentityUseCase>(),
      await get.getAsync<_i32.GetIdentityUseCase>(),
      await get.getAsync<_i28.SignMessageUseCase>(),
      await get.getAsync<_i30.GetAuthTokenUseCase>(),
      await get.getAsync<_i31.GetCurrentIdentifierUseCase>(),
      await get.getAsync<_i27.RemoveCurrentIdentityUseCase>()));
  gh.factoryAsync<_i34.FetchAndSaveClaimsUseCase>(() async =>
      _i34.FetchAndSaveClaimsUseCase(
          await get.getAsync<_i30.GetAuthTokenUseCase>(),
          await get.getAsync<_i23.CredentialRepository>()));
  gh.factoryAsync<_i35.CredentialWallet>(() async => _i35.CredentialWallet(
      await get.getAsync<_i34.FetchAndSaveClaimsUseCase>(),
...
class _$RepositoriesModule extends _i36.RepositoriesModule {}

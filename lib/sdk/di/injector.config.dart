...
import '../../iden3comm/domain/use_cases/get_proof_requests_use_case.dart'
    as _i23;
import '../../iden3comm/domain/use_cases/get_proofs_use_case.dart' as _i146;
...
import '../../identity/domain/use_cases/add_identity_use_case.dart' as _i138;
import '../../identity/domain/use_cases/add_profile_use_case.dart' as _i139;
...
import '../../identity/domain/use_cases/create_identity_state_use_case.dart'
    as _i129;
import '../../identity/domain/use_cases/create_identity_use_case.dart' as _i122;
import '../../identity/domain/use_cases/create_new_identity_use_case.dart'
    as _i142;
import '../../identity/domain/use_cases/export_identity_use_case.dart' as _i123;
...
import '../../identity/domain/use_cases/remove_profile_use_case.dart' as _i148;
...
import '../../identity/domain/use_cases/update_identity_use_case.dart' as _i137;
...
import '../../proof/data/mappers/gist_proof_mapper.dart' as _i77;
...
import '../iden3comm.dart' as _i152;
import '../identity.dart' as _i153;
import '../mappers/iden3_message_type_mapper.dart' as _i27;
import '../proof.dart' as _i147;
import 'injector.dart' as _i155; // ignore_for_file: unnecessary_lambdas
...
_i1.GetIt $initSDKGetIt(
  ...
  gh.factory<_i76.GistProofMapper>(
      () => _i76.GistProofMapper(get<_i24.HashMapper>()));
  gh.factory<_i77.GistProofMapper>(
      () => _i77.GistProofMapper(get<_i49.ProofMapper>()));
  ...
  gh.factoryAsync<_i122.CreateIdentityUseCase>(() async =>
      _i122.CreateIdentityUseCase(
          await get.getAsync<_i116.IdentityRepository>()));
  gh.factoryAsync<_i123.ExportIdentityUseCase>(() async =>
      _i123.ExportIdentityUseCase(
          await get.getAsync<_i116.IdentityRepository>()));
  ...
  gh.factoryAsync<_i137.UpdateIdentityUseCase>(
      () async => _i137.UpdateIdentityUseCase(
            await get.getAsync<_i116.IdentityRepository>(),
            await get.getAsync<_i122.CreateIdentityUseCase>(),
            await get.getAsync<_i129.CreateIdentityStateUseCase>(),
            await get.getAsync<_i120.RemoveIdentityStateUseCase>(),
            get<_i107.RemoveAllClaimsUseCase>(),
          ));
  gh.factoryAsync<_i138.AddIdentityUseCase>(
      () async => _i138.AddIdentityUseCase(
            await get.getAsync<_i116.IdentityRepository>(),
            await get.getAsync<_i122.CreateIdentityUseCase>(),
            await get.getAsync<_i129.CreateIdentityStateUseCase>(),
          ));
  gh.factoryAsync<_i139.AddProfileUseCase>(() async => _i139.AddProfileUseCase(
        await get.getAsync<_i116.IdentityRepository>(),
        await get.getAsync<_i134.GetIdentityUseCase>(),
        await get.getAsync<_i125.GetDidUseCase>(),
        await get.getAsync<_i137.UpdateIdentityUseCase>(),
      ));
  gh.factoryAsync<_i140.BackupIdentityUseCase>(
      () async => _i140.BackupIdentityUseCase(
            await get.getAsync<_i134.GetIdentityUseCase>(),
            await get.getAsync<_i123.ExportIdentityUseCase>(),
            await get.getAsync<_i133.GetDidIdentifierUseCase>(),
          ));
  ...
  gh.factoryAsync<_i142.CreateNewIdentityUseCase>(
      () async => _i142.CreateNewIdentityUseCase(
            get<String>(instanceName: 'accessMessage'),
            await get.getAsync<_i116.IdentityRepository>(),
            await get.getAsync<_i138.AddIdentityUseCase>(),
          ));
  ...
  gh.factoryAsync<_i146.GetProofsUseCase>(() async => _i146.GetProofsUseCase(
        get<_i105.ProofRepository>(),
        await get.getAsync<_i116.IdentityRepository>(),
  ...
  gh.factoryAsync<_i148.RemoveProfileUseCase>(
      () async => _i148.RemoveProfileUseCase(
            await get.getAsync<_i116.IdentityRepository>(),
            await get.getAsync<_i134.GetIdentityUseCase>(),
            await get.getAsync<_i125.GetDidUseCase>(),
            await get.getAsync<_i137.UpdateIdentityUseCase>(),
          ));
  gh.factoryAsync<_i149.RestoreIdentityUseCase>(
      () async => _i149.RestoreIdentityUseCase(
            await get.getAsync<_i138.AddIdentityUseCase>(),
            await get.getAsync<_i134.GetIdentityUseCase>(),
  ...
  gh.factoryAsync<_i150.AuthenticateUseCase>(
      () async => _i150.AuthenticateUseCase(
            get<_i103.Iden3commRepository>(),
            await get.getAsync<_i146.GetProofsUseCase>(),
            await get.getAsync<_i145.GetAuthTokenUseCase>(),
            get<_i101.GetEnvConfigUseCase>(),
            await get.getAsync<_i92.GetPackageNameUseCase>(),
            await get.getAsync<_i133.GetDidIdentifierUseCase>(),
          ));
  gh.factoryAsync<_i151.FetchAndSaveClaimsUseCase>(
      () async => _i151.FetchAndSaveClaimsUseCase(
            get<_i19.GetFetchRequestsUseCase>(),
            await get.getAsync<_i145.GetAuthTokenUseCase>(),
            get<_i98.CredentialRepository>(),
          ));
  gh.factoryAsync<_i152.Iden3comm>(() async => _i152.Iden3comm(
        get<_i102.GetVocabsUseCase>(),
        await get.getAsync<_i150.AuthenticateUseCase>(),
        await get.getAsync<_i146.GetProofsUseCase>(),
        get<_i21.GetIden3MessageUseCase>(),
      ));
  gh.factoryAsync<_i153.Identity>(() async => _i153.Identity(
        await get.getAsync<_i141.CheckIdentityValidityUseCase>(),
        await get.getAsync<_i142.CreateNewIdentityUseCase>(),
        await get.getAsync<_i149.RestoreIdentityUseCase>(),
        ...
        await get.getAsync<_i121.SignMessageUseCase>(),
        await get.getAsync<_i130.FetchIdentityStateUseCase>(),
        await get.getAsync<_i139.AddProfileUseCase>(),
        await get.getAsync<_i135.GetProfilesUseCase>(),
        await get.getAsync<_i148.RemoveProfileUseCase>(),
      ));
  gh.factoryAsync<_i154.Credential>(() async => _i154.Credential(
        await get.getAsync<_i151.FetchAndSaveClaimsUseCase>(),
        get<_i100.GetClaimsUseCase>(),
...
class _$PlatformModule extends _i155.PlatformModule {}

class _$NetworkModule extends _i155.NetworkModule {}

class _$DatabaseModule extends _i155.DatabaseModule {}

class _$EncryptionModule extends _i155.EncryptionModule {}

class _$Sdk extends _i155.Sdk {}

class _$ZipDecoderModule extends _i155.ZipDecoderModule {}

class _$RepositoriesModule extends _i155.RepositoriesModule {}

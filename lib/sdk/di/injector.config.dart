...
import '../../common/domain/use_cases/get_config_use_case.dart' as _i103;
...
import '../../credential/domain/repositories/credential_repository.dart'
    as _i98;
import '../../credential/domain/use_cases/fetch_schema_use_case.dart' as _i99;
import '../../credential/domain/use_cases/fetch_vocab_use_case.dart' as _i100;
...
import '../../credential/domain/use_cases/get_claim_revocation_status_use_case.dart'
    as _i134;
import '../../credential/domain/use_cases/get_claims_use_case.dart' as _i102;
import '../../credential/domain/use_cases/remove_all_claims_use_case.dart'
    as _i110;
import '../../credential/domain/use_cases/remove_claims_use_case.dart' as _i111;
import '../../credential/domain/use_cases/save_claims_use_case.dart' as _i150;
import '../../credential/domain/use_cases/update_claim_use_case.dart' as _i114;
...
import '../../iden3comm/data/repositories/iden3comm_repository_impl.dart'
    as _i105;
import '../../iden3comm/domain/repositories/iden3comm_repository.dart' as _i126;
...
import '../../iden3comm/domain/use_cases/get_proof_requests_use_case.dart'
    as _i23;
import '../../iden3comm/domain/use_cases/get_vocabs_use_case.dart' as _i104;
...
import '../../identity/data/repositories/identity_repository_impl.dart' as _i93;
import '../../identity/data/repositories/smt_repository_impl.dart' as _i96;
import '../../identity/domain/repositories/identity_repository.dart' as _i106;
...
import '../../identity/domain/use_cases/import_identity_use_case.dart' as _i107;
...
import '../../identity/domain/use_cases/restore_identity_use_case.dart'
    as _i160;
import '../../identity/domain/use_cases/sign_message_use_case.dart' as _i113;
...
import '../../proof/domain/repositories/proof_repository.dart' as _i108;
import '../../proof/domain/use_cases/circuits_files_exist_use_case.dart'
    as _i115;
import '../../proof/domain/use_cases/download_circuits_use_case.dart' as _i116;
...
import '../../proof/domain/use_cases/is_proof_circuit_supported_use_case.dart'
    as _i127;
import '../../proof/domain/use_cases/load_circuit_use_case.dart' as _i128;
import '../../proof/domain/use_cases/prove_use_case.dart' as _i109;
...
_i1.GetIt $initSDKGetIt(
  ...
  gh.factoryAsync<_i93.IdentityRepositoryImpl>(
      () async => _i93.IdentityRepositoryImpl(
  ...
  gh.factory<_i99.FetchSchemaUseCase>(
      () => _i99.FetchSchemaUseCase(get<_i98.CredentialRepository>()));
  gh.factory<_i100.FetchVocabUseCase>(
      () => _i100.FetchVocabUseCase(get<_i98.CredentialRepository>()));
  gh.factory<_i101.GetAuthClaimUseCase>(
      () => _i101.GetAuthClaimUseCase(get<_i98.CredentialRepository>()));
  gh.factory<_i102.GetClaimsUseCase>(
      () => _i102.GetClaimsUseCase(get<_i98.CredentialRepository>()));
  gh.factory<_i103.GetEnvConfigUseCase>(
      () => _i103.GetEnvConfigUseCase(get<_i97.ConfigRepository>()));
  gh.factory<_i104.GetVocabsUseCase>(() => _i104.GetVocabsUseCase(
        get<_i99.FetchSchemaUseCase>(),
        get<_i100.FetchVocabUseCase>(),
      ));
  ...
  gh.factoryAsync<_i106.IdentityRepository>(() async => repositoriesModule
      .identityRepository(await get.getAsync<_i93.IdentityRepositoryImpl>()));
  gh.factoryAsync<_i107.ImportIdentityUseCase>(() async =>
      _i107.ImportIdentityUseCase(
          await get.getAsync<_i106.IdentityRepository>()));
  gh.factory<_i108.ProofRepository>(() =>
      repositoriesModule.proofRepository(get<_i94.ProofRepositoryImpl>()));
  gh.factory<_i109.ProveUseCase>(
      () => _i109.ProveUseCase(get<_i108.ProofRepository>()));
  gh.factory<_i110.RemoveAllClaimsUseCase>(
      () => _i110.RemoveAllClaimsUseCase(get<_i98.CredentialRepository>()));
  gh.factory<_i111.RemoveClaimsUseCase>(
      () => _i111.RemoveClaimsUseCase(get<_i98.CredentialRepository>()));
  gh.factory<_i112.SMTRepository>(
      () => repositoriesModule.smtRepository(get<_i96.SMTRepositoryImpl>()));
  gh.factoryAsync<_i113.SignMessageUseCase>(() async =>
      _i113.SignMessageUseCase(await get.getAsync<_i106.IdentityRepository>()));
  gh.factory<_i114.UpdateClaimUseCase>(
      () => _i114.UpdateClaimUseCase(get<_i98.CredentialRepository>()));
  gh.factory<_i115.CircuitsFilesExistUseCase>(
      () => _i115.CircuitsFilesExistUseCase(get<_i108.ProofRepository>()));
  gh.factory<_i116.DownloadCircuitsUseCase>(() => _i116.DownloadCircuitsUseCase(
        get<_i108.ProofRepository>(),
        get<_i115.CircuitsFilesExistUseCase>(),
      ));
  ...
  gh.factoryAsync<_i119.GetDidUseCase>(() async =>
      _i119.GetDidUseCase(await get.getAsync<_i106.IdentityRepository>()));
  gh.factoryAsync<_i120.GetGistProofUseCase>(
      () async => _i120.GetGistProofUseCase(
            get<_i108.ProofRepository>(),
            await get.getAsync<_i106.IdentityRepository>(),
            get<_i103.GetEnvConfigUseCase>(),
  ...
  gh.factory<_i123.GetJWZUseCase>(
      () => _i123.GetJWZUseCase(get<_i108.ProofRepository>()));
  gh.factory<_i124.GetLatestStateUseCase>(
      () => _i124.GetLatestStateUseCase(get<_i112.SMTRepository>()));
  ...
  gh.factory<_i127.IsProofCircuitSupportedUseCase>(
      () => _i127.IsProofCircuitSupportedUseCase(get<_i108.ProofRepository>()));
  gh.factory<_i128.LoadCircuitUseCase>(
      () => _i128.LoadCircuitUseCase(get<_i108.ProofRepository>()));
  gh.factory<_i129.RemoveIdentityStateUseCase>(
      () => _i129.RemoveIdentityStateUseCase(get<_i112.SMTRepository>()));
  ...
  gh.factory<_i133.GetAuthChallengeUseCase>(
      () => _i133.GetAuthChallengeUseCase(get<_i126.Iden3commRepository>()));
  ...
  gh.factory<_i135.GetFiltersUseCase>(() => _i135.GetFiltersUseCase(
        get<_i126.Iden3commRepository>(),
        get<_i127.IsProofCircuitSupportedUseCase>(),
  ...
  gh.factoryAsync<_i141.RemoveIdentityUseCase>(
      () async => _i141.RemoveIdentityUseCase(
            ...
            get<_i110.RemoveAllClaimsUseCase>(),
          ));
  ...
  gh.factoryAsync<_i145.GenerateProofUseCase>(
      () async => _i145.GenerateProofUseCase(
            ...
            get<_i112.SMTRepository>(),
            get<_i108.ProofRepository>(),
            get<_i109.ProveUseCase>(),
            await get.getAsync<_i139.GetIdentityUseCase>(),
            get<_i101.GetAuthClaimUseCase>(),
            await get.getAsync<_i120.GetGistProofUseCase>(),
            await get.getAsync<_i119.GetDidUseCase>(),
            await get.getAsync<_i113.SignMessageUseCase>(),
  ...
  gh.factoryAsync<_i147.GetAuthTokenUseCase>(
      () async => _i147.GetAuthTokenUseCase(
            get<_i128.LoadCircuitUseCase>(),
            get<_i123.GetJWZUseCase>(),
            get<_i133.GetAuthChallengeUseCase>(),
  ...
  gh.factoryAsync<_i149.Proof>(() async => _i149.Proof(
        await get.getAsync<_i145.GenerateProofUseCase>(),
        get<_i116.DownloadCircuitsUseCase>(),
        get<_i115.CircuitsFilesExistUseCase>(),
      ));
  ...
  gh.factoryAsync<_i160.RestoreIdentityUseCase>(
      () async => _i160.RestoreIdentityUseCase(
            await get.getAsync<_i152.AddIdentityUseCase>(),
            await get.getAsync<_i139.GetIdentityUseCase>(),
            await get.getAsync<_i107.ImportIdentityUseCase>(),
            await get.getAsync<_i138.GetDidIdentifierUseCase>(),
          ));

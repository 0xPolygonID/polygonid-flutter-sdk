...
import 'package:logger/logger.dart' as _i34;
...
import 'package:polygonid_flutter_sdk/identity/domain/use_cases/smt/remove_identity_state_use_case.dart'
    as _i148;
import 'package:polygonid_flutter_sdk/identity/libs/bjj/bjj.dart' as _i5;
...
import 'package:polygonid_flutter_sdk/proof/libs/witnesscalc/v3_onchain/witness_v3_onchain.dart'
    as _i68;
import 'package:polygonid_flutter_sdk/sdk/credential.dart' as _i210;
import 'package:polygonid_flutter_sdk/sdk/di/injector.dart' as _i217;
import 'package:polygonid_flutter_sdk/sdk/error_handling.dart' as _i76;
import 'package:polygonid_flutter_sdk/sdk/iden3comm.dart' as _i211;
import 'package:polygonid_flutter_sdk/sdk/identity.dart' as _i216;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt $initSDKGetIt({
    ...
    gh.factory<_i11.DestinationPathDataSource>(
        () => _i11.DestinationPathDataSource(gh<_i11.CreatePathWrapper>()));
    gh.factory<_i13.DidProfileInfoInteractedDidFilterMapper>(
        () => _i13.DidProfileInfoInteractedDidFilterMapper());
    gh.factory<_i14.Dio>(() => networkModule.dio);
    gh.factoryAsync<_i15.Directory>(
        () => filesManagerModule.applicationDocumentsDirectory);
    gh.factory<_i16.DisplayTypeMapper>(() => _i16.DisplayTypeMapper());
    ...
    gh.factory<_i32.LibBabyJubJubDataSource>(
        () => _i32.LibBabyJubJubDataSource(gh<_i5.BabyjubjubLib>()));
    gh.factory<_i33.LocalContractFilesDataSource>(
        () => _i33.LocalContractFilesDataSource());
    gh.factory<_i34.Logger>(() => loggerModule.logger);
    gh.factory<_i35.MTProofMapper>(
        () => _i35.MTProofMapper(gh<_i24.HashMapper>()));
    ...
    gh.factory<_i45.PoseidonHashMapper>(
        () => _i45.PoseidonHashMapper(gh<_i25.HexMapper>()));
    ...
    gh.factory<_i71.AuthProofMapper>(
        () => _i71.AuthProofMapper(gh<_i24.HashMapper>()));
    gh.factory<_i72.CircuitsDownloadDataSource>(
        () => _i72.CircuitsDownloadDataSource(gh<_i14.Dio>()));
    gh.factoryAsync<_i73.CircuitsFilesDataSource>(() async =>
        _i73.CircuitsFilesDataSource(await getAsync<_i15.Directory>()));
    gh.factory<_i74.ClaimMapper>(() => _i74.ClaimMapper(
          gh<_i9.ClaimStateMapper>(),
          gh<_i8.ClaimInfoMapper>(),
          gh<_i16.DisplayTypeMapper>(),
        ));
    gh.factory<_i75.ClaimStoreRefWrapper>(() => _i75.ClaimStoreRefWrapper(
        gh<_i12.StoreRef<String, Map<String, Object?>>>(
            instanceName: 'claimStore')));
    gh.factory<_i76.ErrorHandling>(
        () => _i76.ErrorHandling(gh<_i54.StacktraceManager>()));
    gh.factory<_i77.GetIden3MessageUseCase>(
        () => _i77.GetIden3MessageUseCase(gh<_i54.StacktraceManager>()));
    gh.factory<_i78.GetProofQueryUseCase>(
        () => _i78.GetProofQueryUseCase(gh<_i54.StacktraceManager>()));
    gh.factory<_i79.GistMTProofMapper>(() => _i79.GistMTProofMapper(
          gh<_i35.MTProofMapper>(),
          gh<_i24.HashMapper>(),
        ));
    gh.factory<_i80.Iden3MessageDataSource>(
        () => _i80.Iden3MessageDataSource(gh<_i54.StacktraceManager>()));
    gh.factory<_i81.Iden3commProofMapper>(
        () => _i81.Iden3commProofMapper(gh<_i28.Iden3commVPProofMapper>()));
    gh.factory<_i82.IdentitySMTStoreRefWrapper>(() =>
        _i82.IdentitySMTStoreRefWrapper(
            gh<Map<String, _i12.StoreRef<String, Map<String, Object?>>>>(
                instanceName: 'identityStateStore')));
    ...
    gh.factory<_i84.InteractionStoreRefWrapper>(() =>
        _i84.InteractionStoreRefWrapper(
            gh<_i12.StoreRef<String, Map<String, Object?>>>(
                instanceName: 'interactionStore')));
    gh.factory<_i85.JWZMapper>(
        () => _i85.JWZMapper(gh<_i54.StacktraceManager>()));
    gh.factory<_i86.KeyValueStoreRefWrapper>(() => _i86.KeyValueStoreRefWrapper(
        gh<_i12.StoreRef<String, dynamic>>(instanceName: 'keyValueStore')));
    ...
    gh.factory<_i89.PolygonIdCoreCredential>(
        () => _i89.PolygonIdCoreCredential(gh<_i54.StacktraceManager>()));
    gh.factory<_i90.PolygonIdCoreIden3comm>(
        () => _i90.PolygonIdCoreIden3comm(gh<_i54.StacktraceManager>()));
    gh.factory<_i91.PolygonIdCoreIdentity>(
        () => _i91.PolygonIdCoreIdentity(gh<_i54.StacktraceManager>()));
    gh.factory<_i92.PolygonIdCoreProof>(
        () => _i92.PolygonIdCoreProof(gh<_i54.StacktraceManager>()));
    gh.factory<_i93.PolygonIdFlutterChannel>(() => _i93.PolygonIdFlutterChannel(
          gh<_i43.PolygonIdSdk>(),
          gh<_i3.MethodChannel>(),
        ));
    gh.factory<_i94.ProofRequestFiltersMapper>(
        () => _i94.ProofRequestFiltersMapper(gh<_i54.StacktraceManager>()));
    gh.factory<_i50.ProverLibDataSource>(
        () => _i50.ProverLibDataSource(gh<_i50.ProverLibWrapper>()));
    gh.factory<_i95.RemoteClaimDataSource>(() => _i95.RemoteClaimDataSource(
          gh<_i10.Client>(),
          gh<_i54.StacktraceManager>(),
        ));
    gh.factory<_i96.RemoteIden3commDataSource>(
        () => _i96.RemoteIden3commDataSource(
              gh<_i14.Dio>(),
              gh<_i10.Client>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factory<_i97.RemoteIdentityDataSource>(
        () => _i97.RemoteIdentityDataSource(gh<_i54.StacktraceManager>()));
    gh.factory<_i98.RhsNodeMapper>(
        () => _i98.RhsNodeMapper(gh<_i53.RhsNodeTypeMapper>()));
    gh.factory<_i99.SecureDidProfileInfoStoreRefWrapper>(() =>
        _i99.SecureDidProfileInfoStoreRefWrapper(
            gh<_i12.StoreRef<String, Map<String, Object?>>>(
                instanceName: 'didProfileInfoStore')));
    gh.factory<_i100.SecureInteractionStoreRefWrapper>(() =>
        _i100.SecureInteractionStoreRefWrapper(
            gh<_i12.StoreRef<String, Map<String, Object?>>>(
                instanceName: 'interactionStore')));
    gh.factory<_i99.SecureStorageDidProfileInfoDataSource>(() =>
        _i99.SecureStorageDidProfileInfoDataSource(
            gh<_i99.SecureDidProfileInfoStoreRefWrapper>()));
    gh.factory<_i100.SecureStorageInteractionDataSource>(() =>
        _i100.SecureStorageInteractionDataSource(
            gh<_i100.SecureInteractionStoreRefWrapper>()));
    gh.factory<_i101.SecureStorageProfilesStoreRefWrapper>(() =>
        _i101.SecureStorageProfilesStoreRefWrapper(
            gh<_i12.StoreRef<String, Map<String, Object?>>>(
                instanceName: 'profilesStore')));
    gh.factory<_i75.StorageClaimDataSource>(
        () => _i75.StorageClaimDataSource(gh<_i75.ClaimStoreRefWrapper>()));
    gh.factoryAsync<_i83.StorageIdentityDataSource>(
        () async => _i83.StorageIdentityDataSource(
              await getAsync<_i12.Database>(),
              gh<_i83.IdentityStoreRefWrapper>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i84.StorageInteractionDataSource>(
        () async => _i84.StorageInteractionDataSource(
              await getAsync<_i12.Database>(),
              gh<_i84.InteractionStoreRefWrapper>(),
            ));
    gh.factoryAsync<_i86.StorageKeyValueDataSource>(
        () async => _i86.StorageKeyValueDataSource(
              await getAsync<_i12.Database>(),
              gh<_i86.KeyValueStoreRefWrapper>(),
            ));
    gh.factory<_i82.StorageSMTDataSource>(
        () => _i82.StorageSMTDataSource(gh<_i82.IdentitySMTStoreRefWrapper>()));
    ...
    gh.factoryAsync<_i102.ConfigRepositoryImpl>(() async =>
        _i102.ConfigRepositoryImpl(
            await getAsync<_i86.StorageKeyValueDataSource>()));
    gh.factory<_i103.DidProfileInfoRepositoryImpl>(
        () => _i103.DidProfileInfoRepositoryImpl(
              gh<_i99.SecureStorageDidProfileInfoDataSource>(),
              gh<_i21.FiltersMapper>(),
              gh<_i13.DidProfileInfoInteractedDidFilterMapper>(),
            ));
    gh.factoryAsync<_i104.GetPackageNameUseCase>(() async =>
        _i104.GetPackageNameUseCase(
            await getAsync<_i88.PackageInfoRepository>()));
    gh.factory<_i105.Iden3commCredentialRepositoryImpl>(
        () => _i105.Iden3commCredentialRepositoryImpl(
              gh<_i96.RemoteIden3commDataSource>(),
              gh<_i94.ProofRequestFiltersMapper>(),
              gh<_i74.ClaimMapper>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i106.InteractionRepositoryImpl>(
        () async => _i106.InteractionRepositoryImpl(
              gh<_i100.SecureStorageInteractionDataSource>(),
              await getAsync<_i84.StorageInteractionDataSource>(),
              gh<_i31.InteractionMapper>(),
              gh<_i21.FiltersMapper>(),
              gh<_i30.InteractionIdFilterMapper>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factory<_i107.LibPolygonIdCoreCredentialDataSource>(() =>
        _i107.LibPolygonIdCoreCredentialDataSource(
            gh<_i89.PolygonIdCoreCredential>()));
    gh.factory<_i108.LibPolygonIdCoreIden3commDataSource>(() =>
        _i108.LibPolygonIdCoreIden3commDataSource(
            gh<_i90.PolygonIdCoreIden3comm>()));
    gh.factory<_i109.LibPolygonIdCoreIdentityDataSource>(() =>
        _i109.LibPolygonIdCoreIdentityDataSource(
            gh<_i91.PolygonIdCoreIdentity>()));
    gh.factory<_i110.LibPolygonIdCoreWrapper>(
        () => _i110.LibPolygonIdCoreWrapper(gh<_i92.PolygonIdCoreProof>()));
    gh.factory<_i111.LocalClaimDataSource>(() => _i111.LocalClaimDataSource(
        gh<_i107.LibPolygonIdCoreCredentialDataSource>()));
    gh.factory<_i112.SMTDataSource>(() => _i112.SMTDataSource(
          gh<_i25.HexMapper>(),
          gh<_i32.LibBabyJubJubDataSource>(),
          gh<_i82.StorageSMTDataSource>(),
        ));
    gh.factory<_i113.SMTRepositoryImpl>(() => _i113.SMTRepositoryImpl(
          gh<_i112.SMTDataSource>(),
          gh<_i82.StorageSMTDataSource>(),
          gh<_i32.LibBabyJubJubDataSource>(),
          gh<_i87.NodeMapper>(),
          gh<_i24.HashMapper>(),
    ...
    gh.factory<_i101.SecureStorageProfilesDataSource>(() =>
        _i101.SecureStorageProfilesDataSource(
            gh<_i101.SecureStorageProfilesStoreRefWrapper>()));
    gh.factory<_i114.CacheCredentialDataSource>(() =>
        _i114.CacheCredentialDataSource(
            gh<_i107.LibPolygonIdCoreCredentialDataSource>()));
    gh.factoryAsync<_i115.ConfigRepository>(() async => repositoriesModule
        .configRepository(await getAsync<_i102.ConfigRepositoryImpl>()));
    gh.factory<_i116.CredentialRepositoryImpl>(
        () => _i116.CredentialRepositoryImpl(
              gh<_i95.RemoteClaimDataSource>(),
              gh<_i75.StorageClaimDataSource>(),
              gh<_i111.LocalClaimDataSource>(),
              gh<_i114.CacheCredentialDataSource>(),
              gh<_i74.ClaimMapper>(),
              gh<_i21.FiltersMapper>(),
              gh<_i26.IdFilterMapper>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factory<_i117.DidProfileInfoRepository>(() => repositoriesModule
        .didProfileInfoRepository(gh<_i103.DidProfileInfoRepositoryImpl>()));
    gh.factory<_i118.GetDidProfileInfoListUseCase>(() =>
        _i118.GetDidProfileInfoListUseCase(
            gh<_i117.DidProfileInfoRepository>()));
    gh.factory<_i119.GetDidProfileInfoUseCase>(() =>
        _i119.GetDidProfileInfoUseCase(gh<_i117.DidProfileInfoRepository>()));
    gh.factoryAsync<_i120.GetEnvUseCase>(() async => _i120.GetEnvUseCase(
          await getAsync<_i115.ConfigRepository>(),
          gh<_i54.StacktraceManager>(),
        ));
    gh.factoryAsync<_i121.GetSelectedChainUseCase>(
        () async => _i121.GetSelectedChainUseCase(
              await getAsync<_i115.ConfigRepository>(),
              await getAsync<_i120.GetEnvUseCase>(),
            ));
    gh.factory<_i122.Iden3commCredentialRepository>(() =>
        repositoriesModule.iden3commCredentialRepository(
            gh<_i105.Iden3commCredentialRepositoryImpl>()));
    gh.factory<_i123.Iden3commRepositoryImpl>(
        () => _i123.Iden3commRepositoryImpl(
              gh<_i80.Iden3MessageDataSource>(),
              gh<_i96.RemoteIden3commDataSource>(),
              gh<_i108.LibPolygonIdCoreIden3commDataSource>(),
              gh<_i32.LibBabyJubJubDataSource>(),
              gh<_i4.AuthResponseMapper>(),
              gh<_i71.AuthProofMapper>(),
              gh<_i79.GistMTProofMapper>(),
              gh<_i51.QMapper>(),
              gh<_i85.JWZMapper>(),
              gh<_i81.Iden3commProofMapper>(),
              gh<_i77.GetIden3MessageUseCase>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i124.InteractionRepository>(() async =>
        repositoriesModule.interactionRepository(
            await getAsync<_i106.InteractionRepositoryImpl>()));
    gh.factory<_i110.LibPolygonIdCoreProofDataSource>(
        () => _i110.LibPolygonIdCoreProofDataSource(
              gh<_i110.LibPolygonIdCoreWrapper>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i125.ListenAndStoreNotificationUseCase>(() async =>
        _i125.ListenAndStoreNotificationUseCase(
            await getAsync<_i124.InteractionRepository>()));
    gh.factoryAsync<_i126.RPCDataSource>(() async => _i126.RPCDataSource(
          await getAsync<_i121.GetSelectedChainUseCase>(),
          gh<_i54.StacktraceManager>(),
        ));
    gh.factory<_i127.RemoveDidProfileInfoUseCase>(() =>
        _i127.RemoveDidProfileInfoUseCase(
            gh<_i117.DidProfileInfoRepository>()));
    gh.factory<_i128.SMTRepository>(
        () => repositoriesModule.smtRepository(gh<_i113.SMTRepositoryImpl>()));
    gh.factoryAsync<_i129.SetEnvUseCase>(() async =>
        _i129.SetEnvUseCase(await getAsync<_i115.ConfigRepository>()));
    gh.factoryAsync<_i130.SetSelectedChainUseCase>(() async =>
        _i130.SetSelectedChainUseCase(
            await getAsync<_i115.ConfigRepository>()));
    gh.factory<_i131.AddDidProfileInfoUseCase>(() =>
        _i131.AddDidProfileInfoUseCase(gh<_i117.DidProfileInfoRepository>()));
    gh.factory<_i132.CredentialRepository>(() => repositoriesModule
        .credentialRepository(gh<_i116.CredentialRepositoryImpl>()));
    gh.factoryAsync<_i133.FetchOnchainClaimUseCase>(
        () async => _i133.FetchOnchainClaimUseCase(
              await getAsync<_i121.GetSelectedChainUseCase>(),
              await getAsync<_i120.GetEnvUseCase>(),
              gh<_i107.LibPolygonIdCoreCredentialDataSource>(),
              gh<_i33.LocalContractFilesDataSource>(),
              gh<_i96.RemoteIden3commDataSource>(),
              gh<_i74.ClaimMapper>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factory<_i134.FetchSchemaUseCase>(() =>
        _i134.FetchSchemaUseCase(gh<_i122.Iden3commCredentialRepository>()));
    gh.factory<_i135.GetAuthClaimUseCase>(() => _i135.GetAuthClaimUseCase(
          gh<_i132.CredentialRepository>(),
          gh<_i54.StacktraceManager>(),
        ));
    gh.factory<_i136.GetClaimRevocationNonceUseCase>(() =>
        _i136.GetClaimRevocationNonceUseCase(gh<_i132.CredentialRepository>()));
    gh.factory<_i137.GetCredentialByIdUseCase>(
        () => _i137.GetCredentialByIdUseCase(gh<_i132.CredentialRepository>()));
    gh.factory<_i138.GetCredentialByPartialIdUseCase>(
        () => _i138.GetCredentialByPartialIdUseCase(
              gh<_i132.CredentialRepository>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factory<_i139.GetLatestStateUseCase>(() => _i139.GetLatestStateUseCase(
          gh<_i128.SMTRepository>(),
          gh<_i54.StacktraceManager>(),
        ));
    gh.factory<_i140.GetProofQueryContextUseCase>(
        () => _i140.GetProofQueryContextUseCase(
              gh<_i122.Iden3commCredentialRepository>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factory<_i141.GetProofRequestsUseCase>(
        () => _i141.GetProofRequestsUseCase(
              gh<_i140.GetProofQueryContextUseCase>(),
              gh<_i78.GetProofQueryUseCase>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factory<_i142.GetSchemasUseCase>(() =>
        _i142.GetSchemasUseCase(gh<_i122.Iden3commCredentialRepository>()));
    gh.factory<_i143.Iden3commRepository>(() => repositoriesModule
        .iden3commRepository(gh<_i123.Iden3commRepositoryImpl>()));
    gh.factoryAsync<_i144.IdentityRepositoryImpl>(
        () async => _i144.IdentityRepositoryImpl(
              gh<_i58.WalletDataSource>(),
              gh<_i97.RemoteIdentityDataSource>(),
              await getAsync<_i83.StorageIdentityDataSource>(),
              await getAsync<_i126.RPCDataSource>(),
              gh<_i33.LocalContractFilesDataSource>(),
              gh<_i32.LibBabyJubJubDataSource>(),
              gh<_i109.LibPolygonIdCoreIdentityDataSource>(),
              gh<_i18.EncryptionDbDataSource>(),
              gh<_i11.DestinationPathDataSource>(),
              gh<_i25.HexMapper>(),
              gh<_i46.PrivateKeyMapper>(),
              gh<_i29.IdentityDTOMapper>(),
              gh<_i98.RhsNodeMapper>(),
              gh<_i55.StateIdentifierMapper>(),
              gh<_i87.NodeMapper>(),
              gh<_i19.EncryptionKeyMapper>(),
              gh<_i101.SecureStorageProfilesDataSource>(),
            ));
    gh.factoryAsync<_i145.ProofRepositoryImpl>(
        () async => _i145.ProofRepositoryImpl(
              gh<_i61.WitnessDataSource>(),
              gh<_i50.ProverLibDataSource>(),
              gh<_i110.LibPolygonIdCoreProofDataSource>(),
              gh<_i23.GistMTProofDataSource>(),
              gh<_i47.ProofCircuitDataSource>(),
              gh<_i97.RemoteIdentityDataSource>(),
              gh<_i33.LocalContractFilesDataSource>(),
              gh<_i72.CircuitsDownloadDataSource>(),
              await getAsync<_i126.RPCDataSource>(),
              gh<_i7.CircuitTypeMapper>(),
              gh<_i69.ZKProofMapper>(),
              gh<_i74.ClaimMapper>(),
              gh<_i52.RevocationStatusMapper>(),
              gh<_i71.AuthProofMapper>(),
              gh<_i79.GistMTProofMapper>(),
              await getAsync<_i73.CircuitsFilesDataSource>(),
              await getAsync<_i120.GetEnvUseCase>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factory<_i146.RemoveAllClaimsUseCase>(() => _i146.RemoveAllClaimsUseCase(
          gh<_i132.CredentialRepository>(),
          gh<_i54.StacktraceManager>(),
        ));
    gh.factory<_i147.RemoveClaimsUseCase>(() => _i147.RemoveClaimsUseCase(
          gh<_i132.CredentialRepository>(),
          gh<_i54.StacktraceManager>(),
        ));
    ...
    gh.factory<_i149.SaveClaimsUseCase>(() => _i149.SaveClaimsUseCase(
          gh<_i132.CredentialRepository>(),
          gh<_i54.StacktraceManager>(),
        ));
    gh.factory<_i150.UpdateClaimUseCase>(() => _i150.UpdateClaimUseCase(
          gh<_i132.CredentialRepository>(),
          gh<_i54.StacktraceManager>(),
        ));
    gh.factory<_i151.CacheCredentialUseCase>(
        () => _i151.CacheCredentialUseCase(gh<_i132.CredentialRepository>()));
    gh.factoryAsync<_i152.CacheCredentialsUseCase>(
        () async => _i152.CacheCredentialsUseCase(
              gh<_i151.CacheCredentialUseCase>(),
              gh<_i54.StacktraceManager>(),
              await getAsync<_i120.GetEnvUseCase>(),
            ));
    gh.factory<_i153.CleanSchemaCacheUseCase>(
        () => _i153.CleanSchemaCacheUseCase(gh<_i143.Iden3commRepository>()));
    gh.factory<_i154.GetAuthChallengeUseCase>(
        () => _i154.GetAuthChallengeUseCase(
              gh<_i143.Iden3commRepository>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factory<_i155.GetJWZUseCase>(() => _i155.GetJWZUseCase(
          gh<_i143.Iden3commRepository>(),
          gh<_i54.StacktraceManager>(),
        ));
    gh.factoryAsync<_i156.IdentityRepository>(() async => repositoriesModule
        .identityRepository(await getAsync<_i144.IdentityRepositoryImpl>()));
    gh.factoryAsync<_i157.ProofRepository>(() async => repositoriesModule
        .proofRepository(await getAsync<_i145.ProofRepositoryImpl>()));
    ...
    gh.factoryAsync<_i177.GetFiltersUseCase>(
        () async => _i177.GetFiltersUseCase(
              ...
              gh<_i141.GetProofRequestsUseCase>(),
            ));
    ...
    gh.factoryAsync<_i183.GetInteractionsUseCase>(
        () async => _i183.GetInteractionsUseCase(
              await getAsync<_i124.InteractionRepository>(),
              gh<_i6.CheckProfileValidityUseCase>(),
    ...
    gh.factoryAsync<_i187.FetchOnchainClaimsUseCase>(
        () async => _i187.FetchOnchainClaimsUseCase(
              await getAsync<_i133.FetchOnchainClaimUseCase>(),
              await getAsync<_i186.CheckProfileAndDidCurrentEnvUseCase>(),
              await getAsync<_i120.GetEnvUseCase>(),
              await getAsync<_i121.GetSelectedChainUseCase>(),
              await getAsync<_i181.GetDidIdentifierUseCase>(),
              await getAsync<_i165.GetDidUseCase>(),
              gh<_i149.SaveClaimsUseCase>(),
              gh<_i151.CacheCredentialUseCase>(),
              gh<_i33.LocalContractFilesDataSource>(),
              await getAsync<_i156.IdentityRepository>(),
              gh<_i117.DidProfileInfoRepository>(),
    ...
    gh.factoryAsync<_i188.GenerateIden3commProofUseCase>(
        () async => _i188.GenerateIden3commProofUseCase(
              await getAsync<_i156.IdentityRepository>(),
              gh<_i128.SMTRepository>(),
              await getAsync<_i157.ProofRepository>(),
              await getAsync<_i158.ProveUseCase>(),
              ...
              gh<_i139.GetLatestStateUseCase>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i189.GetAuthInputsUseCase>(
        () async => _i189.GetAuthInputsUseCase(
              await getAsync<_i182.GetIdentityUseCase>(),
              gh<_i135.GetAuthClaimUseCase>(),
              await getAsync<_i159.SignMessageUseCase>(),
              await getAsync<_i166.GetGistMTProofUseCase>(),
    ...
    gh.factoryAsync<_i190.GetAuthTokenUseCase>(
        () async => _i190.GetAuthTokenUseCase(
              await getAsync<_i172.LoadCircuitUseCase>(),
              gh<_i155.GetJWZUseCase>(),
              gh<_i154.GetAuthChallengeUseCase>(),
              await getAsync<_i189.GetAuthInputsUseCase>(),
              await getAsync<_i158.ProveUseCase>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i191.GetCurrentEnvDidIdentifierUseCase>(
        () async => _i191.GetCurrentEnvDidIdentifierUseCase(
              await getAsync<_i121.GetSelectedChainUseCase>(),
              await getAsync<_i181.GetDidIdentifierUseCase>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i192.GetProfilesUseCase>(
        () async => _i192.GetProfilesUseCase(
              await getAsync<_i182.GetIdentityUseCase>(),
              await getAsync<_i186.CheckProfileAndDidCurrentEnvUseCase>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i193.RefreshCredentialUseCase>(
        () async => _i193.RefreshCredentialUseCase(
              gh<_i132.CredentialRepository>(),
              gh<_i54.StacktraceManager>(),
              await getAsync<_i182.GetIdentityUseCase>(),
              await getAsync<_i190.GetAuthTokenUseCase>(),
              gh<_i122.Iden3commCredentialRepository>(),
              gh<_i147.RemoveClaimsUseCase>(),
              gh<_i149.SaveClaimsUseCase>(),
            ));
    gh.factoryAsync<_i194.UpdateInteractionUseCase>(
        () async => _i194.UpdateInteractionUseCase(
              await getAsync<_i124.InteractionRepository>(),
              gh<_i6.CheckProfileValidityUseCase>(),
              await getAsync<_i182.GetIdentityUseCase>(),
              await getAsync<_i185.AddInteractionUseCase>(),
            ));
    gh.factoryAsync<_i195.BackupIdentityUseCase>(
        () async => _i195.BackupIdentityUseCase(
              await getAsync<_i182.GetIdentityUseCase>(),
              await getAsync<_i156.IdentityRepository>(),
              await getAsync<_i191.GetCurrentEnvDidIdentifierUseCase>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i196.CheckIdentityValidityUseCase>(
        () async => _i196.CheckIdentityValidityUseCase(
              await getAsync<_i169.GetPrivateKeyUseCase>(),
              await getAsync<_i191.GetCurrentEnvDidIdentifierUseCase>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i197.CreateIdentityUseCase>(
        () async => _i197.CreateIdentityUseCase(
              await getAsync<_i170.GetPublicKeysUseCase>(),
              await getAsync<_i191.GetCurrentEnvDidIdentifierUseCase>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i198.CreateProfilesUseCase>(
        () async => _i198.CreateProfilesUseCase(
              await getAsync<_i170.GetPublicKeysUseCase>(),
              await getAsync<_i191.GetCurrentEnvDidIdentifierUseCase>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i199.FetchAndSaveClaimsUseCase>(
        () async => _i199.FetchAndSaveClaimsUseCase(
              gh<_i122.Iden3commCredentialRepository>(),
              await getAsync<_i133.FetchOnchainClaimUseCase>(),
              await getAsync<_i186.CheckProfileAndDidCurrentEnvUseCase>(),
              await getAsync<_i120.GetEnvUseCase>(),
    ...
    gh.factoryAsync<_i200.FetchCredentialsUseCase>(
        () async => _i200.FetchCredentialsUseCase(
              await getAsync<_i121.GetSelectedChainUseCase>(),
              await getAsync<_i181.GetDidIdentifierUseCase>(),
              await getAsync<_i190.GetAuthTokenUseCase>(),
              gh<_i22.GetFetchRequestsUseCase>(),
    ...
    gh.factoryAsync<_i201.GetClaimsUseCase>(() async => _i201.GetClaimsUseCase(
          gh<_i132.CredentialRepository>(),
          await getAsync<_i191.GetCurrentEnvDidIdentifierUseCase>(),
          gh<_i54.StacktraceManager>(),
        ));
    gh.factoryAsync<_i202.GetIden3commClaimsRevNonceUseCase>(
        () async => _i202.GetIden3commClaimsRevNonceUseCase(
              gh<_i122.Iden3commCredentialRepository>(),
              await getAsync<_i201.GetClaimsUseCase>(),
              gh<_i136.GetClaimRevocationNonceUseCase>(),
              await getAsync<_i171.IsProofCircuitSupportedUseCase>(),
              gh<_i141.GetProofRequestsUseCase>(),
            ));
    gh.factoryAsync<_i203.GetIden3commClaimsUseCase>(
        () async => _i203.GetIden3commClaimsUseCase(
              gh<_i122.Iden3commCredentialRepository>(),
              await getAsync<_i201.GetClaimsUseCase>(),
              await getAsync<_i180.GetClaimRevocationStatusUseCase>(),
              gh<_i136.GetClaimRevocationNonceUseCase>(),
              gh<_i150.UpdateClaimUseCase>(),
              await getAsync<_i171.IsProofCircuitSupportedUseCase>(),
              gh<_i141.GetProofRequestsUseCase>(),
              gh<_i7.CircuitTypeMapper>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i204.GetIden3commProofsUseCase>(
        () async => _i204.GetIden3commProofsUseCase(
              await getAsync<_i157.ProofRepository>(),
              await getAsync<_i203.GetIden3commClaimsUseCase>(),
              await getAsync<_i188.GenerateIden3commProofUseCase>(),
              await getAsync<_i171.IsProofCircuitSupportedUseCase>(),
              gh<_i141.GetProofRequestsUseCase>(),
              await getAsync<_i182.GetIdentityUseCase>(),
              gh<_i48.ProofGenerationStepsStreamManager>(),
              ...
              gh<_i147.RemoveClaimsUseCase>(),
              gh<_i149.SaveClaimsUseCase>(),
              await getAsync<_i193.RefreshCredentialUseCase>(),
            ));
    gh.factoryAsync<_i205.UpdateIdentityUseCase>(
        () async => _i205.UpdateIdentityUseCase(
              await getAsync<_i156.IdentityRepository>(),
              await getAsync<_i197.CreateIdentityUseCase>(),
              await getAsync<_i182.GetIdentityUseCase>(),
            ));
    gh.factoryAsync<_i206.AddIdentityUseCase>(
        () async => _i206.AddIdentityUseCase(
              await getAsync<_i156.IdentityRepository>(),
              await getAsync<_i197.CreateIdentityUseCase>(),
              await getAsync<_i174.CreateIdentityStateUseCase>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i207.AddNewIdentityUseCase>(
        () async => _i207.AddNewIdentityUseCase(
              await getAsync<_i156.IdentityRepository>(),
              await getAsync<_i206.AddIdentityUseCase>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i208.AddProfileUseCase>(
        () async => _i208.AddProfileUseCase(
              await getAsync<_i182.GetIdentityUseCase>(),
              await getAsync<_i205.UpdateIdentityUseCase>(),
              await getAsync<_i186.CheckProfileAndDidCurrentEnvUseCase>(),
              await getAsync<_i198.CreateProfilesUseCase>(),
              gh<_i109.LibPolygonIdCoreIdentityDataSource>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i209.AuthenticateUseCase>(
        () async => _i209.AuthenticateUseCase(
              gh<_i143.Iden3commRepository>(),
              await getAsync<_i204.GetIden3commProofsUseCase>(),
              await getAsync<_i181.GetDidIdentifierUseCase>(),
              await getAsync<_i190.GetAuthTokenUseCase>(),
              await getAsync<_i120.GetEnvUseCase>(),
              await getAsync<_i121.GetSelectedChainUseCase>(),
              await getAsync<_i104.GetPackageNameUseCase>(),
              await getAsync<_i186.CheckProfileAndDidCurrentEnvUseCase>(),
              gh<_i48.ProofGenerationStepsStreamManager>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i210.Credential>(() async => _i210.Credential(
          gh<_i149.SaveClaimsUseCase>(),
          await getAsync<_i201.GetClaimsUseCase>(),
          gh<_i147.RemoveClaimsUseCase>(),
          await getAsync<_i180.GetClaimRevocationStatusUseCase>(),
          ...
          gh<_i54.StacktraceManager>(),
          await getAsync<_i193.RefreshCredentialUseCase>(),
          gh<_i137.GetCredentialByIdUseCase>(),
          gh<_i138.GetCredentialByPartialIdUseCase>(),
          await getAsync<_i152.CacheCredentialsUseCase>(),
          gh<_i151.CacheCredentialUseCase>(),
        ));
    gh.factoryAsync<_i211.Iden3comm>(() async => _i211.Iden3comm(
          await getAsync<_i199.FetchAndSaveClaimsUseCase>(),
          await getAsync<_i187.FetchOnchainClaimsUseCase>(),
          gh<_i77.GetIden3MessageUseCase>(),
          gh<_i142.GetSchemasUseCase>(),
          gh<_i134.FetchSchemaUseCase>(),
          await getAsync<_i209.AuthenticateUseCase>(),
          await getAsync<_i177.GetFiltersUseCase>(),
          await getAsync<_i203.GetIden3commClaimsUseCase>(),
          await getAsync<_i202.GetIden3commClaimsRevNonceUseCase>(),
          await getAsync<_i204.GetIden3commProofsUseCase>(),
          await getAsync<_i183.GetInteractionsUseCase>(),
          await getAsync<_i185.AddInteractionUseCase>(),
          await getAsync<_i184.RemoveInteractionsUseCase>(),
          await getAsync<_i194.UpdateInteractionUseCase>(),
          gh<_i153.CleanSchemaCacheUseCase>(),
          gh<_i54.StacktraceManager>(),
          gh<_i131.AddDidProfileInfoUseCase>(),
          gh<_i119.GetDidProfileInfoUseCase>(),
          gh<_i118.GetDidProfileInfoListUseCase>(),
          gh<_i127.RemoveDidProfileInfoUseCase>(),
          await getAsync<_i190.GetAuthTokenUseCase>(),
          await getAsync<_i200.FetchCredentialsUseCase>(),
        ));
    gh.factoryAsync<_i212.RemoveProfileUseCase>(
        () async => _i212.RemoveProfileUseCase(
              await getAsync<_i182.GetIdentityUseCase>(),
              await getAsync<_i205.UpdateIdentityUseCase>(),
              await getAsync<_i186.CheckProfileAndDidCurrentEnvUseCase>(),
              await getAsync<_i198.CreateProfilesUseCase>(),
              gh<_i148.RemoveIdentityStateUseCase>(),
              gh<_i146.RemoveAllClaimsUseCase>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i213.RestoreProfilesUseCase>(
        () async => _i213.RestoreProfilesUseCase(
              await getAsync<_i156.IdentityRepository>(),
              await getAsync<_i205.UpdateIdentityUseCase>(),
            ));
    gh.factoryAsync<_i214.RemoveIdentityUseCase>(
        () async => _i214.RemoveIdentityUseCase(
              await getAsync<_i156.IdentityRepository>(),
              await getAsync<_i192.GetProfilesUseCase>(),
              await getAsync<_i212.RemoveProfileUseCase>(),
              gh<_i148.RemoveIdentityStateUseCase>(),
              gh<_i146.RemoveAllClaimsUseCase>(),
              await getAsync<_i186.CheckProfileAndDidCurrentEnvUseCase>(),
              gh<_i54.StacktraceManager>(),
            ));
    gh.factoryAsync<_i215.RestoreIdentityUseCase>(
        () async => _i215.RestoreIdentityUseCase(
              await getAsync<_i206.AddIdentityUseCase>(),
              await getAsync<_i182.GetIdentityUseCase>(),
              await getAsync<_i156.IdentityRepository>(),
              await getAsync<_i191.GetCurrentEnvDidIdentifierUseCase>(),
              await getAsync<_i213.RestoreProfilesUseCase>(),
            ));
    gh.factoryAsync<_i216.Identity>(() async => _i216.Identity(
          await getAsync<_i196.CheckIdentityValidityUseCase>(),
          await getAsync<_i169.GetPrivateKeyUseCase>(),
          await getAsync<_i207.AddNewIdentityUseCase>(),
          await getAsync<_i215.RestoreIdentityUseCase>(),
          await getAsync<_i195.BackupIdentityUseCase>(),
          await getAsync<_i182.GetIdentityUseCase>(),
          await getAsync<_i167.GetIdentitiesUseCase>(),
          await getAsync<_i214.RemoveIdentityUseCase>(),
          await getAsync<_i181.GetDidIdentifierUseCase>(),
          await getAsync<_i159.SignMessageUseCase>(),
          await getAsync<_i175.FetchIdentityStateUseCase>(),
          await getAsync<_i208.AddProfileUseCase>(),
          await getAsync<_i192.GetProfilesUseCase>(),
          await getAsync<_i212.RemoveProfileUseCase>(),
          await getAsync<_i165.GetDidUseCase>(),
          gh<_i54.StacktraceManager>(),
...
class _$PlatformModule extends _i217.PlatformModule {}

class _$NetworkModule extends _i217.NetworkModule {}

class _$DatabaseModule extends _i217.DatabaseModule {}

class _$FilesManagerModule extends _i217.FilesManagerModule {}

class _$EncryptionModule extends _i217.EncryptionModule {}

class _$LoggerModule extends _i217.LoggerModule {}

class _$ChannelModule extends _i217.ChannelModule {}

class _$RepositoriesModule extends _i217.RepositoriesModule {}

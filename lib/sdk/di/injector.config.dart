...
import '../../iden3comm/domain/use_cases/authenticate_use_case.dart' as _i135;
...
import '../../iden3comm/domain/use_cases/get_proof_requests_use_case.dart'
    as _i23;
import '../../iden3comm/domain/use_cases/get_proofs_use_case.dart' as _i132;
...
import '../../proof/domain/use_cases/generate_proof_use_case.dart' as _i128;
...
import '../../proof/libs/witnesscalc/sig_v2_onchain/witness_sig_onchain.dart'
    as _i68;
import '../credential.dart' as _i139;
import '../iden3comm.dart' as _i137;
import '../identity.dart' as _i138;
import '../mappers/iden3_message_type_mapper.dart' as _i27;
import '../proof.dart' as _i133;
import 'injector.dart' as _i140; // ignore_for_file: unnecessary_lambdas
...
_i1.GetIt $initSDKGetIt(
  ...
  gh.factoryAsync<_i128.GenerateProofUseCase>(
      () async => _i128.GenerateProofUseCase(
            await get.getAsync<_i109.IdentityRepository>(),
  ...
  gh.factoryAsync<_i131.GetClaimRevocationStatusUseCase>(
      () async => _i131.GetClaimRevocationStatusUseCase(
            get<_i95.CredentialRepository>(),
            await get.getAsync<_i109.IdentityRepository>(),
            await get.getAsync<_i127.GenerateNonRevProofUseCase>(),
          ));
  gh.factoryAsync<_i132.GetProofsUseCase>(() async => _i132.GetProofsUseCase(
        get<_i102.ProofRepository>(),
        await get.getAsync<_i109.IdentityRepository>(),
        get<_i97.GetClaimsUseCase>(),
        await get.getAsync<_i128.GenerateProofUseCase>(),
        get<_i111.IsProofCircuitSupportedUseCase>(),
        get<_i23.GetProofRequestsUseCase>(),
      ));
  gh.factoryAsync<_i133.Proof>(() async =>
      _i133.Proof(await get.getAsync<_i128.GenerateProofUseCase>()));
  gh.factoryAsync<_i134.RestoreIdentityUseCase>(
      () async => _i134.RestoreIdentityUseCase(
            await get.getAsync<_i125.CreateAndSaveIdentityUseCase>(),
            await get.getAsync<_i110.ImportIdentityUseCase>(),
            await get.getAsync<_i119.GetDidIdentifierUseCase>(),
          ));
  gh.factoryAsync<_i135.AuthenticateUseCase>(
      () async => _i135.AuthenticateUseCase(
            get<_i100.Iden3commRepository>(),
            await get.getAsync<_i132.GetProofsUseCase>(),
            await get.getAsync<_i130.GetAuthTokenUseCase>(),
            get<_i98.GetEnvConfigUseCase>(),
            await get.getAsync<_i89.GetPackageNameUseCase>(),
            await get.getAsync<_i119.GetDidIdentifierUseCase>(),
          ));
  gh.factoryAsync<_i136.FetchAndSaveClaimsUseCase>(
      () async => _i136.FetchAndSaveClaimsUseCase(
            get<_i19.GetFetchRequestsUseCase>(),
            await get.getAsync<_i130.GetAuthTokenUseCase>(),
            get<_i95.CredentialRepository>(),
          ));
  gh.factoryAsync<_i137.Iden3comm>(() async => _i137.Iden3comm(
        get<_i99.GetVocabsUseCase>(),
        await get.getAsync<_i135.AuthenticateUseCase>(),
        await get.getAsync<_i132.GetProofsUseCase>(),
        get<_i21.GetIden3MessageUseCase>(),
      ));
  gh.factoryAsync<_i138.Identity>(() async => _i138.Identity(
        await get.getAsync<_i115.CheckIdentityValidityUseCase>(),
        await get.getAsync<_i125.CreateAndSaveIdentityUseCase>(),
        await get.getAsync<_i134.RestoreIdentityUseCase>(),
  ...
  gh.factoryAsync<_i139.Credential>(() async => _i139.Credential(
        await get.getAsync<_i136.FetchAndSaveClaimsUseCase>(),
        get<_i97.GetClaimsUseCase>(),
...
class _$PlatformModule extends _i140.PlatformModule {}

class _$NetworkModule extends _i140.NetworkModule {}

class _$DatabaseModule extends _i140.DatabaseModule {}

class _$EncryptionModule extends _i140.EncryptionModule {}

class _$Sdk extends _i140.Sdk {}

class _$RepositoriesModule extends _i140.RepositoriesModule {}

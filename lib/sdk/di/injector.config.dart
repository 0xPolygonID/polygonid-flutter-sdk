...
import '../../iden3comm/domain/use_cases/authenticate_use_case.dart' as _i136;
import '../../iden3comm/domain/use_cases/get_auth_inputs_use_case.dart'
    as _i130;
import '../../iden3comm/domain/use_cases/get_auth_token_use_case.dart' as _i131;
...
import '../../iden3comm/domain/use_cases/get_proof_requests_use_case.dart'
    as _i23;
import '../../iden3comm/domain/use_cases/get_proofs_use_case.dart' as _i133;
...
import '../../identity/domain/use_cases/backup_identity_use_case.dart' as _i124;
...
import '../../identity/domain/use_cases/get_identities_use_case.dart' as _i122;
...
import '../../proof/domain/use_cases/generate_proof_use_case.dart' as _i129;
...
import '../iden3comm.dart' as _i138;
import '../identity.dart' as _i139;
import '../mappers/iden3_message_type_mapper.dart' as _i27;
import '../proof.dart' as _i134;
...
_i1.GetIt $initSDKGetIt(
  ...
  gh.factoryAsync<_i122.GetIdentitiesUseCase>(() async =>
      _i122.GetIdentitiesUseCase(
          await get.getAsync<_i109.IdentityRepository>()));
  ...
  gh.factoryAsync<_i124.BackupIdentityUseCase>(
      () async => _i124.BackupIdentityUseCase(
  ...
  gh.factoryAsync<_i125.CreateAndSaveIdentityFromPKUseCase>(
      () async => _i125.CreateAndSaveIdentityFromPKUseCase(
            await get.getAsync<_i109.IdentityRepository>(),
            await get.getAsync<_i120.GetDidUseCase>(),
            await get.getAsync<_i119.GetDidIdentifierUseCase>(),
          ));
  gh.factoryAsync<_i126.CreateAndSaveIdentityUseCase>(
      () async => _i126.CreateAndSaveIdentityUseCase(
  ...
  gh.factoryAsync<_i129.GenerateProofUseCase>(
      () async => _i129.GenerateProofUseCase(
            await get.getAsync<_i109.IdentityRepository>(),
  ...
  gh.factoryAsync<_i130.GetAuthInputsUseCase>(
      () async => _i130.GetAuthInputsUseCase(
            await get.getAsync<_i123.GetIdentityUseCase>(),
            get<_i96.GetAuthClaimUseCase>(),
            await get.getAsync<_i114.SignMessageUseCase>(),
            await get.getAsync<_i121.GetGistProofUseCase>(),
  ...
  gh.factoryAsync<_i131.GetAuthTokenUseCase>(
      () async => _i131.GetAuthTokenUseCase(
            get<_i112.LoadCircuitUseCase>(),
            get<_i108.GetJWZUseCase>(),
            await get.getAsync<_i118.GetAuthChallengeUseCase>(),
            await get.getAsync<_i130.GetAuthInputsUseCase>(),
            get<_i103.ProveUseCase>(),
          ));
  ...
  gh.factoryAsync<_i133.GetProofsUseCase>(() async => _i133.GetProofsUseCase(
        get<_i102.ProofRepository>(),
        await get.getAsync<_i109.IdentityRepository>(),
        get<_i97.GetClaimsUseCase>(),
        await get.getAsync<_i129.GenerateProofUseCase>(),
        get<_i111.IsProofCircuitSupportedUseCase>(),
        get<_i23.GetProofRequestsUseCase>(),
      ));
  gh.factoryAsync<_i134.Proof>(() async =>
      _i134.Proof(await get.getAsync<_i129.GenerateProofUseCase>()));
  gh.factoryAsync<_i135.RestoreIdentityUseCase>(
      () async => _i135.RestoreIdentityUseCase(
            await get.getAsync<_i125.CreateAndSaveIdentityFromPKUseCase>(),
            await get.getAsync<_i110.ImportIdentityUseCase>(),
            await get.getAsync<_i119.GetDidIdentifierUseCase>(),
          ));
  gh.factoryAsync<_i136.AuthenticateUseCase>(
      () async => _i136.AuthenticateUseCase(
            get<_i100.Iden3commRepository>(),
            await get.getAsync<_i133.GetProofsUseCase>(),
            await get.getAsync<_i131.GetAuthTokenUseCase>(),
            get<_i98.GetEnvConfigUseCase>(),
            await get.getAsync<_i89.GetPackageNameUseCase>(),
            await get.getAsync<_i119.GetDidIdentifierUseCase>(),
          ));
  gh.factoryAsync<_i137.FetchAndSaveClaimsUseCase>(
      () async => _i137.FetchAndSaveClaimsUseCase(
            get<_i19.GetFetchRequestsUseCase>(),
            await get.getAsync<_i131.GetAuthTokenUseCase>(),
            get<_i95.CredentialRepository>(),
          ));
  gh.factoryAsync<_i138.Iden3comm>(() async => _i138.Iden3comm(
        get<_i99.GetVocabsUseCase>(),
        await get.getAsync<_i136.AuthenticateUseCase>(),
        await get.getAsync<_i133.GetProofsUseCase>(),
        get<_i21.GetIden3MessageUseCase>(),
      ));
  gh.factoryAsync<_i139.Identity>(() async => _i139.Identity(
        await get.getAsync<_i115.CheckIdentityValidityUseCase>(),
        await get.getAsync<_i126.CreateAndSaveIdentityUseCase>(),
        await get.getAsync<_i135.RestoreIdentityUseCase>(),
        await get.getAsync<_i124.BackupIdentityUseCase>(),
        await get.getAsync<_i123.GetIdentityUseCase>(),
        await get.getAsync<_i122.GetIdentitiesUseCase>(),
  ...
  gh.factoryAsync<_i140.Credential>(() async => _i140.Credential(
        await get.getAsync<_i137.FetchAndSaveClaimsUseCase>(),
        get<_i97.GetClaimsUseCase>(),

...
import 'package:polygonid_flutter_sdk/common/data/repositories/package_info_repository_impl.dart'
    as _i43;
import 'package:polygonid_flutter_sdk/common/domain/domain_logger.dart' as _i46;
...
import 'package:polygonid_flutter_sdk/proof/libs/polygonidcore/pidcore_proof.dart'
    as _i95;
import 'package:polygonid_flutter_sdk/proof/libs/prover/prover.dart' as _i51;
...
import 'package:polygonid_flutter_sdk/proof/libs/witnesscalc/v3_onchain/witness_v3_onchain.dart'
    as _i70;
import 'package:polygonid_flutter_sdk/sdk/credential.dart' as _i211;
import 'package:polygonid_flutter_sdk/sdk/di/injector.dart' as _i218;
import 'package:polygonid_flutter_sdk/sdk/error_handling.dart' as _i79;
import 'package:polygonid_flutter_sdk/sdk/iden3comm.dart' as _i212;
import 'package:polygonid_flutter_sdk/sdk/identity.dart' as _i217;
import 'package:polygonid_flutter_sdk/sdk/polygon_id_sdk.dart' as _i45;
import 'package:polygonid_flutter_sdk/sdk/polygonid_flutter_channel.dart'
    as _i96;
import 'package:polygonid_flutter_sdk/sdk/proof.dart' as _i175;
import 'package:sembast/sembast.dart' as _i13;
import 'package:web3dart/web3dart.dart' as _i61;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt $initSDKGetIt({
    ...
    gh.factory<_i34.LibBabyJubJubDataSource>(
        () => _i34.LibBabyJubJubDataSource(gh<_i6.BabyjubjubLib>()));
    ...
    gh.factoryAsync<_i42.PackageInfoDataSource>(() async =>
        _i42.PackageInfoDataSource(await getAsync<_i41.PackageInfo>()));
    gh.factoryAsync<_i43.PackageInfoRepositoryImpl>(() async =>
        _i43.PackageInfoRepositoryImpl(
            await getAsync<_i42.PackageInfoDataSource>()));
    gh.factory<_i44.PolygonIdCore>(() => _i44.PolygonIdCore());
    gh.factory<_i45.PolygonIdSdk>(() => channelModule.polygonIdSdk);
    gh.factory<_i46.PolygonIdSdkLogger>(() => loggerModule.sdkLogger);
    gh.factory<_i47.PoseidonHashMapper>(
        () => _i47.PoseidonHashMapper(gh<_i27.HexMapper>()));
    gh.factory<_i48.PrivateKeyMapper>(() => _i48.PrivateKeyMapper());
    gh.factory<_i49.ProofCircuitDataSource>(
        () => _i49.ProofCircuitDataSource());
    ...
    gh.factory<_i54.RevocationStatusMapper>(
        () => _i54.RevocationStatusMapper());
    ...
    gh.lazySingleton<_i56.StacktraceManager>(() => _i56.StacktraceManager());
    ...
    gh.factory<_i58.TreeStateMapper>(() => _i58.TreeStateMapper());
    gh.factory<_i59.TreeTypeMapper>(() => _i59.TreeTypeMapper());
    gh.factory<_i60.WalletLibWrapper>(() => _i60.WalletLibWrapper());
    gh.factoryParam<_i61.Web3Client, String, dynamic>((
      rpcUrl,
      _,
    ) =>
        networkModule.web3client(rpcUrl));
    gh.factory<_i62.WitnessAuthV2Lib>(() => _i62.WitnessAuthV2Lib());
    gh.factory<_i63.WitnessIsolatesWrapper>(
        () => _i63.WitnessIsolatesWrapper());
    gh.factory<_i64.WitnessLinkedMultiQuery10>(
        () => _i64.WitnessLinkedMultiQuery10());
    gh.factory<_i65.WitnessMTPV2Lib>(() => _i65.WitnessMTPV2Lib());
    gh.factory<_i66.WitnessMTPV2OnchainLib>(
        () => _i66.WitnessMTPV2OnchainLib());
    gh.factory<_i67.WitnessSigV2Lib>(() => _i67.WitnessSigV2Lib());
    gh.factory<_i68.WitnessSigV2OnchainLib>(
        () => _i68.WitnessSigV2OnchainLib());
    gh.factory<_i69.WitnessV3Lib>(() => _i69.WitnessV3Lib());
    gh.factory<_i70.WitnessV3OnchainLib>(() => _i70.WitnessV3OnchainLib());
    gh.factory<_i71.ZKProofBaseMapper>(() => _i71.ZKProofBaseMapper());
    gh.factory<_i72.ZKProofMapper>(() => _i72.ZKProofMapper());
    gh.factory<_i73.ZipDecoder>(() => filesManagerModule.zipDecoder());
    gh.factory<_i74.AuthProofMapper>(() => _i74.AuthProofMapper(
          gh<_i26.HashMapper>(),
          gh<_i37.NodeAuxMapper>(),
        ));
    gh.factory<_i75.CircuitsDownloadDataSource>(
        () => _i75.CircuitsDownloadDataSource(gh<_i15.Dio>()));
    gh.factoryAsync<_i76.CircuitsFilesDataSource>(() async =>
        _i76.CircuitsFilesDataSource(await getAsync<_i16.Directory>()));
    ...
    gh.factory<_i78.ClaimStoreRefWrapper>(() => _i78.ClaimStoreRefWrapper(
        gh<_i13.StoreRef<String, Map<String, Object?>>>(
            instanceName: 'claimStore')));
    gh.factory<_i79.ErrorHandling>(
        () => _i79.ErrorHandling(gh<_i56.StacktraceManager>()));
    gh.factory<_i80.GetIden3MessageUseCase>(() => _i80.GetIden3MessageUseCase(
          gh<_i24.GetIden3MessageTypeUseCase>(),
          gh<_i56.StacktraceManager>(),
        ));
    gh.factory<_i81.GetProofQueryUseCase>(
        () => _i81.GetProofQueryUseCase(gh<_i56.StacktraceManager>()));
    gh.factory<_i82.Iden3MessageDataSource>(
        () => _i82.Iden3MessageDataSource(gh<_i56.StacktraceManager>()));
    gh.factory<_i83.Iden3commProofMapper>(() => _i83.Iden3commProofMapper(
          gh<_i71.ZKProofBaseMapper>(),
    ...
    gh.factory<_i86.InteractionStoreRefWrapper>(() =>
        _i86.InteractionStoreRefWrapper(
            gh<_i13.StoreRef<String, Map<String, Object?>>>(
                instanceName: 'interactionStore')));
    gh.factory<_i87.JWZMapper>(
        () => _i87.JWZMapper(gh<_i56.StacktraceManager>()));
    ...
    gh.factory<_i89.MTProofMapper>(() => _i89.MTProofMapper(
          gh<_i26.HashMapper>(),
          gh<_i37.NodeAuxMapper>(),
        ));
    gh.factory<_i90.NodeMapper>(() => _i90.NodeMapper(
          gh<_i40.NodeTypeMapper>(),
          gh<_i39.NodeTypeEntityMapper>(),
          gh<_i38.NodeTypeDTOMapper>(),
          gh<_i26.HashMapper>(),
        ));
    gh.factoryAsync<_i91.PackageInfoRepository>(() async =>
        repositoriesModule.packageInfoRepository(
            await getAsync<_i43.PackageInfoRepositoryImpl>()));
    gh.factory<_i92.PolygonIdCoreCredential>(
        () => _i92.PolygonIdCoreCredential(gh<_i56.StacktraceManager>()));
    gh.factory<_i93.PolygonIdCoreIden3comm>(
        () => _i93.PolygonIdCoreIden3comm(gh<_i56.StacktraceManager>()));
    gh.factory<_i94.PolygonIdCoreIdentity>(
        () => _i94.PolygonIdCoreIdentity(gh<_i56.StacktraceManager>()));
    gh.factory<_i95.PolygonIdCoreProof>(
        () => _i95.PolygonIdCoreProof(gh<_i56.StacktraceManager>()));
    gh.factory<_i96.PolygonIdFlutterChannel>(() => _i96.PolygonIdFlutterChannel(
          gh<_i45.PolygonIdSdk>(),
          gh<_i3.MethodChannel>(),
        ));
    gh.factory<_i97.ProofRequestFiltersMapper>(
        () => _i97.ProofRequestFiltersMapper(gh<_i56.StacktraceManager>()));
    gh.factory<_i52.ProverLibDataSource>(
        () => _i52.ProverLibDataSource(gh<_i52.ProverLibWrapper>()));
    gh.factory<_i98.RemoteClaimDataSource>(() => _i98.RemoteClaimDataSource(
          gh<_i11.Client>(),
          gh<_i56.StacktraceManager>(),
        ));
    gh.factory<_i99.RemoteIden3commDataSource>(
        () => _i99.RemoteIden3commDataSource(
              gh<_i15.Dio>(),
              gh<_i11.Client>(),
              gh<_i56.StacktraceManager>(),
            ));
    gh.factory<_i100.RemoteIdentityDataSource>(
        () => _i100.RemoteIdentityDataSource(gh<_i56.StacktraceManager>()));
    gh.factory<_i101.RhsNodeMapper>(
        () => _i101.RhsNodeMapper(gh<_i55.RhsNodeTypeMapper>()));
    gh.factory<_i102.SecureDidProfileInfoStoreRefWrapper>(() =>
        _i102.SecureDidProfileInfoStoreRefWrapper(
            gh<_i13.StoreRef<String, Map<String, Object?>>>(
                instanceName: 'didProfileInfoStore')));
    gh.factory<_i103.SecureInteractionStoreRefWrapper>(() =>
        _i103.SecureInteractionStoreRefWrapper(
            gh<_i13.StoreRef<String, Map<String, Object?>>>(
                instanceName: 'interactionStore')));
    gh.factory<_i102.SecureStorageDidProfileInfoDataSource>(() =>
        _i102.SecureStorageDidProfileInfoDataSource(
            gh<_i102.SecureDidProfileInfoStoreRefWrapper>()));
    ...
    gh.factory<_i104.SecureStorageProfilesStoreRefWrapper>(() =>
        _i104.SecureStorageProfilesStoreRefWrapper(
            gh<_i13.StoreRef<String, Map<String, Object?>>>(
                instanceName: 'profilesStore')));
    gh.factory<_i78.StorageClaimDataSource>(
        () => _i78.StorageClaimDataSource(gh<_i78.ClaimStoreRefWrapper>()));
    gh.factoryAsync<_i85.StorageIdentityDataSource>(
        () async => _i85.StorageIdentityDataSource(
              await getAsync<_i13.Database>(),
              gh<_i85.IdentityStoreRefWrapper>(),
              gh<_i56.StacktraceManager>(),
            ));
    gh.factoryAsync<_i86.StorageInteractionDataSource>(
        () async => _i86.StorageInteractionDataSource(
              await getAsync<_i13.Database>(),
              gh<_i86.InteractionStoreRefWrapper>(),
            ));
    gh.factoryAsync<_i88.StorageKeyValueDataSource>(
        () async => _i88.StorageKeyValueDataSource(
              await getAsync<_i13.Database>(),
              gh<_i88.KeyValueStoreRefWrapper>(),
            ));
    gh.factory<_i84.StorageSMTDataSource>(
        () => _i84.StorageSMTDataSource(gh<_i84.IdentitySMTStoreRefWrapper>()));
    gh.factory<_i60.WalletDataSource>(
        () => _i60.WalletDataSource(gh<_i60.WalletLibWrapper>()));
    gh.factory<_i63.WitnessDataSource>(
        () => _i63.WitnessDataSource(gh<_i63.WitnessIsolatesWrapper>()));
    gh.factoryAsync<_i105.ConfigRepositoryImpl>(() async =>
        _i105.ConfigRepositoryImpl(
            await getAsync<_i88.StorageKeyValueDataSource>()));
    gh.factory<_i106.DidProfileInfoRepositoryImpl>(
        () => _i106.DidProfileInfoRepositoryImpl(
              gh<_i102.SecureStorageDidProfileInfoDataSource>(),
              gh<_i22.FiltersMapper>(),
              gh<_i14.DidProfileInfoInteractedDidFilterMapper>(),
            ));
    gh.factoryAsync<_i107.GetPackageNameUseCase>(() async =>
        _i107.GetPackageNameUseCase(
            await getAsync<_i91.PackageInfoRepository>()));
    gh.factory<_i108.GistMTProofMapper>(() => _i108.GistMTProofMapper(
          gh<_i89.MTProofMapper>(),
          gh<_i26.HashMapper>(),
        ));
    gh.factory<_i109.Iden3commCredentialRepositoryImpl>(
        () => _i109.Iden3commCredentialRepositoryImpl(
              gh<_i99.RemoteIden3commDataSource>(),
              gh<_i97.ProofRequestFiltersMapper>(),
              gh<_i77.ClaimMapper>(),
              gh<_i56.StacktraceManager>(),
            ));
    gh.factoryAsync<_i110.InteractionRepositoryImpl>(
        () async => _i110.InteractionRepositoryImpl(
              ...
              await getAsync<_i86.StorageInteractionDataSource>(),
              gh<_i33.InteractionMapper>(),
              gh<_i22.FiltersMapper>(),
              gh<_i32.InteractionIdFilterMapper>(),
              gh<_i56.StacktraceManager>(),
            ));
    gh.factory<_i111.LibPolygonIdCoreCredentialDataSource>(() =>
        _i111.LibPolygonIdCoreCredentialDataSource(
            gh<_i92.PolygonIdCoreCredential>()));
    gh.factory<_i112.LibPolygonIdCoreIden3commDataSource>(() =>
        _i112.LibPolygonIdCoreIden3commDataSource(
            gh<_i93.PolygonIdCoreIden3comm>()));
    gh.factory<_i113.LibPolygonIdCoreIdentityDataSource>(() =>
        _i113.LibPolygonIdCoreIdentityDataSource(
            gh<_i94.PolygonIdCoreIdentity>()));
    gh.factory<_i114.LibPolygonIdCoreWrapper>(
        () => _i114.LibPolygonIdCoreWrapper(gh<_i95.PolygonIdCoreProof>()));
    gh.factory<_i115.LocalClaimDataSource>(() => _i115.LocalClaimDataSource(
        gh<_i111.LibPolygonIdCoreCredentialDataSource>()));
    gh.factory<_i116.SMTDataSource>(() => _i116.SMTDataSource(
          gh<_i27.HexMapper>(),
          gh<_i34.LibBabyJubJubDataSource>(),
          gh<_i84.StorageSMTDataSource>(),
        ));
    gh.factory<_i117.SMTRepositoryImpl>(() => _i117.SMTRepositoryImpl(
          ...
          gh<_i26.HashMapper>(),
          gh<_i89.MTProofMapper>(),
          gh<_i59.TreeTypeMapper>(),
          gh<_i58.TreeStateMapper>(),
        ));
    gh.factory<_i104.SecureStorageProfilesDataSource>(() =>
        _i104.SecureStorageProfilesDataSource(
            gh<_i104.SecureStorageProfilesStoreRefWrapper>()));
    gh.factory<_i118.CacheCredentialDataSource>(() =>
        _i118.CacheCredentialDataSource(
            gh<_i111.LibPolygonIdCoreCredentialDataSource>()));
    gh.factoryAsync<_i119.ConfigRepository>(() async => repositoriesModule
        .configRepository(await getAsync<_i105.ConfigRepositoryImpl>()));
    gh.factory<_i120.CredentialRepositoryImpl>(
        () => _i120.CredentialRepositoryImpl(
              gh<_i98.RemoteClaimDataSource>(),
              gh<_i78.StorageClaimDataSource>(),
              gh<_i115.LocalClaimDataSource>(),
              gh<_i118.CacheCredentialDataSource>(),
              gh<_i77.ClaimMapper>(),
              gh<_i22.FiltersMapper>(),
              gh<_i28.IdFilterMapper>(),
              gh<_i56.StacktraceManager>(),
            ));
    gh.factory<_i121.DidProfileInfoRepository>(() => repositoriesModule
        .didProfileInfoRepository(gh<_i106.DidProfileInfoRepositoryImpl>()));
    gh.factory<_i122.GetDidProfileInfoListUseCase>(() =>
        _i122.GetDidProfileInfoListUseCase(
            gh<_i121.DidProfileInfoRepository>()));
    gh.factory<_i123.GetDidProfileInfoUseCase>(() =>
        _i123.GetDidProfileInfoUseCase(gh<_i121.DidProfileInfoRepository>()));
    gh.factoryAsync<_i124.GetEnvUseCase>(() async => _i124.GetEnvUseCase(
          await getAsync<_i119.ConfigRepository>(),
          gh<_i56.StacktraceManager>(),
        ));
    gh.factoryAsync<_i125.GetSelectedChainUseCase>(
        () async => _i125.GetSelectedChainUseCase(
              await getAsync<_i119.ConfigRepository>(),
    ...
    gh.factory<_i126.Iden3commCredentialRepository>(() =>
        repositoriesModule.iden3commCredentialRepository(
            gh<_i109.Iden3commCredentialRepositoryImpl>()));
    gh.factory<_i127.Iden3commRepositoryImpl>(
        () => _i127.Iden3commRepositoryImpl(
              gh<_i82.Iden3MessageDataSource>(),
              gh<_i99.RemoteIden3commDataSource>(),
              gh<_i112.LibPolygonIdCoreIden3commDataSource>(),
              gh<_i34.LibBabyJubJubDataSource>(),
              gh<_i5.AuthResponseMapper>(),
              gh<_i4.AuthInputsMapper>(),
              gh<_i74.AuthProofMapper>(),
              gh<_i108.GistMTProofMapper>(),
              gh<_i53.QMapper>(),
              gh<_i87.JWZMapper>(),
              gh<_i83.Iden3commProofMapper>(),
              gh<_i80.GetIden3MessageUseCase>(),
              gh<_i56.StacktraceManager>(),
            ));
    ...
    gh.factory<_i114.LibPolygonIdCoreProofDataSource>(
        () => _i114.LibPolygonIdCoreProofDataSource(
              gh<_i114.LibPolygonIdCoreWrapper>(),
              gh<_i56.StacktraceManager>(),
            ));
    ...
    gh.factoryAsync<_i130.RPCDataSource>(() async => _i130.RPCDataSource(
          await getAsync<_i125.GetSelectedChainUseCase>(),
          gh<_i56.StacktraceManager>(),
        ));
    gh.factory<_i131.RemoveDidProfileInfoUseCase>(() =>
        _i131.RemoveDidProfileInfoUseCase(
            gh<_i121.DidProfileInfoRepository>()));
    gh.factory<_i132.SMTRepository>(
        () => repositoriesModule.smtRepository(gh<_i117.SMTRepositoryImpl>()));
    gh.factoryAsync<_i133.SetEnvUseCase>(() async =>
        _i133.SetEnvUseCase(await getAsync<_i119.ConfigRepository>()));
    gh.factoryAsync<_i134.SetSelectedChainUseCase>(() async =>
        _i134.SetSelectedChainUseCase(
            await getAsync<_i119.ConfigRepository>()));
    gh.factory<_i135.AddDidProfileInfoUseCase>(() =>
        _i135.AddDidProfileInfoUseCase(gh<_i121.DidProfileInfoRepository>()));
    gh.factory<_i136.CredentialRepository>(() => repositoriesModule
        .credentialRepository(gh<_i120.CredentialRepositoryImpl>()));
    gh.factoryAsync<_i137.FetchOnchainClaimUseCase>(
        () async => _i137.FetchOnchainClaimUseCase(
              await getAsync<_i125.GetSelectedChainUseCase>(),
              await getAsync<_i124.GetEnvUseCase>(),
              gh<_i111.LibPolygonIdCoreCredentialDataSource>(),
              gh<_i35.LocalContractFilesDataSource>(),
              gh<_i99.RemoteIden3commDataSource>(),
              gh<_i77.ClaimMapper>(),
              gh<_i56.StacktraceManager>(),
            ));
    gh.factory<_i138.GetAuthClaimUseCase>(() => _i138.GetAuthClaimUseCase(
          gh<_i136.CredentialRepository>(),
          gh<_i56.StacktraceManager>(),
        ));
    gh.factory<_i139.GetClaimRevocationNonceUseCase>(() =>
        _i139.GetClaimRevocationNonceUseCase(gh<_i136.CredentialRepository>()));
    gh.factory<_i140.GetCredentialByIdUseCase>(
        () => _i140.GetCredentialByIdUseCase(gh<_i136.CredentialRepository>()));
    ...
    gh.factory<_i146.Iden3commRepository>(() => repositoriesModule
        .iden3commRepository(gh<_i127.Iden3commRepositoryImpl>()));
    gh.factoryAsync<_i147.IdentityRepositoryImpl>(
        () async => _i147.IdentityRepositoryImpl(
              gh<_i60.WalletDataSource>(),
              gh<_i100.RemoteIdentityDataSource>(),
              await getAsync<_i85.StorageIdentityDataSource>(),
              await getAsync<_i130.RPCDataSource>(),
              gh<_i35.LocalContractFilesDataSource>(),
              gh<_i34.LibBabyJubJubDataSource>(),
              gh<_i113.LibPolygonIdCoreIdentityDataSource>(),
              gh<_i19.EncryptionDbDataSource>(),
              gh<_i12.DestinationPathDataSource>(),
              gh<_i27.HexMapper>(),
              gh<_i48.PrivateKeyMapper>(),
              gh<_i31.IdentityDTOMapper>(),
              gh<_i101.RhsNodeMapper>(),
              gh<_i57.StateIdentifierMapper>(),
              gh<_i90.NodeMapper>(),
              gh<_i20.EncryptionKeyMapper>(),
              gh<_i104.SecureStorageProfilesDataSource>(),
            ));
    gh.factoryAsync<_i148.ProofRepositoryImpl>(
        () async => _i148.ProofRepositoryImpl(
              gh<_i63.WitnessDataSource>(),
              gh<_i52.ProverLibDataSource>(),
              gh<_i114.LibPolygonIdCoreProofDataSource>(),
              gh<_i25.GistMTProofDataSource>(),
              gh<_i49.ProofCircuitDataSource>(),
              gh<_i100.RemoteIdentityDataSource>(),
              gh<_i35.LocalContractFilesDataSource>(),
              gh<_i75.CircuitsDownloadDataSource>(),
              await getAsync<_i130.RPCDataSource>(),
              gh<_i8.CircuitTypeMapper>(),
              gh<_i72.ZKProofMapper>(),
              gh<_i77.ClaimMapper>(),
              gh<_i54.RevocationStatusMapper>(),
              gh<_i74.AuthProofMapper>(),
              gh<_i108.GistMTProofMapper>(),
              await getAsync<_i76.CircuitsFilesDataSource>(),
              gh<_i56.StacktraceManager>(),
            ));
    ...
    gh.factory<_i154.CacheCredentialUseCase>(
        () => _i154.CacheCredentialUseCase(gh<_i136.CredentialRepository>()));
    gh.factory<_i155.CleanSchemaCacheUseCase>(
        () => _i155.CleanSchemaCacheUseCase(gh<_i146.Iden3commRepository>()));
    gh.factory<_i156.GetAuthChallengeUseCase>(
        () => _i156.GetAuthChallengeUseCase(
              gh<_i146.Iden3commRepository>(),
              gh<_i56.StacktraceManager>(),
            ));
    gh.factory<_i157.GetJWZUseCase>(() => _i157.GetJWZUseCase(
          gh<_i146.Iden3commRepository>(),
          gh<_i56.StacktraceManager>(),
        ));
    gh.factoryAsync<_i158.IdentityRepository>(() async => repositoriesModule
        .identityRepository(await getAsync<_i147.IdentityRepositoryImpl>()));
    gh.factoryAsync<_i159.ProofRepository>(() async => repositoriesModule
        .proofRepository(await getAsync<_i148.ProofRepositoryImpl>()));
    gh.factoryAsync<_i160.ProveUseCase>(() async => _i160.ProveUseCase(
          await getAsync<_i159.ProofRepository>(),
          gh<_i56.StacktraceManager>(),
        ));
    gh.factoryAsync<_i161.SignMessageUseCase>(() async =>
        _i161.SignMessageUseCase(await getAsync<_i158.IdentityRepository>()));
    gh.factoryAsync<_i162.CancelDownloadCircuitsUseCase>(() async =>
        _i162.CancelDownloadCircuitsUseCase(
            await getAsync<_i159.ProofRepository>()));
    gh.factoryAsync<_i163.CircuitsFilesExistUseCase>(() async =>
        _i163.CircuitsFilesExistUseCase(
            await getAsync<_i159.ProofRepository>()));
    gh.factoryAsync<_i164.DownloadCircuitsUseCase>(() async =>
        _i164.DownloadCircuitsUseCase(await getAsync<_i159.ProofRepository>()));
    gh.factoryAsync<_i165.FetchStateRootsUseCase>(() async =>
        _i165.FetchStateRootsUseCase(
            await getAsync<_i158.IdentityRepository>()));
    gh.factoryAsync<_i166.GenerateZKProofUseCase>(
        () async => _i166.GenerateZKProofUseCase(
              await getAsync<_i159.ProofRepository>(),
              await getAsync<_i160.ProveUseCase>(),
              gh<_i56.StacktraceManager>(),
            ));
    gh.factoryAsync<_i167.GetDidUseCase>(() async =>
        _i167.GetDidUseCase(await getAsync<_i158.IdentityRepository>()));
    gh.factoryAsync<_i168.GetGistMTProofUseCase>(
        () async => _i168.GetGistMTProofUseCase(
              await getAsync<_i159.ProofRepository>(),
              await getAsync<_i158.IdentityRepository>(),
              await getAsync<_i125.GetSelectedChainUseCase>(),
              await getAsync<_i167.GetDidUseCase>(),
              gh<_i56.StacktraceManager>(),
            ));
    gh.factoryAsync<_i169.GetIdentitiesUseCase>(
        () async => _i169.GetIdentitiesUseCase(
              await getAsync<_i158.IdentityRepository>(),
              gh<_i56.StacktraceManager>(),
            ));
    gh.factoryAsync<_i170.GetIdentityAuthClaimUseCase>(
        () async => _i170.GetIdentityAuthClaimUseCase(
              await getAsync<_i158.IdentityRepository>(),
              gh<_i138.GetAuthClaimUseCase>(),
              gh<_i56.StacktraceManager>(),
            ));
    gh.factoryAsync<_i171.GetPrivateKeyUseCase>(
        () async => _i171.GetPrivateKeyUseCase(
              await getAsync<_i158.IdentityRepository>(),
              gh<_i56.StacktraceManager>(),
            ));
    gh.factoryAsync<_i172.GetPublicKeysUseCase>(
        () async => _i172.GetPublicKeysUseCase(
              await getAsync<_i158.IdentityRepository>(),
              gh<_i56.StacktraceManager>(),
            ));
    gh.factoryAsync<_i173.IsProofCircuitSupportedUseCase>(() async =>
        _i173.IsProofCircuitSupportedUseCase(
            await getAsync<_i159.ProofRepository>()));
    gh.factoryAsync<_i174.LoadCircuitUseCase>(
        () async => _i174.LoadCircuitUseCase(
              await getAsync<_i159.ProofRepository>(),
              gh<_i56.StacktraceManager>(),
            ));
    gh.factoryAsync<_i175.Proof>(() async => _i175.Proof(
          await getAsync<_i166.GenerateZKProofUseCase>(),
          await getAsync<_i164.DownloadCircuitsUseCase>(),
          await getAsync<_i163.CircuitsFilesExistUseCase>(),
          gh<_i50.ProofGenerationStepsStreamManager>(),
          await getAsync<_i162.CancelDownloadCircuitsUseCase>(),
          gh<_i56.StacktraceManager>(),
        ));
    gh.factoryAsync<_i176.CreateIdentityStateUseCase>(
        () async => _i176.CreateIdentityStateUseCase(
              await getAsync<_i158.IdentityRepository>(),
              gh<_i132.SMTRepository>(),
              await getAsync<_i170.GetIdentityAuthClaimUseCase>(),
              gh<_i56.StacktraceManager>(),
            ));
    gh.factoryAsync<_i177.FetchIdentityStateUseCase>(
        () async => _i177.FetchIdentityStateUseCase(
              await getAsync<_i158.IdentityRepository>(),
              await getAsync<_i125.GetSelectedChainUseCase>(),
              await getAsync<_i167.GetDidUseCase>(),
              gh<_i56.StacktraceManager>(),
            ));
    gh.factoryAsync<_i178.GenerateNonRevProofUseCase>(
        () async => _i178.GenerateNonRevProofUseCase(
              await getAsync<_i158.IdentityRepository>(),
              gh<_i136.CredentialRepository>(),
              await getAsync<_i177.FetchIdentityStateUseCase>(),
              gh<_i56.StacktraceManager>(),
            ));
    gh.factoryAsync<_i179.GetFiltersUseCase>(
        () async => _i179.GetFiltersUseCase(
              gh<_i126.Iden3commCredentialRepository>(),
              await getAsync<_i173.IsProofCircuitSupportedUseCase>(),
              gh<_i144.GetProofRequestsUseCase>(),
            ));
    gh.factoryAsync<_i180.GetGenesisStateUseCase>(
        () async => _i180.GetGenesisStateUseCase(
              await getAsync<_i158.IdentityRepository>(),
              gh<_i132.SMTRepository>(),
              await getAsync<_i170.GetIdentityAuthClaimUseCase>(),
              gh<_i56.StacktraceManager>(),
            ));
    gh.factoryAsync<_i181.GetNonRevProofUseCase>(
        () async => _i181.GetNonRevProofUseCase(
              await getAsync<_i158.IdentityRepository>(),
              gh<_i136.CredentialRepository>(),
              await getAsync<_i177.FetchIdentityStateUseCase>(),
              gh<_i56.StacktraceManager>(),
            ));
    gh.factoryAsync<_i182.GetClaimRevocationStatusUseCase>(
        () async => _i182.GetClaimRevocationStatusUseCase(
              gh<_i136.CredentialRepository>(),
              await getAsync<_i178.GenerateNonRevProofUseCase>(),
              await getAsync<_i181.GetNonRevProofUseCase>(),
              gh<_i56.StacktraceManager>(),
            ));
    gh.factoryAsync<_i183.GetDidIdentifierUseCase>(
        () async => _i183.GetDidIdentifierUseCase(
              await getAsync<_i158.IdentityRepository>(),
              await getAsync<_i124.GetEnvUseCase>(),
              await getAsync<_i180.GetGenesisStateUseCase>(),
              gh<_i56.StacktraceManager>(),
            ));
    gh.factoryAsync<_i184.GetIdentityUseCase>(
        () async => _i184.GetIdentityUseCase(
              await getAsync<_i158.IdentityRepository>(),
              await getAsync<_i167.GetDidUseCase>(),
              await getAsync<_i183.GetDidIdentifierUseCase>(),
              gh<_i56.StacktraceManager>(),
            ));
    gh.factoryAsync<_i185.GetInteractionsUseCase>(
        () async => _i185.GetInteractionsUseCase(
              await getAsync<_i128.InteractionRepository>(),
              gh<_i7.CheckProfileValidityUseCase>(),
              await getAsync<_i184.GetIdentityUseCase>(),
              gh<_i56.StacktraceManager>(),
            ));
    gh.factoryAsync<_i186.RemoveInteractionsUseCase>(
        () async => _i186.RemoveInteractionsUseCase(
              await getAsync<_i128.InteractionRepository>(),
              await getAsync<_i184.GetIdentityUseCase>(),
            ));
    gh.factoryAsync<_i187.AddInteractionUseCase>(
        () async => _i187.AddInteractionUseCase(
              await getAsync<_i128.InteractionRepository>(),
              gh<_i7.CheckProfileValidityUseCase>(),
              await getAsync<_i184.GetIdentityUseCase>(),
              gh<_i56.StacktraceManager>(),
            ));
    gh.factoryAsync<_i188.CheckProfileAndDidCurrentEnvUseCase>(
        () async => _i188.CheckProfileAndDidCurrentEnvUseCase(
              gh<_i7.CheckProfileValidityUseCase>(),
              await getAsync<_i125.GetSelectedChainUseCase>(),
              await getAsync<_i183.GetDidIdentifierUseCase>(),
              gh<_i56.StacktraceManager>(),
            ));
    gh.factoryAsync<_i189.FetchOnchainClaimsUseCase>(
        () async => _i189.FetchOnchainClaimsUseCase(
              await getAsync<_i137.FetchOnchainClaimUseCase>(),
              await getAsync<_i188.CheckProfileAndDidCurrentEnvUseCase>(),
              await getAsync<_i124.GetEnvUseCase>(),
              await getAsync<_i125.GetSelectedChainUseCase>(),
              await getAsync<_i183.GetDidIdentifierUseCase>(),
              await getAsync<_i167.GetDidUseCase>(),
    ...
    gh.factoryAsync<_i190.GenerateIden3commProofUseCase>(
        () async => _i190.GenerateIden3commProofUseCase(
              await getAsync<_i158.IdentityRepository>(),
              gh<_i132.SMTRepository>(),
              await getAsync<_i159.ProofRepository>(),
              await getAsync<_i160.ProveUseCase>(),
              await getAsync<_i184.GetIdentityUseCase>(),
              gh<_i138.GetAuthClaimUseCase>(),
              await getAsync<_i168.GetGistMTProofUseCase>(),
              await getAsync<_i167.GetDidUseCase>(),
              await getAsync<_i161.SignMessageUseCase>(),
              gh<_i142.GetLatestStateUseCase>(),
              gh<_i56.StacktraceManager>(),
            ));
    gh.factoryAsync<_i191.GetAuthInputsUseCase>(
        () async => _i191.GetAuthInputsUseCase(
              await getAsync<_i184.GetIdentityUseCase>(),
              gh<_i138.GetAuthClaimUseCase>(),
              await getAsync<_i161.SignMessageUseCase>(),
              await getAsync<_i168.GetGistMTProofUseCase>(),
    ...
    gh.factoryAsync<_i192.GetAuthTokenUseCase>(
        () async => _i192.GetAuthTokenUseCase(
              await getAsync<_i174.LoadCircuitUseCase>(),
              gh<_i157.GetJWZUseCase>(),
              gh<_i156.GetAuthChallengeUseCase>(),
              await getAsync<_i191.GetAuthInputsUseCase>(),
              await getAsync<_i160.ProveUseCase>(),
              gh<_i56.StacktraceManager>(),
            ));
    gh.factoryAsync<_i193.GetCurrentEnvDidIdentifierUseCase>(
        () async => _i193.GetCurrentEnvDidIdentifierUseCase(
              await getAsync<_i125.GetSelectedChainUseCase>(),
              await getAsync<_i183.GetDidIdentifierUseCase>(),
              gh<_i56.StacktraceManager>(),
            ));
    gh.factoryAsync<_i194.GetProfilesUseCase>(
        () async => _i194.GetProfilesUseCase(
              await getAsync<_i184.GetIdentityUseCase>(),
              await getAsync<_i188.CheckProfileAndDidCurrentEnvUseCase>(),
              gh<_i56.StacktraceManager>(),
            ));
    gh.factoryAsync<_i195.RefreshCredentialUseCase>(
        () async => _i195.RefreshCredentialUseCase(
              gh<_i136.CredentialRepository>(),
              gh<_i56.StacktraceManager>(),
              await getAsync<_i184.GetIdentityUseCase>(),
              await getAsync<_i192.GetAuthTokenUseCase>(),
              gh<_i126.Iden3commCredentialRepository>(),
              gh<_i150.RemoveClaimsUseCase>(),
              gh<_i152.SaveClaimsUseCase>(),
            ));
    gh.factoryAsync<_i196.UpdateInteractionUseCase>(
        () async => _i196.UpdateInteractionUseCase(
              await getAsync<_i128.InteractionRepository>(),
              gh<_i7.CheckProfileValidityUseCase>(),
              await getAsync<_i184.GetIdentityUseCase>(),
              await getAsync<_i187.AddInteractionUseCase>(),
            ));
    gh.factoryAsync<_i197.BackupIdentityUseCase>(
        () async => _i197.BackupIdentityUseCase(
              await getAsync<_i184.GetIdentityUseCase>(),
              await getAsync<_i158.IdentityRepository>(),
              await getAsync<_i193.GetCurrentEnvDidIdentifierUseCase>(),
              gh<_i56.StacktraceManager>(),
            ));
    gh.factoryAsync<_i198.CheckIdentityValidityUseCase>(
        () async => _i198.CheckIdentityValidityUseCase(
              await getAsync<_i171.GetPrivateKeyUseCase>(),
              await getAsync<_i193.GetCurrentEnvDidIdentifierUseCase>(),
              gh<_i56.StacktraceManager>(),
            ));
    gh.factoryAsync<_i199.CreateIdentityUseCase>(
        () async => _i199.CreateIdentityUseCase(
              await getAsync<_i172.GetPublicKeysUseCase>(),
              await getAsync<_i193.GetCurrentEnvDidIdentifierUseCase>(),
              gh<_i56.StacktraceManager>(),
            ));
    gh.factoryAsync<_i200.CreateProfilesUseCase>(
        () async => _i200.CreateProfilesUseCase(
              await getAsync<_i172.GetPublicKeysUseCase>(),
              await getAsync<_i193.GetCurrentEnvDidIdentifierUseCase>(),
              gh<_i56.StacktraceManager>(),
            ));
    gh.factoryAsync<_i201.FetchAndSaveClaimsUseCase>(
        () async => _i201.FetchAndSaveClaimsUseCase(
              gh<_i126.Iden3commCredentialRepository>(),
              await getAsync<_i137.FetchOnchainClaimUseCase>(),
              await getAsync<_i188.CheckProfileAndDidCurrentEnvUseCase>(),
              await getAsync<_i124.GetEnvUseCase>(),
    ...
    gh.factoryAsync<_i202.GetClaimsUseCase>(() async => _i202.GetClaimsUseCase(
          gh<_i136.CredentialRepository>(),
          await getAsync<_i193.GetCurrentEnvDidIdentifierUseCase>(),
          gh<_i56.StacktraceManager>(),
        ));
    gh.factoryAsync<_i203.GetIden3commClaimsRevNonceUseCase>(
        () async => _i203.GetIden3commClaimsRevNonceUseCase(
              gh<_i126.Iden3commCredentialRepository>(),
              await getAsync<_i202.GetClaimsUseCase>(),
              gh<_i139.GetClaimRevocationNonceUseCase>(),
              await getAsync<_i173.IsProofCircuitSupportedUseCase>(),
              gh<_i144.GetProofRequestsUseCase>(),
            ));
    gh.factoryAsync<_i204.GetIden3commClaimsUseCase>(
        () async => _i204.GetIden3commClaimsUseCase(
              gh<_i126.Iden3commCredentialRepository>(),
              await getAsync<_i202.GetClaimsUseCase>(),
              await getAsync<_i182.GetClaimRevocationStatusUseCase>(),
              gh<_i139.GetClaimRevocationNonceUseCase>(),
    ...
    gh.factoryAsync<_i205.GetIden3commProofsUseCase>(
        () async => _i205.GetIden3commProofsUseCase(
              await getAsync<_i159.ProofRepository>(),
              await getAsync<_i204.GetIden3commClaimsUseCase>(),
              await getAsync<_i190.GenerateIden3commProofUseCase>(),
              await getAsync<_i173.IsProofCircuitSupportedUseCase>(),
              gh<_i144.GetProofRequestsUseCase>(),
              await getAsync<_i184.GetIdentityUseCase>(),
              gh<_i50.ProofGenerationStepsStreamManager>(),
              ...
              gh<_i150.RemoveClaimsUseCase>(),
              gh<_i152.SaveClaimsUseCase>(),
              await getAsync<_i195.RefreshCredentialUseCase>(),
            ));
    gh.factoryAsync<_i206.UpdateIdentityUseCase>(
        () async => _i206.UpdateIdentityUseCase(
              await getAsync<_i158.IdentityRepository>(),
              await getAsync<_i199.CreateIdentityUseCase>(),
              await getAsync<_i184.GetIdentityUseCase>(),
            ));
    gh.factoryAsync<_i207.AddIdentityUseCase>(
        () async => _i207.AddIdentityUseCase(
              await getAsync<_i158.IdentityRepository>(),
              await getAsync<_i199.CreateIdentityUseCase>(),
              await getAsync<_i176.CreateIdentityStateUseCase>(),
              gh<_i56.StacktraceManager>(),
            ));
    gh.factoryAsync<_i208.AddNewIdentityUseCase>(
        () async => _i208.AddNewIdentityUseCase(
              await getAsync<_i158.IdentityRepository>(),
              await getAsync<_i207.AddIdentityUseCase>(),
              gh<_i56.StacktraceManager>(),
            ));
    gh.factoryAsync<_i209.AddProfileUseCase>(
        () async => _i209.AddProfileUseCase(
              await getAsync<_i184.GetIdentityUseCase>(),
              await getAsync<_i206.UpdateIdentityUseCase>(),
              await getAsync<_i188.CheckProfileAndDidCurrentEnvUseCase>(),
              await getAsync<_i200.CreateProfilesUseCase>(),
              gh<_i113.LibPolygonIdCoreIdentityDataSource>(),
              gh<_i56.StacktraceManager>(),
            ));
    gh.factoryAsync<_i210.AuthenticateUseCase>(
        () async => _i210.AuthenticateUseCase(
              gh<_i146.Iden3commRepository>(),
              await getAsync<_i205.GetIden3commProofsUseCase>(),
              await getAsync<_i183.GetDidIdentifierUseCase>(),
              await getAsync<_i192.GetAuthTokenUseCase>(),
              await getAsync<_i124.GetEnvUseCase>(),
              await getAsync<_i125.GetSelectedChainUseCase>(),
              await getAsync<_i107.GetPackageNameUseCase>(),
              await getAsync<_i188.CheckProfileAndDidCurrentEnvUseCase>(),
              gh<_i50.ProofGenerationStepsStreamManager>(),
              gh<_i56.StacktraceManager>(),
            ));
    gh.factoryAsync<_i211.Credential>(() async => _i211.Credential(
          gh<_i152.SaveClaimsUseCase>(),
          await getAsync<_i202.GetClaimsUseCase>(),
          gh<_i150.RemoveClaimsUseCase>(),
          await getAsync<_i182.GetClaimRevocationStatusUseCase>(),
    ...
    gh.factoryAsync<_i212.Iden3comm>(() async => _i212.Iden3comm(
          await getAsync<_i201.FetchAndSaveClaimsUseCase>(),
          await getAsync<_i189.FetchOnchainClaimsUseCase>(),
          gh<_i80.GetIden3MessageUseCase>(),
          gh<_i145.GetSchemasUseCase>(),
          await getAsync<_i210.AuthenticateUseCase>(),
          await getAsync<_i179.GetFiltersUseCase>(),
          await getAsync<_i204.GetIden3commClaimsUseCase>(),
          await getAsync<_i203.GetIden3commClaimsRevNonceUseCase>(),
          await getAsync<_i205.GetIden3commProofsUseCase>(),
          await getAsync<_i185.GetInteractionsUseCase>(),
          await getAsync<_i187.AddInteractionUseCase>(),
          await getAsync<_i186.RemoveInteractionsUseCase>(),
          await getAsync<_i196.UpdateInteractionUseCase>(),
          gh<_i155.CleanSchemaCacheUseCase>(),
          gh<_i56.StacktraceManager>(),
          gh<_i135.AddDidProfileInfoUseCase>(),
          gh<_i123.GetDidProfileInfoUseCase>(),
          gh<_i122.GetDidProfileInfoListUseCase>(),
          gh<_i131.RemoveDidProfileInfoUseCase>(),
          await getAsync<_i192.GetAuthTokenUseCase>(),
        ));
    gh.factoryAsync<_i213.RemoveProfileUseCase>(
        () async => _i213.RemoveProfileUseCase(
              await getAsync<_i184.GetIdentityUseCase>(),
              await getAsync<_i206.UpdateIdentityUseCase>(),
              await getAsync<_i188.CheckProfileAndDidCurrentEnvUseCase>(),
              await getAsync<_i200.CreateProfilesUseCase>(),
    ...
    gh.factoryAsync<_i214.RestoreProfilesUseCase>(
        () async => _i214.RestoreProfilesUseCase(
              await getAsync<_i158.IdentityRepository>(),
              await getAsync<_i206.UpdateIdentityUseCase>(),
            ));
    gh.factoryAsync<_i215.RemoveIdentityUseCase>(
        () async => _i215.RemoveIdentityUseCase(
              await getAsync<_i158.IdentityRepository>(),
              await getAsync<_i194.GetProfilesUseCase>(),
              await getAsync<_i213.RemoveProfileUseCase>(),
              gh<_i151.RemoveIdentityStateUseCase>(),
              gh<_i149.RemoveAllClaimsUseCase>(),
              await getAsync<_i188.CheckProfileAndDidCurrentEnvUseCase>(),
              gh<_i56.StacktraceManager>(),
            ));
    gh.factoryAsync<_i216.RestoreIdentityUseCase>(
        () async => _i216.RestoreIdentityUseCase(
              await getAsync<_i207.AddIdentityUseCase>(),
              await getAsync<_i184.GetIdentityUseCase>(),
              await getAsync<_i158.IdentityRepository>(),
              await getAsync<_i193.GetCurrentEnvDidIdentifierUseCase>(),
              await getAsync<_i214.RestoreProfilesUseCase>(),
            ));
    gh.factoryAsync<_i217.Identity>(() async => _i217.Identity(
          await getAsync<_i198.CheckIdentityValidityUseCase>(),
          await getAsync<_i171.GetPrivateKeyUseCase>(),
          await getAsync<_i208.AddNewIdentityUseCase>(),
          await getAsync<_i216.RestoreIdentityUseCase>(),
          await getAsync<_i197.BackupIdentityUseCase>(),
          await getAsync<_i184.GetIdentityUseCase>(),
          await getAsync<_i169.GetIdentitiesUseCase>(),
          await getAsync<_i215.RemoveIdentityUseCase>(),
          await getAsync<_i183.GetDidIdentifierUseCase>(),
          await getAsync<_i161.SignMessageUseCase>(),
          await getAsync<_i177.FetchIdentityStateUseCase>(),
          await getAsync<_i209.AddProfileUseCase>(),
          await getAsync<_i194.GetProfilesUseCase>(),
          await getAsync<_i213.RemoveProfileUseCase>(),
          await getAsync<_i167.GetDidUseCase>(),
          gh<_i56.StacktraceManager>(),
...
class _$PlatformModule extends _i218.PlatformModule {}

class _$NetworkModule extends _i218.NetworkModule {}

class _$DatabaseModule extends _i218.DatabaseModule {}

class _$FilesManagerModule extends _i218.FilesManagerModule {}

class _$EncryptionModule extends _i218.EncryptionModule {}

class _$LoggerModule extends _i218.LoggerModule {}

class _$ChannelModule extends _i218.ChannelModule {}

class _$RepositoriesModule extends _i218.RepositoriesModule {}

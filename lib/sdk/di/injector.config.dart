...
import 'package:polygonid_flutter_sdk/proof/libs/witnesscalc/v3_onchain/witness_v3_onchain.dart'
    as _i78;
import 'package:polygonid_flutter_sdk/sdk/credential.dart' as _i207;
import 'package:polygonid_flutter_sdk/sdk/di/injector.dart' as _i214;
import 'package:polygonid_flutter_sdk/sdk/error_handling.dart' as _i87;
import 'package:polygonid_flutter_sdk/sdk/iden3comm.dart' as _i208;
import 'package:polygonid_flutter_sdk/sdk/identity.dart' as _i213;
...
import 'package:polygonid_flutter_sdk/sdk/polygonid_flutter_channel.dart'
    as _i103;
import 'package:polygonid_flutter_sdk/sdk/proof.dart' as _i172;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt $initSDKGetIt({
    ...
    gh.factoryAsync<_i135.RPCDataSource>(
        () async => _i135.RPCDataSource(await getAsync<_i130.GetEnvUseCase>()));
    ...
    gh.factoryAsync<_i141.SetEnvUseCase>(() async =>
        _i141.SetEnvUseCase(await getAsync<_i121.ConfigRepository>()));
    gh.factory<_i142.UpdateClaimUseCase>(() => _i142.UpdateClaimUseCase(
          gh<_i122.CredentialRepository>(),
          gh<_i64.StacktraceManager>(),
        ));
    gh.factory<_i143.AddDidProfileInfoUseCase>(() =>
        _i143.AddDidProfileInfoUseCase(gh<_i123.DidProfileInfoRepository>()));
    gh.factory<_i144.CacheCredentialUseCase>(
        () => _i144.CacheCredentialUseCase(gh<_i122.CredentialRepository>()));
    gh.factory<_i145.CleanSchemaCacheUseCase>(
        () => _i145.CleanSchemaCacheUseCase(gh<_i132.Iden3commRepository>()));
    ...
    gh.factory<_i148.GetLatestStateUseCase>(() => _i148.GetLatestStateUseCase(
          gh<_i139.SMTRepository>(),
          gh<_i64.StacktraceManager>(),
        ));
    gh.factory<_i149.GetProofQueryContextUseCase>(
        () => _i149.GetProofQueryContextUseCase(
              gh<_i131.Iden3commCredentialRepository>(),
              gh<_i64.StacktraceManager>(),
            ));
    gh.factory<_i150.GetProofRequestsUseCase>(
        () => _i150.GetProofRequestsUseCase(
              gh<_i149.GetProofQueryContextUseCase>(),
              gh<_i89.GetProofQueryUseCase>(),
              gh<_i64.StacktraceManager>(),
            ));
    gh.factory<_i151.GetSchemasUseCase>(() =>
        _i151.GetSchemasUseCase(gh<_i131.Iden3commCredentialRepository>()));
    gh.factoryAsync<_i152.IdentityRepositoryImpl>(
        () async => _i152.IdentityRepositoryImpl(
    ...
    gh.factoryAsync<_i153.ProofRepositoryImpl>(
        () async => _i153.ProofRepositoryImpl(
    ...
    gh.factory<_i154.RemoveIdentityStateUseCase>(
        () => _i154.RemoveIdentityStateUseCase(
              gh<_i139.SMTRepository>(),
              gh<_i64.StacktraceManager>(),
            ));
    gh.factoryAsync<_i155.IdentityRepository>(() async => repositoriesModule
        .identityRepository(await getAsync<_i152.IdentityRepositoryImpl>()));
    gh.factoryAsync<_i156.ProofRepository>(() async => repositoriesModule
        .proofRepository(await getAsync<_i153.ProofRepositoryImpl>()));
    gh.factoryAsync<_i157.ProveUseCase>(() async => _i157.ProveUseCase(
          await getAsync<_i156.ProofRepository>(),
          gh<_i64.StacktraceManager>(),
        ));
    gh.factoryAsync<_i158.SignMessageUseCase>(() async =>
        _i158.SignMessageUseCase(await getAsync<_i155.IdentityRepository>()));
    gh.factoryAsync<_i159.CancelDownloadCircuitsUseCase>(() async =>
        _i159.CancelDownloadCircuitsUseCase(
            await getAsync<_i156.ProofRepository>()));
    gh.factoryAsync<_i160.CircuitsFilesExistUseCase>(() async =>
        _i160.CircuitsFilesExistUseCase(
            await getAsync<_i156.ProofRepository>()));
    gh.factoryAsync<_i161.DownloadCircuitsUseCase>(() async =>
        _i161.DownloadCircuitsUseCase(await getAsync<_i156.ProofRepository>()));
    gh.factoryAsync<_i162.FetchStateRootsUseCase>(() async =>
        _i162.FetchStateRootsUseCase(
            await getAsync<_i155.IdentityRepository>()));
    gh.factoryAsync<_i163.GenerateZKProofUseCase>(
        () async => _i163.GenerateZKProofUseCase(
              await getAsync<_i156.ProofRepository>(),
              await getAsync<_i157.ProveUseCase>(),
              gh<_i64.StacktraceManager>(),
            ));
    gh.factoryAsync<_i164.GetDidUseCase>(() async =>
        _i164.GetDidUseCase(await getAsync<_i155.IdentityRepository>()));
    gh.factoryAsync<_i165.GetGistMTProofUseCase>(
        () async => _i165.GetGistMTProofUseCase(
              await getAsync<_i156.ProofRepository>(),
              await getAsync<_i155.IdentityRepository>(),
              await getAsync<_i130.GetEnvUseCase>(),
              await getAsync<_i164.GetDidUseCase>(),
              gh<_i64.StacktraceManager>(),
            ));
    gh.factoryAsync<_i166.GetIdentitiesUseCase>(
        () async => _i166.GetIdentitiesUseCase(
              await getAsync<_i155.IdentityRepository>(),
              gh<_i64.StacktraceManager>(),
            ));
    gh.factoryAsync<_i167.GetIdentityAuthClaimUseCase>(
        () async => _i167.GetIdentityAuthClaimUseCase(
              await getAsync<_i155.IdentityRepository>(),
              gh<_i124.GetAuthClaimUseCase>(),
              gh<_i64.StacktraceManager>(),
            ));
    gh.factoryAsync<_i168.GetPrivateKeyUseCase>(
        () async => _i168.GetPrivateKeyUseCase(
              await getAsync<_i155.IdentityRepository>(),
              gh<_i64.StacktraceManager>(),
            ));
    gh.factoryAsync<_i169.GetPublicKeysUseCase>(
        () async => _i169.GetPublicKeysUseCase(
              await getAsync<_i155.IdentityRepository>(),
              gh<_i64.StacktraceManager>(),
            ));
    gh.factoryAsync<_i170.IsProofCircuitSupportedUseCase>(() async =>
        _i170.IsProofCircuitSupportedUseCase(
            await getAsync<_i156.ProofRepository>()));
    gh.factoryAsync<_i171.LoadCircuitUseCase>(
        () async => _i171.LoadCircuitUseCase(
              await getAsync<_i156.ProofRepository>(),
              gh<_i64.StacktraceManager>(),
            ));
    gh.factoryAsync<_i172.Proof>(() async => _i172.Proof(
          await getAsync<_i163.GenerateZKProofUseCase>(),
          await getAsync<_i161.DownloadCircuitsUseCase>(),
          await getAsync<_i160.CircuitsFilesExistUseCase>(),
          gh<_i56.ProofGenerationStepsStreamManager>(),
          await getAsync<_i159.CancelDownloadCircuitsUseCase>(),
          gh<_i64.StacktraceManager>(),
        ));
    gh.factoryAsync<_i173.CreateIdentityStateUseCase>(
        () async => _i173.CreateIdentityStateUseCase(
              await getAsync<_i155.IdentityRepository>(),
              gh<_i139.SMTRepository>(),
              await getAsync<_i167.GetIdentityAuthClaimUseCase>(),
              gh<_i64.StacktraceManager>(),
            ));
    gh.factoryAsync<_i174.FetchIdentityStateUseCase>(
        () async => _i174.FetchIdentityStateUseCase(
              await getAsync<_i155.IdentityRepository>(),
              await getAsync<_i130.GetEnvUseCase>(),
              await getAsync<_i164.GetDidUseCase>(),
              gh<_i64.StacktraceManager>(),
            ));
    gh.factoryAsync<_i175.GenerateNonRevProofUseCase>(
        () async => _i175.GenerateNonRevProofUseCase(
              await getAsync<_i155.IdentityRepository>(),
              gh<_i122.CredentialRepository>(),
              await getAsync<_i174.FetchIdentityStateUseCase>(),
              gh<_i64.StacktraceManager>(),
            ));
    gh.factoryAsync<_i176.GetFiltersUseCase>(
        () async => _i176.GetFiltersUseCase(
              gh<_i131.Iden3commCredentialRepository>(),
              await getAsync<_i170.IsProofCircuitSupportedUseCase>(),
              gh<_i150.GetProofRequestsUseCase>(),
            ));
    gh.factoryAsync<_i177.GetGenesisStateUseCase>(
        () async => _i177.GetGenesisStateUseCase(
              await getAsync<_i155.IdentityRepository>(),
              gh<_i139.SMTRepository>(),
              await getAsync<_i167.GetIdentityAuthClaimUseCase>(),
              gh<_i64.StacktraceManager>(),
            ));
    gh.factoryAsync<_i178.GetNonRevProofUseCase>(
        () async => _i178.GetNonRevProofUseCase(
              await getAsync<_i155.IdentityRepository>(),
              gh<_i122.CredentialRepository>(),
              await getAsync<_i174.FetchIdentityStateUseCase>(),
              gh<_i64.StacktraceManager>(),
            ));
    gh.factoryAsync<_i179.GetClaimRevocationStatusUseCase>(
        () async => _i179.GetClaimRevocationStatusUseCase(
              gh<_i122.CredentialRepository>(),
              await getAsync<_i175.GenerateNonRevProofUseCase>(),
              await getAsync<_i178.GetNonRevProofUseCase>(),
              gh<_i64.StacktraceManager>(),
            ));
    gh.factoryAsync<_i180.GetDidIdentifierUseCase>(
        () async => _i180.GetDidIdentifierUseCase(
              await getAsync<_i155.IdentityRepository>(),
              await getAsync<_i177.GetGenesisStateUseCase>(),
              gh<_i64.StacktraceManager>(),
            ));
    gh.factoryAsync<_i181.GetIdentityUseCase>(
        () async => _i181.GetIdentityUseCase(
              await getAsync<_i155.IdentityRepository>(),
              await getAsync<_i164.GetDidUseCase>(),
              await getAsync<_i180.GetDidIdentifierUseCase>(),
              gh<_i64.StacktraceManager>(),
            ));
    gh.factoryAsync<_i182.GetInteractionsUseCase>(
        () async => _i182.GetInteractionsUseCase(
              await getAsync<_i133.InteractionRepository>(),
              gh<_i7.CheckProfileValidityUseCase>(),
              await getAsync<_i181.GetIdentityUseCase>(),
            ));
    gh.factoryAsync<_i183.RemoveInteractionsUseCase>(
        () async => _i183.RemoveInteractionsUseCase(
              await getAsync<_i133.InteractionRepository>(),
              await getAsync<_i181.GetIdentityUseCase>(),
            ));
    gh.factoryAsync<_i184.AddInteractionUseCase>(
        () async => _i184.AddInteractionUseCase(
              await getAsync<_i133.InteractionRepository>(),
              gh<_i7.CheckProfileValidityUseCase>(),
              await getAsync<_i181.GetIdentityUseCase>(),
            ));
    gh.factoryAsync<_i185.CheckProfileAndDidCurrentEnvUseCase>(
        () async => _i185.CheckProfileAndDidCurrentEnvUseCase(
              gh<_i7.CheckProfileValidityUseCase>(),
              await getAsync<_i130.GetEnvUseCase>(),
              await getAsync<_i180.GetDidIdentifierUseCase>(),
              gh<_i64.StacktraceManager>(),
    ...
    gh.factoryAsync<_i186.GenerateIden3commProofUseCase>(
        () async => _i186.GenerateIden3commProofUseCase(
              ...
              await getAsync<_i181.GetIdentityUseCase>(),
              gh<_i124.GetAuthClaimUseCase>(),
              await getAsync<_i165.GetGistMTProofUseCase>(),
              await getAsync<_i164.GetDidUseCase>(),
              await getAsync<_i158.SignMessageUseCase>(),
              gh<_i148.GetLatestStateUseCase>(),
              gh<_i64.StacktraceManager>(),
            ));
    ...
    gh.factoryAsync<_i188.GetAuthTokenUseCase>(
        () async => _i188.GetAuthTokenUseCase(
              await getAsync<_i171.LoadCircuitUseCase>(),
    ...
    gh.factoryAsync<_i190.GetProfilesUseCase>(
        () async => _i190.GetProfilesUseCase(
              await getAsync<_i181.GetIdentityUseCase>(),
              await getAsync<_i185.CheckProfileAndDidCurrentEnvUseCase>(),
              gh<_i64.StacktraceManager>(),
            ));
    ...
    gh.factoryAsync<_i192.UpdateInteractionUseCase>(
        () async => _i192.UpdateInteractionUseCase(
              ...
              gh<_i7.CheckProfileValidityUseCase>(),
              await getAsync<_i181.GetIdentityUseCase>(),
              await getAsync<_i184.AddInteractionUseCase>(),
            ));
    ...
    gh.factoryAsync<_i194.CheckIdentityValidityUseCase>(
        () async => _i194.CheckIdentityValidityUseCase(
              await getAsync<_i168.GetPrivateKeyUseCase>(),
              await getAsync<_i189.GetCurrentEnvDidIdentifierUseCase>(),
              gh<_i64.StacktraceManager>(),
            ));
    gh.factoryAsync<_i195.CreateIdentityUseCase>(
        () async => _i195.CreateIdentityUseCase(
              await getAsync<_i169.GetPublicKeysUseCase>(),
              await getAsync<_i189.GetCurrentEnvDidIdentifierUseCase>(),
              gh<_i64.StacktraceManager>(),
            ));
    ...
    gh.factoryAsync<_i197.FetchAndSaveClaimsUseCase>(
        () async => _i197.FetchAndSaveClaimsUseCase(
              ...
              await getAsync<_i188.GetAuthTokenUseCase>(),
              gh<_i140.SaveClaimsUseCase>(),
              await getAsync<_i179.GetClaimRevocationStatusUseCase>(),
              gh<_i144.CacheCredentialUseCase>(),
              gh<_i64.StacktraceManager>(),
            ));
    gh.factoryAsync<_i198.GetClaimsUseCase>(() async => _i198.GetClaimsUseCase(
          gh<_i122.CredentialRepository>(),
          await getAsync<_i189.GetCurrentEnvDidIdentifierUseCase>(),
          gh<_i64.StacktraceManager>(),
        ));
    gh.factoryAsync<_i199.GetIden3commClaimsRevNonceUseCase>(
        () async => _i199.GetIden3commClaimsRevNonceUseCase(
              gh<_i131.Iden3commCredentialRepository>(),
              await getAsync<_i198.GetClaimsUseCase>(),
              gh<_i125.GetClaimRevocationNonceUseCase>(),
              await getAsync<_i170.IsProofCircuitSupportedUseCase>(),
              gh<_i150.GetProofRequestsUseCase>(),
            ));
    gh.factoryAsync<_i200.GetIden3commClaimsUseCase>(
        () async => _i200.GetIden3commClaimsUseCase(
              gh<_i131.Iden3commCredentialRepository>(),
              await getAsync<_i198.GetClaimsUseCase>(),
              await getAsync<_i179.GetClaimRevocationStatusUseCase>(),
              gh<_i125.GetClaimRevocationNonceUseCase>(),
    ...
    gh.factoryAsync<_i201.GetIden3commProofsUseCase>(
        () async => _i201.GetIden3commProofsUseCase(
              await getAsync<_i156.ProofRepository>(),
              await getAsync<_i200.GetIden3commClaimsUseCase>(),
    ...
    gh.factoryAsync<_i202.UpdateIdentityUseCase>(
        () async => _i202.UpdateIdentityUseCase(
              await getAsync<_i155.IdentityRepository>(),
              await getAsync<_i195.CreateIdentityUseCase>(),
              await getAsync<_i181.GetIdentityUseCase>(),
            ));
    gh.factoryAsync<_i203.AddIdentityUseCase>(
        () async => _i203.AddIdentityUseCase(
              await getAsync<_i155.IdentityRepository>(),
              await getAsync<_i195.CreateIdentityUseCase>(),
              await getAsync<_i173.CreateIdentityStateUseCase>(),
              gh<_i64.StacktraceManager>(),
            ));
    gh.factoryAsync<_i204.AddNewIdentityUseCase>(
        () async => _i204.AddNewIdentityUseCase(
              await getAsync<_i155.IdentityRepository>(),
              await getAsync<_i203.AddIdentityUseCase>(),
              gh<_i64.StacktraceManager>(),
            ));
    gh.factoryAsync<_i205.AddProfileUseCase>(
        () async => _i205.AddProfileUseCase(
              await getAsync<_i181.GetIdentityUseCase>(),
              await getAsync<_i202.UpdateIdentityUseCase>(),
              await getAsync<_i185.CheckProfileAndDidCurrentEnvUseCase>(),
              await getAsync<_i196.CreateProfilesUseCase>(),
              gh<_i64.StacktraceManager>(),
            ));
    gh.factoryAsync<_i206.AuthenticateUseCase>(
        () async => _i206.AuthenticateUseCase(
              gh<_i132.Iden3commRepository>(),
              await getAsync<_i201.GetIden3commProofsUseCase>(),
              await getAsync<_i180.GetDidIdentifierUseCase>(),
              await getAsync<_i188.GetAuthTokenUseCase>(),
              await getAsync<_i130.GetEnvUseCase>(),
    ...
    gh.factoryAsync<_i207.Credential>(() async => _i207.Credential(
          gh<_i140.SaveClaimsUseCase>(),
          await getAsync<_i198.GetClaimsUseCase>(),
          gh<_i137.RemoveClaimsUseCase>(),
          await getAsync<_i179.GetClaimRevocationStatusUseCase>(),
    ...
    gh.factoryAsync<_i208.Iden3comm>(() async => _i208.Iden3comm(
          await getAsync<_i197.FetchAndSaveClaimsUseCase>(),
          gh<_i88.GetIden3MessageUseCase>(),
          gh<_i151.GetSchemasUseCase>(),
          await getAsync<_i206.AuthenticateUseCase>(),
          await getAsync<_i176.GetFiltersUseCase>(),
          await getAsync<_i200.GetIden3commClaimsUseCase>(),
          await getAsync<_i199.GetIden3commClaimsRevNonceUseCase>(),
          await getAsync<_i201.GetIden3commProofsUseCase>(),
          await getAsync<_i182.GetInteractionsUseCase>(),
          await getAsync<_i184.AddInteractionUseCase>(),
          await getAsync<_i183.RemoveInteractionsUseCase>(),
          await getAsync<_i192.UpdateInteractionUseCase>(),
          gh<_i145.CleanSchemaCacheUseCase>(),
          gh<_i64.StacktraceManager>(),
          gh<_i143.AddDidProfileInfoUseCase>(),
          gh<_i129.GetDidProfileInfoUseCase>(),
          gh<_i128.GetDidProfileInfoListUseCase>(),
          gh<_i138.RemoveDidProfileInfoUseCase>(),
        ));
    gh.factoryAsync<_i209.RemoveProfileUseCase>(
        () async => _i209.RemoveProfileUseCase(
              await getAsync<_i181.GetIdentityUseCase>(),
              await getAsync<_i202.UpdateIdentityUseCase>(),
              await getAsync<_i185.CheckProfileAndDidCurrentEnvUseCase>(),
              await getAsync<_i196.CreateProfilesUseCase>(),
              gh<_i154.RemoveIdentityStateUseCase>(),
              gh<_i136.RemoveAllClaimsUseCase>(),
              gh<_i64.StacktraceManager>(),
            ));
    gh.factoryAsync<_i210.RestoreProfilesUseCase>(
        () async => _i210.RestoreProfilesUseCase(
              await getAsync<_i155.IdentityRepository>(),
              await getAsync<_i202.UpdateIdentityUseCase>(),
            ));
    gh.factoryAsync<_i211.RemoveIdentityUseCase>(
        () async => _i211.RemoveIdentityUseCase(
              await getAsync<_i155.IdentityRepository>(),
              await getAsync<_i190.GetProfilesUseCase>(),
              await getAsync<_i209.RemoveProfileUseCase>(),
              gh<_i154.RemoveIdentityStateUseCase>(),
              gh<_i136.RemoveAllClaimsUseCase>(),
              await getAsync<_i185.CheckProfileAndDidCurrentEnvUseCase>(),
              gh<_i64.StacktraceManager>(),
            ));
    gh.factoryAsync<_i212.RestoreIdentityUseCase>(
        () async => _i212.RestoreIdentityUseCase(
              await getAsync<_i203.AddIdentityUseCase>(),
              await getAsync<_i181.GetIdentityUseCase>(),
              await getAsync<_i155.IdentityRepository>(),
              await getAsync<_i189.GetCurrentEnvDidIdentifierUseCase>(),
              await getAsync<_i210.RestoreProfilesUseCase>(),
            ));
    gh.factoryAsync<_i213.Identity>(() async => _i213.Identity(
          await getAsync<_i194.CheckIdentityValidityUseCase>(),
          await getAsync<_i168.GetPrivateKeyUseCase>(),
          await getAsync<_i204.AddNewIdentityUseCase>(),
          await getAsync<_i212.RestoreIdentityUseCase>(),
          await getAsync<_i193.BackupIdentityUseCase>(),
          await getAsync<_i181.GetIdentityUseCase>(),
          await getAsync<_i166.GetIdentitiesUseCase>(),
          await getAsync<_i211.RemoveIdentityUseCase>(),
          await getAsync<_i180.GetDidIdentifierUseCase>(),
          await getAsync<_i158.SignMessageUseCase>(),
          await getAsync<_i174.FetchIdentityStateUseCase>(),
          await getAsync<_i205.AddProfileUseCase>(),
          await getAsync<_i190.GetProfilesUseCase>(),
          await getAsync<_i209.RemoveProfileUseCase>(),
          await getAsync<_i164.GetDidUseCase>(),
          gh<_i64.StacktraceManager>(),
...
class _$PlatformModule extends _i214.PlatformModule {}

class _$NetworkModule extends _i214.NetworkModule {}

class _$DatabaseModule extends _i214.DatabaseModule {}

class _$FilesManagerModule extends _i214.FilesManagerModule {}

class _$EncryptionModule extends _i214.EncryptionModule {}

class _$LoggerModule extends _i214.LoggerModule {}

class _$ChannelModule extends _i214.ChannelModule {}

class _$RepositoriesModule extends _i214.RepositoriesModule {}

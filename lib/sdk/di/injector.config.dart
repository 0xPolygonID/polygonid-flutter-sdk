...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt $initSDKGetIt({
    ...
    gh.factory<_i72.WitnessLinkedMultiQuery10>(
        () => _i72.WitnessLinkedMultiQuery10());
    ...
    gh.factory<_i110.CacheCredentialDataSource>(() =>
        _i110.CacheCredentialDataSource(
            gh<_i95.LibPolygonIdCoreCredentialDataSource>()));
    gh.factoryAsync<_i111.ConfigRepositoryImpl>(() async =>
        _i111.ConfigRepositoryImpl(
            await getAsync<_i94.StorageKeyValueDataSource>()));
    gh.factory<_i112.CredentialRepositoryImpl>(
        () => _i112.CredentialRepositoryImpl(
              gh<_i104.RemoteClaimDataSource>(),
              gh<_i86.StorageClaimDataSource>(),
              gh<_i99.LocalClaimDataSource>(),
              gh<_i110.CacheCredentialDataSource>(),
              gh<_i85.ClaimMapper>(),
              gh<_i22.FiltersMapper>(),
              gh<_i28.IdFilterMapper>(),
            ));
    gh.factory<_i113.DidProfileInfoRepositoryImpl>(
        () => _i113.DidProfileInfoRepositoryImpl(
              gh<_i107.SecureStorageDidProfileInfoDataSource>(),
              gh<_i22.FiltersMapper>(),
              gh<_i14.DidProfileInfoInteractedDidFilterMapper>(),
            ));
    gh.factoryAsync<_i114.GetPackageNameUseCase>(() async =>
        _i114.GetPackageNameUseCase(
            await getAsync<_i102.PackageInfoRepository>()));
    gh.factory<_i115.GistMTProofMapper>(() => _i115.GistMTProofMapper(
          gh<_i100.MTProofMapper>(),
          gh<_i26.HashMapper>(),
        ));
    gh.factory<_i116.Iden3commCredentialRepositoryImpl>(
        () => _i116.Iden3commCredentialRepositoryImpl(
              gh<_i105.RemoteIden3commDataSource>(),
              gh<_i57.ProofRequestFiltersMapper>(),
              gh<_i85.ClaimMapper>(),
            ));
    gh.factory<_i117.Iden3commRepositoryImpl>(
        () => _i117.Iden3commRepositoryImpl(
              ...
              gh<_i115.GistMTProofMapper>(),
              gh<_i60.QMapper>(),
              gh<_i35.JWZMapper>(),
              gh<_i90.Iden3commProofMapper>(),
              gh<_i88.GetIden3MessageUseCase>(),
            ));
    gh.factoryAsync<_i118.InteractionRepositoryImpl>(
        () async => _i118.InteractionRepositoryImpl(
    ...
    gh.factory<_i119.SMTDataSource>(() => _i119.SMTDataSource(
          gh<_i27.HexMapper>(),
          gh<_i36.LibBabyJubJubDataSource>(),
          gh<_i91.StorageSMTDataSource>(),
        ));
    gh.factory<_i120.SMTRepositoryImpl>(() => _i120.SMTRepositoryImpl(
          gh<_i119.SMTDataSource>(),
          gh<_i91.StorageSMTDataSource>(),
          gh<_i36.LibBabyJubJubDataSource>(),
          gh<_i101.NodeMapper>(),
          gh<_i26.HashMapper>(),
    ...
    gh.factoryAsync<_i121.ConfigRepository>(() async => repositoriesModule
        .configRepository(await getAsync<_i111.ConfigRepositoryImpl>()));
    gh.factory<_i122.CredentialRepository>(() => repositoriesModule
        .credentialRepository(gh<_i112.CredentialRepositoryImpl>()));
    gh.factory<_i123.DidProfileInfoRepository>(() => repositoriesModule
        .didProfileInfoRepository(gh<_i113.DidProfileInfoRepositoryImpl>()));
    ...
    gh.factory<_i125.GetClaimRevocationNonceUseCase>(() =>
        _i125.GetClaimRevocationNonceUseCase(gh<_i122.CredentialRepository>()));
    gh.factory<_i126.GetCredentialByIdUseCase>(
        () => _i126.GetCredentialByIdUseCase(gh<_i122.CredentialRepository>()));
    gh.factory<_i127.GetCredentialByPartialIdUseCase>(
        () => _i127.GetCredentialByPartialIdUseCase(
              gh<_i122.CredentialRepository>(),
              gh<_i64.StacktraceManager>(),
            ));
    gh.factory<_i128.GetDidProfileInfoListUseCase>(() =>
        _i128.GetDidProfileInfoListUseCase(
            gh<_i123.DidProfileInfoRepository>()));
    gh.factory<_i129.GetDidProfileInfoUseCase>(() =>
        _i129.GetDidProfileInfoUseCase(gh<_i123.DidProfileInfoRepository>()));
    gh.factoryAsync<_i130.GetEnvUseCase>(() async => _i130.GetEnvUseCase(
          await getAsync<_i121.ConfigRepository>(),
          gh<_i64.StacktraceManager>(),
        ));
    gh.factoryAsync<_i131.GetSelectedChainUseCase>(
        () async => _i131.GetSelectedChainUseCase(
              await getAsync<_i121.ConfigRepository>(),
              await getAsync<_i130.GetEnvUseCase>(),
            ));
    gh.factory<_i132.Iden3commCredentialRepository>(() =>
        repositoriesModule.iden3commCredentialRepository(
            gh<_i116.Iden3commCredentialRepositoryImpl>()));
    gh.factory<_i133.Iden3commRepository>(() => repositoriesModule
        .iden3commRepository(gh<_i117.Iden3commRepositoryImpl>()));
    gh.factoryAsync<_i134.InteractionRepository>(() async =>
        repositoriesModule.interactionRepository(
            await getAsync<_i118.InteractionRepositoryImpl>()));
    ...
    gh.factoryAsync<_i136.RPCDataSource>(() async =>
        _i136.RPCDataSource(await getAsync<_i131.GetSelectedChainUseCase>()));
    ...
    gh.factory<_i140.SMTRepository>(
        () => repositoriesModule.smtRepository(gh<_i120.SMTRepositoryImpl>()));
    gh.factory<_i141.SaveClaimsUseCase>(() => _i141.SaveClaimsUseCase(
          gh<_i122.CredentialRepository>(),
          gh<_i64.StacktraceManager>(),
        ));
    gh.factoryAsync<_i142.SetEnvUseCase>(() async =>
        _i142.SetEnvUseCase(await getAsync<_i121.ConfigRepository>()));
    gh.factoryAsync<_i143.SetSelectedChainUseCase>(() async =>
        _i143.SetSelectedChainUseCase(
            await getAsync<_i121.ConfigRepository>()));
    gh.factory<_i144.UpdateClaimUseCase>(() => _i144.UpdateClaimUseCase(
          gh<_i122.CredentialRepository>(),
          gh<_i64.StacktraceManager>(),
        ));
    gh.factory<_i145.AddDidProfileInfoUseCase>(() =>
        _i145.AddDidProfileInfoUseCase(gh<_i123.DidProfileInfoRepository>()));
    gh.factory<_i146.CacheCredentialUseCase>(
        () => _i146.CacheCredentialUseCase(gh<_i122.CredentialRepository>()));
    gh.factory<_i147.CleanSchemaCacheUseCase>(
        () => _i147.CleanSchemaCacheUseCase(gh<_i133.Iden3commRepository>()));
    gh.factoryAsync<_i148.FetchOnchainClaimUseCase>(
        () async => _i148.FetchOnchainClaimUseCase(
              await getAsync<_i131.GetSelectedChainUseCase>(),
              await getAsync<_i130.GetEnvUseCase>(),
              gh<_i95.LibPolygonIdCoreCredentialDataSource>(),
    ...
    gh.factory<_i149.GetAuthChallengeUseCase>(
        () => _i149.GetAuthChallengeUseCase(
              gh<_i133.Iden3commRepository>(),
              gh<_i64.StacktraceManager>(),
            ));
    gh.factory<_i150.GetJWZUseCase>(() => _i150.GetJWZUseCase(
          gh<_i133.Iden3commRepository>(),
          gh<_i64.StacktraceManager>(),
        ));
    gh.factory<_i151.GetLatestStateUseCase>(() => _i151.GetLatestStateUseCase(
          gh<_i140.SMTRepository>(),
          gh<_i64.StacktraceManager>(),
        ));
    gh.factory<_i152.GetProofQueryContextUseCase>(
        () => _i152.GetProofQueryContextUseCase(
              gh<_i132.Iden3commCredentialRepository>(),
              gh<_i64.StacktraceManager>(),
            ));
    gh.factory<_i153.GetProofRequestsUseCase>(
        () => _i153.GetProofRequestsUseCase(
              gh<_i152.GetProofQueryContextUseCase>(),
              gh<_i89.GetProofQueryUseCase>(),
              gh<_i64.StacktraceManager>(),
            ));
    gh.factory<_i154.GetSchemasUseCase>(() =>
        _i154.GetSchemasUseCase(gh<_i132.Iden3commCredentialRepository>()));
    gh.factoryAsync<_i155.IdentityRepositoryImpl>(
        () async => _i155.IdentityRepositoryImpl(
    ...
    gh.factoryAsync<_i156.ProofRepositoryImpl>(
        () async => _i156.ProofRepositoryImpl(
    ...
    gh.factory<_i157.RemoveIdentityStateUseCase>(
        () => _i157.RemoveIdentityStateUseCase(
              gh<_i140.SMTRepository>(),
              gh<_i64.StacktraceManager>(),
            ));
    gh.factoryAsync<_i158.IdentityRepository>(() async => repositoriesModule
        .identityRepository(await getAsync<_i155.IdentityRepositoryImpl>()));
    gh.factoryAsync<_i159.ProofRepository>(() async => repositoriesModule
        .proofRepository(await getAsync<_i156.ProofRepositoryImpl>()));
    ...
    gh.factoryAsync<_i179.GetFiltersUseCase>(
        () async => _i179.GetFiltersUseCase(
              ...
              gh<_i153.GetProofRequestsUseCase>(),
            ));
    ...
    gh.factoryAsync<_i189.FetchOnchainClaimsUseCase>(
        () async => _i189.FetchOnchainClaimsUseCase(
              await getAsync<_i148.FetchOnchainClaimUseCase>(),
              ...
              gh<_i146.CacheCredentialUseCase>(),
              gh<_i37.LocalContractFilesDataSource>(),
              await getAsync<_i158.IdentityRepository>(),
              gh<_i123.DidProfileInfoRepository>(),
              gh<_i64.StacktraceManager>(),
    ...
    gh.factoryAsync<_i190.GenerateIden3commProofUseCase>(
        () async => _i190.GenerateIden3commProofUseCase(
              ...
              gh<_i151.GetLatestStateUseCase>(),
              gh<_i64.StacktraceManager>(),
            ));
    ...
    gh.factoryAsync<_i192.GetAuthTokenUseCase>(
        () async => _i192.GetAuthTokenUseCase(
              ...
              gh<_i150.GetJWZUseCase>(),
              gh<_i149.GetAuthChallengeUseCase>(),
    ...
    gh.factoryAsync<_i210.AuthenticateUseCase>(
        () async => _i210.AuthenticateUseCase(
              ...
              await getAsync<_i130.GetEnvUseCase>(),
              await getAsync<_i131.GetSelectedChainUseCase>(),
              await getAsync<_i114.GetPackageNameUseCase>(),
              await getAsync<_i188.CheckProfileAndDidCurrentEnvUseCase>(),
              gh<_i56.ProofGenerationStepsStreamManager>(),
              gh<_i64.StacktraceManager>(),
            ));
    ...
    gh.factoryAsync<_i212.Iden3comm>(() async => _i212.Iden3comm(
          ...
          gh<_i147.CleanSchemaCacheUseCase>(),
          gh<_i64.StacktraceManager>(),
          gh<_i145.AddDidProfileInfoUseCase>(),
          gh<_i129.GetDidProfileInfoUseCase>(),
          gh<_i128.GetDidProfileInfoListUseCase>(),
    ...
    gh.factoryAsync<_i213.RemoveProfileUseCase>(
        () async => _i213.RemoveProfileUseCase(
              ...
              await getAsync<_i188.CheckProfileAndDidCurrentEnvUseCase>(),
              await getAsync<_i200.CreateProfilesUseCase>(),
              gh<_i157.RemoveIdentityStateUseCase>(),

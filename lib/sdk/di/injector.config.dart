...
import '../../iden3comm/domain/use_cases/authenticate_use_case.dart' as _i143;
import '../../iden3comm/domain/use_cases/get_auth_inputs_use_case.dart'
    as _i138;
import '../../iden3comm/domain/use_cases/get_auth_token_use_case.dart' as _i139;
...
import '../../iden3comm/domain/use_cases/get_proof_requests_use_case.dart'
    as _i23;
import '../../iden3comm/domain/use_cases/get_proofs_use_case.dart' as _i140;
...
import '../../identity/domain/use_cases/backup_identity_use_case.dart' as _i133;
...
import '../../identity/domain/use_cases/create_new_identity_use_case.dart'
    as _i136;
import '../../identity/domain/use_cases/export_identity_use_case.dart' as _i121;
...
import '../../identity/domain/use_cases/get_identity_auth_claim_use_case.dart'
    as _i127;
import '../../identity/domain/use_cases/get_identity_use_case.dart' as _i132;
import '../../identity/domain/use_cases/get_latest_state_use_case.dart'
    as _i114;
import '../../identity/domain/use_cases/import_identity_use_case.dart' as _i116;
import '../../identity/domain/use_cases/remove_identity_use_case.dart' as _i119;
...
import '../../proof/domain/use_cases/generate_proof_use_case.dart' as _i137;
import '../../proof/domain/use_cases/get_gist_proof_use_case.dart' as _i125;
import '../../proof/domain/use_cases/get_jwz_use_case.dart' as _i113;
import '../../proof/domain/use_cases/is_proof_circuit_supported_use_case.dart'
    as _i117;
import '../../proof/domain/use_cases/load_circuit_use_case.dart' as _i118;
...
import '../../proof/libs/witnesscalc/sig_v2_onchain/witness_sig_onchain.dart'
    as _i70;
import '../credential.dart' as _i147;
import '../iden3comm.dart' as _i145;
import '../identity.dart' as _i146;
import '../mappers/iden3_message_type_mapper.dart' as _i27;
import '../proof.dart' as _i141;
import 'injector.dart' as _i148; // ignore_for_file: unnecessary_lambdas
...
_i1.GetIt $initSDKGetIt(
  ...
  gh.factory<_i113.GetJWZUseCase>(
      () => _i113.GetJWZUseCase(get<_i105.ProofRepository>()));
  gh.factory<_i114.GetLatestStateUseCase>(
      () => _i114.GetLatestStateUseCase(get<_i109.SMTRepository>()));
  ...
  gh.factoryAsync<_i116.ImportIdentityUseCase>(() async =>
      _i116.ImportIdentityUseCase(
          await get.getAsync<_i115.IdentityRepository>()));
  gh.factory<_i117.IsProofCircuitSupportedUseCase>(
      () => _i117.IsProofCircuitSupportedUseCase(get<_i105.ProofRepository>()));
  gh.factory<_i118.LoadCircuitUseCase>(
      () => _i118.LoadCircuitUseCase(get<_i105.ProofRepository>()));
  gh.factoryAsync<_i119.RemoveIdentityUseCase>(
      () async => _i119.RemoveIdentityUseCase(
            await get.getAsync<_i115.IdentityRepository>(),
            get<_i109.SMTRepository>(),
            get<_i107.RemoveAllClaimsUseCase>(),
          ));
  gh.factoryAsync<_i120.SignMessageUseCase>(() async =>
      _i120.SignMessageUseCase(await get.getAsync<_i115.IdentityRepository>()));
  gh.factoryAsync<_i121.ExportIdentityUseCase>(() async =>
      _i121.ExportIdentityUseCase(
          await get.getAsync<_i115.IdentityRepository>()));
  gh.factoryAsync<_i122.FetchStateRootsUseCase>(() async =>
      _i122.FetchStateRootsUseCase(
          await get.getAsync<_i115.IdentityRepository>()));
  gh.factoryAsync<_i123.GetAuthChallengeUseCase>(() async =>
      _i123.GetAuthChallengeUseCase(
          await get.getAsync<_i115.IdentityRepository>()));
  ...
  gh.factoryAsync<_i128.FetchIdentityStateUseCase>(
      () async => _i128.FetchIdentityStateUseCase(
            await get.getAsync<_i115.IdentityRepository>(),
            get<_i101.GetEnvConfigUseCase>(),
            await get.getAsync<_i124.GetDidUseCase>(),
          ));
  gh.factoryAsync<_i129.GenerateNonRevProofUseCase>(
      () async => _i129.GenerateNonRevProofUseCase(
            await get.getAsync<_i115.IdentityRepository>(),
            get<_i98.CredentialRepository>(),
            get<_i101.GetEnvConfigUseCase>(),
            await get.getAsync<_i128.FetchIdentityStateUseCase>(),
          ));
  gh.factoryAsync<_i130.GetClaimRevocationStatusUseCase>(
      () async => _i130.GetClaimRevocationStatusUseCase(
            get<_i98.CredentialRepository>(),
            await get.getAsync<_i115.IdentityRepository>(),
            await get.getAsync<_i129.GenerateNonRevProofUseCase>(),
          ));
  gh.factoryAsync<_i131.GetDidIdentifierUseCase>(
      () async => _i131.GetDidIdentifierUseCase(
            await get.getAsync<_i115.IdentityRepository>(),
            await get.getAsync<_i127.GetIdentityAuthClaimUseCase>(),
          ));
  gh.factoryAsync<_i132.GetIdentityUseCase>(
      () async => _i132.GetIdentityUseCase(
            await get.getAsync<_i115.IdentityRepository>(),
            await get.getAsync<_i124.GetDidUseCase>(),
            await get.getAsync<_i131.GetDidIdentifierUseCase>(),
          ));
  gh.factoryAsync<_i133.BackupIdentityUseCase>(
      () async => _i133.BackupIdentityUseCase(
            await get.getAsync<_i132.GetIdentityUseCase>(),
            await get.getAsync<_i121.ExportIdentityUseCase>(),
            await get.getAsync<_i131.GetDidIdentifierUseCase>(),
          ));
  gh.factoryAsync<_i134.CheckIdentityValidityUseCase>(
      () async => _i134.CheckIdentityValidityUseCase(
            get<String>(instanceName: 'accessMessage'),
            await get.getAsync<_i115.IdentityRepository>(),
            await get.getAsync<_i131.GetDidIdentifierUseCase>(),
          ));
  gh.factoryAsync<_i135.CreateAndSaveIdentityUseCase>(
      () async => _i135.CreateAndSaveIdentityUseCase(
            await get.getAsync<_i115.IdentityRepository>(),
            await get.getAsync<_i124.GetDidUseCase>(),
            await get.getAsync<_i131.GetDidIdentifierUseCase>(),
            await get.getAsync<_i127.GetIdentityAuthClaimUseCase>(),
          ));
  gh.factoryAsync<_i136.CreateNewIdentityUseCase>(
      () async => _i136.CreateNewIdentityUseCase(
            get<String>(instanceName: 'accessMessage'),
            await get.getAsync<_i115.IdentityRepository>(),
            await get.getAsync<_i135.CreateAndSaveIdentityUseCase>(),
          ));
  gh.factoryAsync<_i137.GenerateProofUseCase>(
      () async => _i137.GenerateProofUseCase(
            await get.getAsync<_i115.IdentityRepository>(),
            get<_i109.SMTRepository>(),
            get<_i105.ProofRepository>(),
            ...
            get<_i114.GetLatestStateUseCase>(),
          ));
  gh.factoryAsync<_i138.GetAuthInputsUseCase>(
      () async => _i138.GetAuthInputsUseCase(
            await get.getAsync<_i132.GetIdentityUseCase>(),
            get<_i99.GetAuthClaimUseCase>(),
            await get.getAsync<_i120.SignMessageUseCase>(),
            await get.getAsync<_i125.GetGistProofUseCase>(),
  ...
  gh.factoryAsync<_i139.GetAuthTokenUseCase>(
      () async => _i139.GetAuthTokenUseCase(
            get<_i118.LoadCircuitUseCase>(),
            get<_i113.GetJWZUseCase>(),
            await get.getAsync<_i123.GetAuthChallengeUseCase>(),
            await get.getAsync<_i138.GetAuthInputsUseCase>(),
            get<_i106.ProveUseCase>(),
          ));
  gh.factoryAsync<_i140.GetProofsUseCase>(() async => _i140.GetProofsUseCase(
        get<_i105.ProofRepository>(),
        await get.getAsync<_i115.IdentityRepository>(),
        get<_i100.GetClaimsUseCase>(),
        await get.getAsync<_i137.GenerateProofUseCase>(),
        get<_i117.IsProofCircuitSupportedUseCase>(),
        get<_i23.GetProofRequestsUseCase>(),
      ));
  gh.factoryAsync<_i141.Proof>(() async => _i141.Proof(
        await get.getAsync<_i137.GenerateProofUseCase>(),
        get<_i112.DownloadCircuitsUseCase>(),
        get<_i111.CircuitsFilesExistUseCase>(),
      ));
  gh.factoryAsync<_i142.RestoreIdentityUseCase>(
      () async => _i142.RestoreIdentityUseCase(
            await get.getAsync<_i135.CreateAndSaveIdentityUseCase>(),
            await get.getAsync<_i132.GetIdentityUseCase>(),
            await get.getAsync<_i116.ImportIdentityUseCase>(),
            await get.getAsync<_i131.GetDidIdentifierUseCase>(),
          ));
  gh.factoryAsync<_i143.AuthenticateUseCase>(
      () async => _i143.AuthenticateUseCase(
            get<_i103.Iden3commRepository>(),
            await get.getAsync<_i140.GetProofsUseCase>(),
            await get.getAsync<_i139.GetAuthTokenUseCase>(),
            get<_i101.GetEnvConfigUseCase>(),
            await get.getAsync<_i92.GetPackageNameUseCase>(),
            await get.getAsync<_i131.GetDidIdentifierUseCase>(),
          ));
  gh.factoryAsync<_i144.FetchAndSaveClaimsUseCase>(
      () async => _i144.FetchAndSaveClaimsUseCase(
            get<_i19.GetFetchRequestsUseCase>(),
            await get.getAsync<_i139.GetAuthTokenUseCase>(),
            get<_i98.CredentialRepository>(),
          ));
  gh.factoryAsync<_i145.Iden3comm>(() async => _i145.Iden3comm(
        get<_i102.GetVocabsUseCase>(),
        await get.getAsync<_i143.AuthenticateUseCase>(),
        await get.getAsync<_i140.GetProofsUseCase>(),
        get<_i21.GetIden3MessageUseCase>(),
      ));
  gh.factoryAsync<_i146.Identity>(() async => _i146.Identity(
        await get.getAsync<_i134.CheckIdentityValidityUseCase>(),
        await get.getAsync<_i135.CreateAndSaveIdentityUseCase>(),
        await get.getAsync<_i136.CreateNewIdentityUseCase>(),
        await get.getAsync<_i142.RestoreIdentityUseCase>(),
        await get.getAsync<_i133.BackupIdentityUseCase>(),
        await get.getAsync<_i132.GetIdentityUseCase>(),
        await get.getAsync<_i126.GetIdentitiesUseCase>(),
        await get.getAsync<_i119.RemoveIdentityUseCase>(),
        await get.getAsync<_i131.GetDidIdentifierUseCase>(),
        await get.getAsync<_i120.SignMessageUseCase>(),
        await get.getAsync<_i128.FetchIdentityStateUseCase>(),
      ));
  gh.factoryAsync<_i147.Credential>(() async => _i147.Credential(
        await get.getAsync<_i144.FetchAndSaveClaimsUseCase>(),
        get<_i100.GetClaimsUseCase>(),
...
class _$PlatformModule extends _i148.PlatformModule {}

class _$NetworkModule extends _i148.NetworkModule {}

class _$DatabaseModule extends _i148.DatabaseModule {}

class _$EncryptionModule extends _i148.EncryptionModule {}

class _$Sdk extends _i148.Sdk {}

class _$ZipDecoderModule extends _i148.ZipDecoderModule {}

class _$RepositoriesModule extends _i148.RepositoriesModule {}

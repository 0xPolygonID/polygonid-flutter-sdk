...
import 'package:polygonid_flutter_sdk/proof/libs/witnesscalc/v3_onchain/witness_v3_onchain.dart'
    as _i70;
import 'package:polygonid_flutter_sdk/sdk/credential.dart' as _i212;
import 'package:polygonid_flutter_sdk/sdk/di/injector.dart' as _i219;
import 'package:polygonid_flutter_sdk/sdk/error_handling.dart' as _i78;
import 'package:polygonid_flutter_sdk/sdk/iden3comm.dart' as _i213;
import 'package:polygonid_flutter_sdk/sdk/identity.dart' as _i218;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt $initSDKGetIt({
    ...
    gh.factory<_i78.ErrorHandling>(
        () => _i78.ErrorHandling(gh<_i56.StacktraceManager>()));
    gh.factory<_i79.GetIden3MessageUseCase>(() => _i79.GetIden3MessageUseCase(
          gh<_i24.GetIden3MessageTypeUseCase>(),
          gh<_i56.StacktraceManager>(),
        ));
    gh.factory<_i80.GetProofQueryUseCase>(
        () => _i80.GetProofQueryUseCase(gh<_i56.StacktraceManager>()));
    gh.factory<_i81.Iden3MessageDataSource>(
        () => _i81.Iden3MessageDataSource(gh<_i56.StacktraceManager>()));
    gh.factory<_i82.Iden3commProofMapper>(
        () => _i82.Iden3commProofMapper(gh<_i30.Iden3commVPProofMapper>()));
    ...
    gh.factory<_i86.JWZMapper>(
        () => _i86.JWZMapper(gh<_i56.StacktraceManager>()));
    ...
    gh.factory<_i91.PolygonIdCoreCredential>(
        () => _i91.PolygonIdCoreCredential(gh<_i56.StacktraceManager>()));
    gh.factory<_i92.PolygonIdCoreIden3comm>(
        () => _i92.PolygonIdCoreIden3comm(gh<_i56.StacktraceManager>()));
    gh.factory<_i93.PolygonIdCoreIdentity>(
        () => _i93.PolygonIdCoreIdentity(gh<_i56.StacktraceManager>()));
    gh.factory<_i94.PolygonIdCoreProof>(
        () => _i94.PolygonIdCoreProof(gh<_i56.StacktraceManager>()));
    ...
    gh.factory<_i96.ProofRequestFiltersMapper>(
        () => _i96.ProofRequestFiltersMapper(gh<_i56.StacktraceManager>()));
    ...
    gh.factory<_i99.RemoteIdentityDataSource>(
        () => _i99.RemoteIdentityDataSource(gh<_i56.StacktraceManager>()));
    gh.factory<_i100.RhsNodeMapper>(
        () => _i100.RhsNodeMapper(gh<_i55.RhsNodeTypeMapper>()));
    ...
    gh.factory<_i137.GetAuthClaimUseCase>(() => _i137.GetAuthClaimUseCase(
          gh<_i135.CredentialRepository>(),
          gh<_i56.StacktraceManager>(),
        ));
    gh.factory<_i138.GetClaimRevocationNonceUseCase>(() =>
        _i138.GetClaimRevocationNonceUseCase(gh<_i135.CredentialRepository>()));
    gh.factory<_i139.GetCredentialByIdUseCase>(
        () => _i139.GetCredentialByIdUseCase(gh<_i135.CredentialRepository>()));
    gh.factory<_i140.GetCredentialByPartialIdUseCase>(
        () => _i140.GetCredentialByPartialIdUseCase(
              gh<_i135.CredentialRepository>(),
              gh<_i56.StacktraceManager>(),
            ));
    ...
    gh.factory<_i145.Iden3commRepository>(() => repositoriesModule
    ...
    gh.factory<_i148.RemoveAllClaimsUseCase>(() => _i148.RemoveAllClaimsUseCase(
          gh<_i135.CredentialRepository>(),
          gh<_i56.StacktraceManager>(),
        ));
    gh.factory<_i149.RemoveClaimsUseCase>(() => _i149.RemoveClaimsUseCase(
          gh<_i135.CredentialRepository>(),
          gh<_i56.StacktraceManager>(),
        ));
    ...
    gh.factory<_i151.SaveClaimsUseCase>(() => _i151.SaveClaimsUseCase(
          gh<_i135.CredentialRepository>(),
          gh<_i56.StacktraceManager>(),
        ));
    gh.factory<_i152.UpdateClaimUseCase>(() => _i152.UpdateClaimUseCase(
          gh<_i135.CredentialRepository>(),
          gh<_i56.StacktraceManager>(),
        ));
    gh.factory<_i153.CacheCredentialUseCase>(
        () => _i153.CacheCredentialUseCase(gh<_i135.CredentialRepository>()));
    gh.factoryAsync<_i154.CacheCredentialsUseCase>(
        () async => _i154.CacheCredentialsUseCase(
              gh<_i153.CacheCredentialUseCase>(),
              gh<_i56.StacktraceManager>(),
              await getAsync<_i123.GetEnvUseCase>(),
            ));
    gh.factory<_i155.CleanSchemaCacheUseCase>(
        () => _i155.CleanSchemaCacheUseCase(gh<_i145.Iden3commRepository>()));
    gh.factory<_i156.GetAuthChallengeUseCase>(
        () => _i156.GetAuthChallengeUseCase(
              gh<_i145.Iden3commRepository>(),
              gh<_i56.StacktraceManager>(),
            ));
    ...
    gh.factoryAsync<_i202.FetchCredentialsUseCase>(
        () async => _i202.FetchCredentialsUseCase(
              await getAsync<_i124.GetSelectedChainUseCase>(),
              await getAsync<_i183.GetDidIdentifierUseCase>(),
              await getAsync<_i192.GetAuthTokenUseCase>(),
              gh<_i23.GetFetchRequestsUseCase>(),
    ...
    gh.factoryAsync<_i203.GetClaimsUseCase>(() async => _i203.GetClaimsUseCase(
          gh<_i135.CredentialRepository>(),
          await getAsync<_i193.GetCurrentEnvDidIdentifierUseCase>(),
          gh<_i56.StacktraceManager>(),
        ));
    gh.factoryAsync<_i204.GetIden3commClaimsRevNonceUseCase>(
        () async => _i204.GetIden3commClaimsRevNonceUseCase(
              gh<_i125.Iden3commCredentialRepository>(),
              await getAsync<_i203.GetClaimsUseCase>(),
              gh<_i138.GetClaimRevocationNonceUseCase>(),
              await getAsync<_i173.IsProofCircuitSupportedUseCase>(),
              gh<_i143.GetProofRequestsUseCase>(),
            ));
    gh.factoryAsync<_i205.GetIden3commClaimsUseCase>(
        () async => _i205.GetIden3commClaimsUseCase(
              gh<_i125.Iden3commCredentialRepository>(),
              await getAsync<_i203.GetClaimsUseCase>(),
              await getAsync<_i182.GetClaimRevocationStatusUseCase>(),
              gh<_i138.GetClaimRevocationNonceUseCase>(),
              gh<_i152.UpdateClaimUseCase>(),
              await getAsync<_i173.IsProofCircuitSupportedUseCase>(),
              gh<_i143.GetProofRequestsUseCase>(),
              gh<_i8.CircuitTypeMapper>(),
              gh<_i56.StacktraceManager>(),
            ));
    gh.factoryAsync<_i206.GetIden3commProofsUseCase>(
        () async => _i206.GetIden3commProofsUseCase(
              await getAsync<_i159.ProofRepository>(),
              await getAsync<_i205.GetIden3commClaimsUseCase>(),
    ...
    gh.factoryAsync<_i207.UpdateIdentityUseCase>(
        () async => _i207.UpdateIdentityUseCase(
              await getAsync<_i158.IdentityRepository>(),
              await getAsync<_i199.CreateIdentityUseCase>(),
              await getAsync<_i184.GetIdentityUseCase>(),
            ));
    gh.factoryAsync<_i208.AddIdentityUseCase>(
        () async => _i208.AddIdentityUseCase(
              await getAsync<_i158.IdentityRepository>(),
              await getAsync<_i199.CreateIdentityUseCase>(),
              await getAsync<_i176.CreateIdentityStateUseCase>(),
              gh<_i56.StacktraceManager>(),
            ));
    gh.factoryAsync<_i209.AddNewIdentityUseCase>(
        () async => _i209.AddNewIdentityUseCase(
              await getAsync<_i158.IdentityRepository>(),
              await getAsync<_i208.AddIdentityUseCase>(),
              gh<_i56.StacktraceManager>(),
            ));
    gh.factoryAsync<_i210.AddProfileUseCase>(
        () async => _i210.AddProfileUseCase(
              await getAsync<_i184.GetIdentityUseCase>(),
              await getAsync<_i207.UpdateIdentityUseCase>(),
              await getAsync<_i188.CheckProfileAndDidCurrentEnvUseCase>(),
              await getAsync<_i200.CreateProfilesUseCase>(),
              gh<_i112.LibPolygonIdCoreIdentityDataSource>(),
              gh<_i56.StacktraceManager>(),
            ));
    gh.factoryAsync<_i211.AuthenticateUseCase>(
        () async => _i211.AuthenticateUseCase(
              gh<_i145.Iden3commRepository>(),
              await getAsync<_i206.GetIden3commProofsUseCase>(),
              await getAsync<_i183.GetDidIdentifierUseCase>(),
              await getAsync<_i192.GetAuthTokenUseCase>(),
              await getAsync<_i123.GetEnvUseCase>(),
              await getAsync<_i124.GetSelectedChainUseCase>(),
    ...
    gh.factoryAsync<_i212.Credential>(() async => _i212.Credential(
          gh<_i151.SaveClaimsUseCase>(),
          await getAsync<_i203.GetClaimsUseCase>(),
          gh<_i149.RemoveClaimsUseCase>(),
          await getAsync<_i182.GetClaimRevocationStatusUseCase>(),
          ...
          gh<_i56.StacktraceManager>(),
          await getAsync<_i195.RefreshCredentialUseCase>(),
          gh<_i139.GetCredentialByIdUseCase>(),
          gh<_i140.GetCredentialByPartialIdUseCase>(),
          await getAsync<_i154.CacheCredentialsUseCase>(),
          gh<_i153.CacheCredentialUseCase>(),
        ));
    gh.factoryAsync<_i213.Iden3comm>(() async => _i213.Iden3comm(
          await getAsync<_i201.FetchAndSaveClaimsUseCase>(),
          await getAsync<_i189.FetchOnchainClaimsUseCase>(),
          gh<_i79.GetIden3MessageUseCase>(),
          gh<_i144.GetSchemasUseCase>(),
          await getAsync<_i211.AuthenticateUseCase>(),
          await getAsync<_i179.GetFiltersUseCase>(),
          await getAsync<_i205.GetIden3commClaimsUseCase>(),
          await getAsync<_i204.GetIden3commClaimsRevNonceUseCase>(),
          await getAsync<_i206.GetIden3commProofsUseCase>(),
          ...
          await getAsync<_i192.GetAuthTokenUseCase>(),
          await getAsync<_i202.FetchCredentialsUseCase>(),
        ));
    gh.factoryAsync<_i214.RemoveProfileUseCase>(
        () async => _i214.RemoveProfileUseCase(
              await getAsync<_i184.GetIdentityUseCase>(),
              await getAsync<_i207.UpdateIdentityUseCase>(),
              await getAsync<_i188.CheckProfileAndDidCurrentEnvUseCase>(),
              await getAsync<_i200.CreateProfilesUseCase>(),
              gh<_i150.RemoveIdentityStateUseCase>(),
              gh<_i148.RemoveAllClaimsUseCase>(),
              gh<_i56.StacktraceManager>(),
            ));
    gh.factoryAsync<_i215.RestoreProfilesUseCase>(
        () async => _i215.RestoreProfilesUseCase(
              await getAsync<_i158.IdentityRepository>(),
              await getAsync<_i207.UpdateIdentityUseCase>(),
            ));
    gh.factoryAsync<_i216.RemoveIdentityUseCase>(
        () async => _i216.RemoveIdentityUseCase(
              await getAsync<_i158.IdentityRepository>(),
              await getAsync<_i194.GetProfilesUseCase>(),
              await getAsync<_i214.RemoveProfileUseCase>(),
              gh<_i150.RemoveIdentityStateUseCase>(),
              gh<_i148.RemoveAllClaimsUseCase>(),
              await getAsync<_i188.CheckProfileAndDidCurrentEnvUseCase>(),
              gh<_i56.StacktraceManager>(),
            ));
    gh.factoryAsync<_i217.RestoreIdentityUseCase>(
        () async => _i217.RestoreIdentityUseCase(
              await getAsync<_i208.AddIdentityUseCase>(),
              await getAsync<_i184.GetIdentityUseCase>(),
              await getAsync<_i158.IdentityRepository>(),
              await getAsync<_i193.GetCurrentEnvDidIdentifierUseCase>(),
              await getAsync<_i215.RestoreProfilesUseCase>(),
            ));
    gh.factoryAsync<_i218.Identity>(() async => _i218.Identity(
          await getAsync<_i198.CheckIdentityValidityUseCase>(),
          await getAsync<_i171.GetPrivateKeyUseCase>(),
          await getAsync<_i209.AddNewIdentityUseCase>(),
          await getAsync<_i217.RestoreIdentityUseCase>(),
          await getAsync<_i197.BackupIdentityUseCase>(),
          await getAsync<_i184.GetIdentityUseCase>(),
          await getAsync<_i169.GetIdentitiesUseCase>(),
          await getAsync<_i216.RemoveIdentityUseCase>(),
          await getAsync<_i183.GetDidIdentifierUseCase>(),
          await getAsync<_i161.SignMessageUseCase>(),
          await getAsync<_i177.FetchIdentityStateUseCase>(),
          await getAsync<_i210.AddProfileUseCase>(),
          await getAsync<_i194.GetProfilesUseCase>(),
          await getAsync<_i214.RemoveProfileUseCase>(),
          await getAsync<_i167.GetDidUseCase>(),
          gh<_i56.StacktraceManager>(),
...
class _$PlatformModule extends _i219.PlatformModule {}

class _$NetworkModule extends _i219.NetworkModule {}

class _$DatabaseModule extends _i219.DatabaseModule {}

class _$FilesManagerModule extends _i219.FilesManagerModule {}

class _$EncryptionModule extends _i219.EncryptionModule {}

class _$LoggerModule extends _i219.LoggerModule {}

class _$ChannelModule extends _i219.ChannelModule {}

class _$RepositoriesModule extends _i219.RepositoriesModule {}

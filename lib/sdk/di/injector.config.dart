...
import '../../data/identity/bjj/bjj.dart' as _i3;
...
import '../../data/identity/iden3core/iden3core.dart' as _i6;
...
_i1.GetIt $initSDKGetIt(_i1.GetIt get,
  ...
  gh.factory<_i8.JWZDataSource>(() => _i8.JWZDataSource(
      get<_i3.BabyjubjubLib>(),
      get<_i11.WalletDataSource>(),
      get<_i8.JWZIsolatesWrapper>()));

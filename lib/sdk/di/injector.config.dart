...
import 'package:polygonid_flutter_sdk/proof/libs/witnesscalc/sig_v2_onchain/witness_sig_onchain.dart'
    as _i77;
import 'package:polygonid_flutter_sdk/sdk/credential.dart' as _i187;
import 'package:polygonid_flutter_sdk/sdk/di/injector.dart' as _i193;
import 'package:polygonid_flutter_sdk/sdk/iden3comm.dart' as _i188;
import 'package:polygonid_flutter_sdk/sdk/identity.dart' as _i192;
...
import 'package:polygonid_flutter_sdk/sdk/polygonid_flutter_channel.dart'
    as _i100;
import 'package:polygonid_flutter_sdk/sdk/proof.dart' as _i153;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt $initSDKGetIt({
    ...
    gh.factory<_i53.PoseidonHashMapper>(
        () => _i53.PoseidonHashMapper(gh<_i28.HexMapper>()));
    ...
    gh.factory<_i61.RemoteClaimDataSource>(
        () => _i61.RemoteClaimDataSource(gh<_i11.Client>()));
    gh.factory<_i62.RemoteIden3commDataSource>(
        () => _i62.RemoteIden3commDataSource(gh<_i11.Client>()));
    gh.factory<_i63.RemoteIdentityDataSource>(
        () => _i63.RemoteIdentityDataSource());
    gh.factory<_i64.RevocationStatusMapper>(
        () => _i64.RevocationStatusMapper());
    ...
    gh.lazySingleton<_i82.CircuitsDownloadDataSource>(
        () => _i82.CircuitsDownloadDataSource(gh<_i14.Dio>()));
    gh.factoryAsync<_i83.CircuitsFilesDataSource>(() async =>
        _i83.CircuitsFilesDataSource(await getAsync<_i15.Directory>()));
    ...
    gh.factory<_i86.Iden3commCredentialRepositoryImpl>(
        () => _i86.Iden3commCredentialRepositoryImpl(
              gh<_i62.RemoteIden3commDataSource>(),
              gh<_i57.ProofRequestFiltersMapper>(),
              gh<_i84.ClaimMapper>(),
            ));
    gh.factory<_i87.Iden3commProofMapper>(
        () => _i87.Iden3commProofMapper(gh<_i78.ZKProofBaseMapper>()));
    ...
    gh.factory<_i101.RhsNodeMapper>(
        () => _i101.RhsNodeMapper(gh<_i65.RhsNodeTypeMapper>()));
    ...
    gh.factory<_i107.Iden3commCredentialRepository>(() =>
        repositoriesModule.iden3commCredentialRepository(
            gh<_i86.Iden3commCredentialRepositoryImpl>()));
    gh.factory<_i108.Iden3commRepositoryImpl>(
        () => _i108.Iden3commRepositoryImpl(
    ...
    gh.factoryAsync<_i112.ConfigRepository>(() async => repositoriesModule
        .configRepository(await getAsync<_i103.ConfigRepositoryImpl>()));
    gh.factory<_i113.CredentialRepository>(() => repositoriesModule
        .credentialRepository(gh<_i104.CredentialRepositoryImpl>()));
    gh.factory<_i114.GetAuthClaimUseCase>(
        () => _i114.GetAuthClaimUseCase(gh<_i113.CredentialRepository>()));
    gh.factory<_i115.GetClaimRevocationNonceUseCase>(() =>
        _i115.GetClaimRevocationNonceUseCase(gh<_i113.CredentialRepository>()));
    gh.factoryAsync<_i116.GetEnvUseCase>(() async =>
        _i116.GetEnvUseCase(await getAsync<_i112.ConfigRepository>()));
    gh.factory<_i117.GetProofQueryContextUseCase>(() =>
        _i117.GetProofQueryContextUseCase(
            gh<_i107.Iden3commCredentialRepository>()));
    gh.factory<_i118.GetProofRequestsUseCase>(
        () => _i118.GetProofRequestsUseCase(
              gh<_i117.GetProofQueryContextUseCase>(),
              gh<_i25.GetProofQueryUseCase>(),
            ));
    gh.factory<_i119.GetSchemasUseCase>(() =>
        _i119.GetSchemasUseCase(gh<_i107.Iden3commCredentialRepository>()));
    gh.factory<_i120.Iden3commRepository>(() => repositoriesModule
        .iden3commRepository(gh<_i108.Iden3commRepositoryImpl>()));
    ...
    gh.factoryAsync<_i122.ListenAndStoreNotificationUseCase>(() async =>
        _i122.ListenAndStoreNotificationUseCase(
            await getAsync<_i121.InteractionRepository>()));
    gh.factoryAsync<_i123.RPCDataSource>(
        () async => _i123.RPCDataSource(await getAsync<_i116.GetEnvUseCase>()));
    gh.factory<_i124.RemoveAllClaimsUseCase>(
        () => _i124.RemoveAllClaimsUseCase(gh<_i113.CredentialRepository>()));
    gh.factory<_i125.RemoveClaimsUseCase>(
        () => _i125.RemoveClaimsUseCase(gh<_i113.CredentialRepository>()));
    ...
    gh.factory<_i127.SaveClaimsUseCase>(
        () => _i127.SaveClaimsUseCase(gh<_i113.CredentialRepository>()));
    gh.factoryAsync<_i128.SetEnvUseCase>(() async =>
        _i128.SetEnvUseCase(await getAsync<_i112.ConfigRepository>()));
    gh.factory<_i129.UpdateClaimUseCase>(
        () => _i129.UpdateClaimUseCase(gh<_i113.CredentialRepository>()));
    gh.factory<_i130.GetAuthChallengeUseCase>(
        () => _i130.GetAuthChallengeUseCase(gh<_i120.Iden3commRepository>()));
    gh.factory<_i131.GetJWZUseCase>(
        () => _i131.GetJWZUseCase(gh<_i120.Iden3commRepository>()));
    gh.factory<_i132.GetLatestStateUseCase>(
        () => _i132.GetLatestStateUseCase(gh<_i126.SMTRepository>()));
    gh.factoryAsync<_i133.IdentityRepositoryImpl>(
        () async => _i133.IdentityRepositoryImpl(
              gh<_i69.WalletDataSource>(),
              gh<_i63.RemoteIdentityDataSource>(),
              await getAsync<_i89.StorageIdentityDataSource>(),
              await getAsync<_i123.RPCDataSource>(),
    ...
    gh.factoryAsync<_i138.ProveUseCase>(() async =>
        _i138.ProveUseCase(await getAsync<_i137.ProofRepository>()));
    gh.factoryAsync<_i139.SignMessageUseCase>(() async =>
        _i139.SignMessageUseCase(await getAsync<_i136.IdentityRepository>()));
    gh.factoryAsync<_i140.CancelDownloadCircuitsUseCase>(() async =>
        _i140.CancelDownloadCircuitsUseCase(
            await getAsync<_i137.ProofRepository>()));
    ...
    gh.factoryAsync<_i152.LoadCircuitUseCase>(() async =>
        _i152.LoadCircuitUseCase(await getAsync<_i137.ProofRepository>()));
    gh.factoryAsync<_i153.Proof>(() async => _i153.Proof(
          await getAsync<_i144.GenerateZKProofUseCase>(),
          await getAsync<_i142.DownloadCircuitsUseCase>(),
          await getAsync<_i141.CircuitsFilesExistUseCase>(),
          gh<_i56.ProofGenerationStepsStreamManager>(),
          await getAsync<_i140.CancelDownloadCircuitsUseCase>(),
        ));
    gh.factoryAsync<_i154.CreateIdentityStateUseCase>(
        () async => _i154.CreateIdentityStateUseCase(
              await getAsync<_i136.IdentityRepository>(),
              gh<_i126.SMTRepository>(),
              await getAsync<_i148.GetIdentityAuthClaimUseCase>(),
            ));
    ...
    gh.factoryAsync<_i156.GenerateNonRevProofUseCase>(
        () async => _i156.GenerateNonRevProofUseCase(
              await getAsync<_i136.IdentityRepository>(),
              gh<_i113.CredentialRepository>(),
              await getAsync<_i155.FetchIdentityStateUseCase>(),
            ));
    gh.factoryAsync<_i157.GetFiltersUseCase>(
        () async => _i157.GetFiltersUseCase(
              gh<_i107.Iden3commCredentialRepository>(),
              await getAsync<_i151.IsProofCircuitSupportedUseCase>(),
              gh<_i118.GetProofRequestsUseCase>(),
            ));
    ...
    gh.factoryAsync<_i167.GenerateIden3commProofUseCase>(
        () async => _i167.GenerateIden3commProofUseCase(
              ...
              await getAsync<_i162.GetIdentityUseCase>(),
              gh<_i114.GetAuthClaimUseCase>(),
              await getAsync<_i146.GetGistMTProofUseCase>(),
              await getAsync<_i145.GetDidUseCase>(),
              await getAsync<_i139.SignMessageUseCase>(),
    ...
    gh.factoryAsync<_i171.GetProfilesUseCase>(
        () async => _i171.GetProfilesUseCase(
              await getAsync<_i162.GetIdentityUseCase>(),
              await getAsync<_i166.CheckProfileAndDidCurrentEnvUseCase>(),
            ));
    ...
    gh.factoryAsync<_i177.FetchAndSaveClaimsUseCase>(
        () async => _i177.FetchAndSaveClaimsUseCase(
              ...
              await getAsync<_i169.GetAuthTokenUseCase>(),
              gh<_i127.SaveClaimsUseCase>(),
              await getAsync<_i160.GetClaimRevocationStatusUseCase>(),
            ));
    ...
    gh.factoryAsync<_i179.GetIden3commClaimsRevNonceUseCase>(
        () async => _i179.GetIden3commClaimsRevNonceUseCase(
              gh<_i107.Iden3commCredentialRepository>(),
              await getAsync<_i178.GetClaimsUseCase>(),
              gh<_i115.GetClaimRevocationNonceUseCase>(),
              await getAsync<_i151.IsProofCircuitSupportedUseCase>(),
              gh<_i118.GetProofRequestsUseCase>(),
            ));
    ...
    gh.factoryAsync<_i181.GetIden3commProofsUseCase>(
        () async => _i181.GetIden3commProofsUseCase(
              await getAsync<_i137.ProofRepository>(),
              await getAsync<_i180.GetIden3commClaimsUseCase>(),
              await getAsync<_i167.GenerateIden3commProofUseCase>(),
              await getAsync<_i151.IsProofCircuitSupportedUseCase>(),
              gh<_i118.GetProofRequestsUseCase>(),
              await getAsync<_i162.GetIdentityUseCase>(),
              gh<_i56.ProofGenerationStepsStreamManager>(),
    ...
    gh.factoryAsync<_i182.UpdateIdentityUseCase>(
        () async => _i182.UpdateIdentityUseCase(
              await getAsync<_i136.IdentityRepository>(),
              await getAsync<_i175.CreateIdentityUseCase>(),
              await getAsync<_i162.GetIdentityUseCase>(),
            ));
    gh.factoryAsync<_i183.AddIdentityUseCase>(
        () async => _i183.AddIdentityUseCase(
              await getAsync<_i136.IdentityRepository>(),
              await getAsync<_i175.CreateIdentityUseCase>(),
              await getAsync<_i154.CreateIdentityStateUseCase>(),
            ));
    gh.factoryAsync<_i184.AddNewIdentityUseCase>(
        () async => _i184.AddNewIdentityUseCase(
              await getAsync<_i136.IdentityRepository>(),
              await getAsync<_i183.AddIdentityUseCase>(),
            ));
    gh.factoryAsync<_i185.AddProfileUseCase>(
        () async => _i185.AddProfileUseCase(
              await getAsync<_i162.GetIdentityUseCase>(),
              await getAsync<_i182.UpdateIdentityUseCase>(),
              await getAsync<_i166.CheckProfileAndDidCurrentEnvUseCase>(),
              await getAsync<_i176.CreateProfilesUseCase>(),
            ));
    gh.factoryAsync<_i186.AuthenticateUseCase>(
        () async => _i186.AuthenticateUseCase(
              gh<_i120.Iden3commRepository>(),
              await getAsync<_i181.GetIden3commProofsUseCase>(),
              await getAsync<_i161.GetDidIdentifierUseCase>(),
              await getAsync<_i169.GetAuthTokenUseCase>(),
              await getAsync<_i116.GetEnvUseCase>(),
              await getAsync<_i105.GetPackageNameUseCase>(),
              await getAsync<_i166.CheckProfileAndDidCurrentEnvUseCase>(),
              gh<_i56.ProofGenerationStepsStreamManager>(),
            ));
    gh.factoryAsync<_i187.Credential>(() async => _i187.Credential(
          gh<_i127.SaveClaimsUseCase>(),
          await getAsync<_i178.GetClaimsUseCase>(),
          gh<_i125.RemoveClaimsUseCase>(),
          await getAsync<_i160.GetClaimRevocationStatusUseCase>(),
          gh<_i129.UpdateClaimUseCase>(),
        ));
    gh.factoryAsync<_i188.Iden3comm>(() async => _i188.Iden3comm(
          await getAsync<_i177.FetchAndSaveClaimsUseCase>(),
          gh<_i24.GetIden3MessageUseCase>(),
          gh<_i119.GetSchemasUseCase>(),
          await getAsync<_i186.AuthenticateUseCase>(),
          await getAsync<_i157.GetFiltersUseCase>(),
          await getAsync<_i180.GetIden3commClaimsUseCase>(),
          await getAsync<_i179.GetIden3commClaimsRevNonceUseCase>(),
          await getAsync<_i181.GetIden3commProofsUseCase>(),
          await getAsync<_i163.GetInteractionsUseCase>(),
          await getAsync<_i165.AddInteractionUseCase>(),
          await getAsync<_i164.RemoveInteractionsUseCase>(),
          await getAsync<_i172.UpdateInteractionUseCase>(),
        ));
    gh.factoryAsync<_i189.RemoveProfileUseCase>(
        () async => _i189.RemoveProfileUseCase(
              ...
              await getAsync<_i166.CheckProfileAndDidCurrentEnvUseCase>(),
              await getAsync<_i176.CreateProfilesUseCase>(),
              gh<_i135.RemoveIdentityStateUseCase>(),
              gh<_i124.RemoveAllClaimsUseCase>(),
            ));
    ...
    gh.factoryAsync<_i191.RemoveIdentityUseCase>(
        () async => _i191.RemoveIdentityUseCase(
              await getAsync<_i136.IdentityRepository>(),
              await getAsync<_i171.GetProfilesUseCase>(),
              await getAsync<_i189.RemoveProfileUseCase>(),
              gh<_i135.RemoveIdentityStateUseCase>(),
              gh<_i124.RemoveAllClaimsUseCase>(),
              await getAsync<_i166.CheckProfileAndDidCurrentEnvUseCase>(),
            ));
    gh.factoryAsync<_i192.Identity>(() async => _i192.Identity(
          await getAsync<_i174.CheckIdentityValidityUseCase>(),
          await getAsync<_i149.GetPrivateKeyUseCase>(),
          await getAsync<_i184.AddNewIdentityUseCase>(),
          await getAsync<_i190.RestoreIdentityUseCase>(),
          await getAsync<_i173.BackupIdentityUseCase>(),
          await getAsync<_i162.GetIdentityUseCase>(),
          await getAsync<_i147.GetIdentitiesUseCase>(),
          await getAsync<_i191.RemoveIdentityUseCase>(),
          await getAsync<_i161.GetDidIdentifierUseCase>(),
          await getAsync<_i139.SignMessageUseCase>(),
          await getAsync<_i155.FetchIdentityStateUseCase>(),
          await getAsync<_i185.AddProfileUseCase>(),
          await getAsync<_i171.GetProfilesUseCase>(),
          await getAsync<_i189.RemoveProfileUseCase>(),
          await getAsync<_i145.GetDidUseCase>(),
        ));

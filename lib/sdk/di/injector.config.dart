...
import '../../credential/data/mappers/claim_mapper.dart' as _i63;
...
import '../../credential/data/mappers/revocation_status_mapper.dart' as _i51;
...
import '../../env/sdk_env.dart' as _i53;
import '../../iden3comm/data/data_sources/proof_scope_data_source.dart' as _i45;
import '../../iden3comm/data/data_sources/remote_iden3comm_data_source.dart'
    as _i49;
import '../../iden3comm/data/mappers/auth_request_mapper.dart' as _i62;
...
import '../../iden3comm/data/mappers/contract_func_call_request_mapper.dart'
    as _i10;
import '../../iden3comm/data/mappers/contract_request_mapper.dart' as _i65;
import '../../iden3comm/data/mappers/fetch_request_mapper.dart' as _i67;
import '../../iden3comm/data/mappers/iden3_message_type_data_mapper.dart'
    as _i20;
import '../../iden3comm/data/mappers/offer_request_mapper.dart' as _i33;
import '../../iden3comm/data/mappers/proof_query_mapper.dart' as _i42;
import '../../iden3comm/data/mappers/proof_query_param_mapper.dart' as _i43;
import '../../iden3comm/data/mappers/proof_request_filters_mapper.dart' as _i44;
...
import '../../identity/data/data_sources/smt_data_source.dart' as _i23;
import '../../identity/data/data_sources/storage_identity_data_source.dart'
    as _i69;
import '../../identity/data/data_sources/wallet_data_source.dart' as _i55;
...
import '../../identity/data/mappers/node_type_dto_mapper.dart' as _i30;
import '../../identity/data/mappers/node_type_entity_mapper.dart' as _i31;
import '../../identity/data/mappers/node_type_mapper.dart' as _i32;
...
import '../../identity/data/mappers/rhs_node_type_mapper.dart' as _i52;
import '../../identity/data/mappers/state_identifier_mapper.dart' as _i54;
...
import '../../identity/libs/polygonidcore/polygonidcore.dart' as _i37;
...
import '../../proof_generation/data/mappers/proof_mapper.dart' as _i41;
...
import '../../proof_generation/domain/use_cases/is_proof_circuit_supported_use_case.dart'
    as _i105;
import '../../proof_generation/libs/prover/prover.dart' as _i46;
import '../../proof_generation/libs/witnesscalc/auth/witness_auth.dart' as _i57;
import '../../proof_generation/libs/witnesscalc/mtp/witness_mtp.dart' as _i59;
import '../../proof_generation/libs/witnesscalc/sig/witness_sig.dart' as _i60;
import '../credential.dart' as _i113;
import '../iden3comm.dart' as _i112;
import '../identity.dart' as _i104;
import '../mappers/iden3_message_mapper.dart' as _i68;
...
_i1.GetIt $initSDKGetIt(
  ...
  gh.factory<_i29.Node>(() => _i29.Node(
        get<_i29.NodeType>(),
        get<_i19.Iden3CoreLib>(),
      ));
  gh.factory<_i30.NodeTypeDTOMapper>(() => _i30.NodeTypeDTOMapper());
  gh.factory<_i31.NodeTypeEntityMapper>(() => _i31.NodeTypeEntityMapper());
  gh.factory<_i32.NodeTypeMapper>(() => _i32.NodeTypeMapper());
  gh.factory<_i33.OfferRequestMapper>(
      () => _i33.OfferRequestMapper(get<_i20.Iden3MessageTypeDataMapper>()));
  ...
  gh.factory<_i37.PolygonIdCoreLib>(() => _i37.PolygonIdCoreLib());
  gh.factory<_i38.PrivateKeyMapper>(() => _i38.PrivateKeyMapper());
  gh.factory<_i39.ProofCircuitDataSource>(() => _i39.ProofCircuitDataSource());
  gh.factory<_i40.ProofMapper>(() => _i40.ProofMapper(get<_i16.HashMapper>()));
  gh.factory<_i41.ProofMapper>(() => _i41.ProofMapper());
  gh.factory<_i42.ProofQueryMapper>(() => _i42.ProofQueryMapper());
  gh.factory<_i43.ProofQueryParamMapper>(() => _i43.ProofQueryParamMapper());
  gh.factory<_i44.ProofRequestFiltersMapper>(
      () => _i44.ProofRequestFiltersMapper(get<_i42.ProofQueryMapper>()));
  gh.factory<_i45.ProofScopeDataSource>(() => _i45.ProofScopeDataSource());
  gh.factory<_i46.ProverLib>(() => _i46.ProverLib());
  gh.factory<_i47.ProverLibWrapper>(() => _i47.ProverLibWrapper());
  gh.factory<_i48.RemoteClaimDataSource>(
      () => _i48.RemoteClaimDataSource(get<_i9.Client>()));
  gh.factory<_i49.RemoteIden3commDataSource>(
      () => _i49.RemoteIden3commDataSource(get<_i9.Client>()));
  gh.factory<_i50.RemoteIdentityDataSource>(
      () => _i50.RemoteIdentityDataSource());
  gh.factory<_i51.RevocationStatusMapper>(() => _i51.RevocationStatusMapper());
  gh.factory<_i52.RhsNodeTypeMapper>(() => _i52.RhsNodeTypeMapper());
  gh.factory<_i23.SMTDataSource>(() => _i23.SMTDataSource(
        get<_i23.IdentitySMTStoreRefWrapper>(),
        get<_i17.HexMapper>(),
        get<_i25.LibBabyJubJubDataSource>(),
      ));
  gh.lazySingleton<_i53.SdkEnv>(() => sdk.sdkEnv);
  gh.factory<_i54.StateIdentifierMapper>(() => _i54.StateIdentifierMapper());
  ...
  gh.factory<_i56.Web3Client>(
      () => networkModule.web3Client(get<_i53.SdkEnv>()));
  gh.factory<_i57.WitnessAuthLib>(() => _i57.WitnessAuthLib());
  gh.factory<_i58.WitnessIsolatesWrapper>(() => _i58.WitnessIsolatesWrapper());
  gh.factory<_i59.WitnessMtpLib>(() => _i59.WitnessMtpLib());
  gh.factory<_i60.WitnessSigLib>(() => _i60.WitnessSigLib());
  gh.factory<_i61.AtomicQueryInputsWrapper>(
      () => _i61.AtomicQueryInputsWrapper(get<_i19.Iden3CoreLib>()));
  gh.factory<_i62.AuthRequestMapper>(
      () => _i62.AuthRequestMapper(get<_i20.Iden3MessageTypeDataMapper>()));
  gh.factory<_i63.ClaimMapper>(() => _i63.ClaimMapper(
        get<_i8.ClaimStateMapper>(),
        get<_i7.ClaimInfoMapper>(),
      ));
  gh.factory<_i64.ClaimStoreRefWrapper>(() => _i64.ClaimStoreRefWrapper(
      get<_i12.StoreRef<String, Map<String, Object?>>>(
          instanceName: 'claimStore')));
  gh.factory<_i65.ContractRequestMapper>(
      () => _i65.ContractRequestMapper(get<_i20.Iden3MessageTypeDataMapper>()));
  gh.factory<_i66.EnvDataSource>(() => _i66.EnvDataSource(get<_i53.SdkEnv>()));
  gh.factory<_i67.FetchRequestMapper>(
      () => _i67.FetchRequestMapper(get<_i20.Iden3MessageTypeDataMapper>()));
  gh.factory<_i68.Iden3MessageMapper>(
      () => _i68.Iden3MessageMapper(get<_i21.Iden3MessageTypeMapper>()));
  gh.factory<_i69.IdentityStoreRefWrapper>(() => _i69.IdentityStoreRefWrapper(
      get<_i12.StoreRef<String, Map<String, Object?>>>(
          instanceName: 'identityStore')));
  gh.factory<_i70.LibPolygonIdCoreDataSource>(
      () => _i70.LibPolygonIdCoreDataSource(get<_i37.PolygonIdCoreLib>()));
  gh.factory<_i71.NodeMapper>(() => _i71.NodeMapper(
        get<_i32.NodeTypeMapper>(),
        get<_i31.NodeTypeEntityMapper>(),
        get<_i30.NodeTypeDTOMapper>(),
        get<_i16.HashMapper>(),
      ));
  ...
  gh.factory<_i73.ProofRequestsMapper>(() => _i73.ProofRequestsMapper(
        get<_i62.AuthRequestMapper>(),
        get<_i67.FetchRequestMapper>(),
        get<_i33.OfferRequestMapper>(),
        get<_i65.ContractRequestMapper>(),
        get<_i43.ProofQueryParamMapper>(),
      ));
  gh.factory<_i47.ProverLibDataSource>(
      () => _i47.ProverLibDataSource(get<_i47.ProverLibWrapper>()));
  gh.factory<_i74.RPCDataSource>(
      () => _i74.RPCDataSource(get<_i56.Web3Client>()));
  gh.factory<_i75.RhsNodeMapper>(
      () => _i75.RhsNodeMapper(get<_i52.RhsNodeTypeMapper>()));
  gh.factory<_i76.SMTRepositoryImpl>(() => _i76.SMTRepositoryImpl(
        get<_i23.SMTDataSource>(),
  ...
  gh.factory<_i64.StorageClaimDataSource>(
      () => _i64.StorageClaimDataSource(get<_i64.ClaimStoreRefWrapper>()));
  ...
  gh.factory<_i55.WalletDataSource>(
      () => _i55.WalletDataSource(get<_i55.WalletLibWrapper>()));
  gh.factory<_i58.WitnessDataSource>(
      () => _i58.WitnessDataSource(get<_i58.WitnessIsolatesWrapper>()));
  gh.factory<_i61.AtomicQueryInputsDataSource>(() =>
      _i61.AtomicQueryInputsDataSource(get<_i61.AtomicQueryInputsWrapper>()));
  gh.factory<_i78.ConfigRepositoryImpl>(
      () => _i78.ConfigRepositoryImpl(get<_i66.EnvDataSource>()));
  gh.factory<_i79.CredentialRepositoryImpl>(() => _i79.CredentialRepositoryImpl(
        get<_i48.RemoteClaimDataSource>(),
        get<_i64.StorageClaimDataSource>(),
        get<_i26.LibIdentityDataSource>(),
        get<_i11.CredentialRequestMapper>(),
        get<_i63.ClaimMapper>(),
        get<_i15.FiltersMapper>(),
        get<_i18.IdFilterMapper>(),
        get<_i51.RevocationStatusMapper>(),
      ));
  ...
  gh.factoryAsync<_i81.IdentityRepositoryImpl>(
      () async => _i81.IdentityRepositoryImpl(
            get<_i55.WalletDataSource>(),
            get<_i26.LibIdentityDataSource>(),
            get<_i70.LibPolygonIdCoreDataSource>(),
            get<_i50.RemoteIdentityDataSource>(),
            ...
            get<_i54.StateIdentifierMapper>(),
            get<_i13.DidMapper>(),
          ));
  ...
  gh.factory<_i82.ProofRepositoryImpl>(() => _i82.ProofRepositoryImpl(
        get<_i58.WitnessDataSource>(),
        get<_i47.ProverLibDataSource>(),
        get<_i61.AtomicQueryInputsDataSource>(),
        get<_i28.LocalProofFilesDataSource>(),
        get<_i39.ProofCircuitDataSource>(),
        get<_i50.RemoteIdentityDataSource>(),
        get<_i6.CircuitTypeMapper>(),
        get<_i73.ProofRequestsMapper>(),
        get<_i44.ProofRequestFiltersMapper>(),
        get<_i41.ProofMapper>(),
        get<_i63.ClaimMapper>(),
        get<_i51.RevocationStatusMapper>(),
      ));
  ...
  gh.factory<_i88.Iden3commRepositoryImpl>(() => _i88.Iden3commRepositoryImpl(
        get<_i49.RemoteIden3commDataSource>(),

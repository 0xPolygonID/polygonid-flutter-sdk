...
import '../../iden3comm/domain/use_cases/authenticate_use_case.dart' as _i109;
import '../../iden3comm/domain/use_cases/get_auth_token_use_case.dart' as _i106;
import '../../iden3comm/domain/use_cases/get_proofs_use_case.dart' as _i107;
...
import '../../identity/data/repositories/smt_repository_impl.dart' as _i75;
...
import '../iden3comm.dart' as _i111;
import '../identity.dart' as _i103;
...
import '../proof.dart' as _i108;
import 'injector.dart' as _i113; // ignore_for_file: unnecessary_lambdas
...
_i1.GetIt $initSDKGetIt(
  ...
  gh.factory<_i39.ProofEntityMapper>(() => _i39.ProofEntityMapper());
  ...
  gh.factory<_i23.StorageIdentitySMTDataSource>(() =>
      _i23.StorageIdentitySMTDataSource(
  ...
  gh.factory<_i75.SMTRepositoryImpl>(() => _i75.SMTRepositoryImpl(
        get<_i23.StorageIdentitySMTDataSource>(),
  ...
  gh.factory<_i81.ProofRepositoryImpl>(() => _i81.ProofRepositoryImpl(
  ...
  gh.factory<_i89.ProofRepository>(() =>
      repositoriesModule.proofRepository(get<_i81.ProofRepositoryImpl>()));
  ...
  gh.factory<_i93.UpdateClaimUseCase>(
      () => _i93.UpdateClaimUseCase(get<_i83.CredentialRepository>()));
  gh.factoryAsync<_i94.CreateAndSaveIdentityUseCase>(() async =>
      _i94.CreateAndSaveIdentityUseCase(
          await get.getAsync<_i88.IdentityRepository>()));
  gh.factoryAsync<_i95.FetchIdentityStateUseCase>(
      () async => _i95.FetchIdentityStateUseCase(
            await get.getAsync<_i88.IdentityRepository>(),
            get<_i85.GetEnvConfigUseCase>(),
          ));
  gh.factoryAsync<_i96.FetchStateRootsUseCase>(() async =>
      _i96.FetchStateRootsUseCase(
          await get.getAsync<_i88.IdentityRepository>()));
  gh.factoryAsync<_i97.GenerateNonRevProofUseCase>(
      () async => _i97.GenerateNonRevProofUseCase(
            await get.getAsync<_i88.IdentityRepository>(),
            get<_i83.CredentialRepository>(),
            get<_i85.GetEnvConfigUseCase>(),
            await get.getAsync<_i95.FetchIdentityStateUseCase>(),
          ));
  gh.factoryAsync<_i98.GetClaimRevocationStatusUseCase>(
      () async => _i98.GetClaimRevocationStatusUseCase(
            get<_i83.CredentialRepository>(),
            await get.getAsync<_i88.IdentityRepository>(),
            await get.getAsync<_i97.GenerateNonRevProofUseCase>(),
          ));
  ...
  gh.factoryAsync<_i103.Identity>(() async => _i103.Identity(
        await get.getAsync<_i94.CreateAndSaveIdentityUseCase>(),
  ...
  gh.factory<_i104.IsProofCircuitSupportedUseCase>(
      () => _i104.IsProofCircuitSupportedUseCase(get<_i89.ProofRepository>()));
  gh.factoryAsync<_i105.GenerateProofUseCase>(
      () async => _i105.GenerateProofUseCase(
            get<_i89.ProofRepository>(),
            get<_i83.CredentialRepository>(),
            await get.getAsync<_i98.GetClaimRevocationStatusUseCase>(),
          ));
  gh.factoryAsync<_i106.GetAuthTokenUseCase>(
      () async => _i106.GetAuthTokenUseCase(
            get<_i102.Iden3commRepository>(),
            get<_i89.ProofRepository>(),
            get<_i83.CredentialRepository>(),
            await get.getAsync<_i88.IdentityRepository>(),
          ));
  gh.factoryAsync<_i107.GetProofsUseCase>(() async => _i107.GetProofsUseCase(
        get<_i89.ProofRepository>(),
        await get.getAsync<_i88.IdentityRepository>(),
        get<_i84.GetClaimsUseCase>(),
        await get.getAsync<_i105.GenerateProofUseCase>(),
        get<_i104.IsProofCircuitSupportedUseCase>(),
      ));
  gh.factoryAsync<_i108.Proof>(() async =>
      _i108.Proof(await get.getAsync<_i105.GenerateProofUseCase>()));
  gh.factoryAsync<_i109.AuthenticateUseCase>(
      () async => _i109.AuthenticateUseCase(
            get<_i102.Iden3commRepository>(),
            await get.getAsync<_i107.GetProofsUseCase>(),
            await get.getAsync<_i106.GetAuthTokenUseCase>(),
            get<_i85.GetEnvConfigUseCase>(),
            await get.getAsync<_i79.GetPackageNameUseCase>(),
            await get.getAsync<_i99.GetDidIdentifierUseCase>(),
          ));
  gh.factoryAsync<_i110.FetchAndSaveClaimsUseCase>(
      () async => _i110.FetchAndSaveClaimsUseCase(
            await get.getAsync<_i106.GetAuthTokenUseCase>(),
            get<_i83.CredentialRepository>(),
          ));
  gh.factoryAsync<_i111.Iden3comm>(() async => _i111.Iden3comm(
        get<_i86.GetVocabsUseCase>(),
        await get.getAsync<_i109.AuthenticateUseCase>(),
        await get.getAsync<_i107.GetProofsUseCase>(),
        get<_i67.Iden3MessageMapper>(),
        get<_i76.SchemaInfoMapper>(),
      ));
  gh.factoryAsync<_i112.Credential>(() async => _i112.Credential(
        await get.getAsync<_i110.FetchAndSaveClaimsUseCase>(),
        get<_i84.GetClaimsUseCase>(),
...
class _$PlatformModule extends _i113.PlatformModule {}

class _$NetworkModule extends _i113.NetworkModule {}

class _$DatabaseModule extends _i113.DatabaseModule {}

class _$Sdk extends _i113.Sdk {}

class _$RepositoriesModule extends _i113.RepositoriesModule {}

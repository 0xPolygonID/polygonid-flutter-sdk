...
import '../../identity/domain/use_cases/add_identity_use_case.dart' as _i147;
import '../../identity/domain/use_cases/add_profile_use_case.dart' as _i148;
...
import '../../identity/domain/use_cases/create_identity_state_use_case.dart'
    as _i129;
import '../../identity/domain/use_cases/create_identity_use_case.dart' as _i140;
...
import '../../identity/domain/use_cases/get_identity_auth_claim_use_case.dart'
    as _i122;
import '../../identity/domain/use_cases/get_identity_use_case.dart' as _i135;
import '../../identity/domain/use_cases/get_latest_state_use_case.dart'
    as _i124;
import '../../identity/domain/use_cases/get_profiles_use_case.dart' as _i136;
...
import '../../identity/domain/use_cases/remove_identity_state_use_case.dart'
    as _i128;
import '../../identity/domain/use_cases/remove_identity_use_case.dart' as _i137;
import '../../identity/domain/use_cases/remove_profile_use_case.dart' as _i153;
...
import '../../identity/domain/use_cases/update_identity_use_case.dart' as _i146;
...
import '../../proof/libs/witnesscalc/sig_v2_onchain/witness_sig_onchain.dart'
    as _i70;
import '../credential.dart' as _i155;
import '../iden3comm.dart' as _i152;
import '../identity.dart' as _i156;
import '../mappers/iden3_message_type_mapper.dart' as _i27;
import '../proof.dart' as _i145;
import 'injector.dart' as _i157; // ignore_for_file: unnecessary_lambdas
...
_i1.GetIt $initSDKGetIt(
  ...
  gh.factoryAsync<_i134.GetDidIdentifierUseCase>(
      () async => _i134.GetDidIdentifierUseCase(
            await get.getAsync<_i105.IdentityRepository>(),
            await get.getAsync<_i133.GetGenesisStateUseCase>(),
          ));
  gh.factoryAsync<_i135.GetIdentityUseCase>(
      () async => _i135.GetIdentityUseCase(
            await get.getAsync<_i105.IdentityRepository>(),
            await get.getAsync<_i119.GetDidUseCase>(),
            await get.getAsync<_i134.GetDidIdentifierUseCase>(),
          ));
  gh.factoryAsync<_i136.GetProfilesUseCase>(
      () async => _i136.GetProfilesUseCase(
            await get.getAsync<_i105.IdentityRepository>(),
            await get.getAsync<_i135.GetIdentityUseCase>(),
          ));
  gh.factoryAsync<_i137.RemoveIdentityUseCase>(
      () async => _i137.RemoveIdentityUseCase(
            await get.getAsync<_i105.IdentityRepository>(),
            await get.getAsync<_i136.GetProfilesUseCase>(),
  ...
  gh.factoryAsync<_i140.CreateIdentityUseCase>(
      () async => _i140.CreateIdentityUseCase(
            await get.getAsync<_i105.IdentityRepository>(),
  ...
  gh.factoryAsync<_i146.UpdateIdentityUseCase>(
      () async => _i146.UpdateIdentityUseCase(
            await get.getAsync<_i105.IdentityRepository>(),
            await get.getAsync<_i140.CreateIdentityUseCase>(),
            await get.getAsync<_i129.CreateIdentityStateUseCase>(),
            get<_i128.RemoveIdentityStateUseCase>(),
            get<_i109.RemoveAllClaimsUseCase>(),
          ));
  gh.factoryAsync<_i147.AddIdentityUseCase>(
      () async => _i147.AddIdentityUseCase(
            await get.getAsync<_i105.IdentityRepository>(),
            await get.getAsync<_i140.CreateIdentityUseCase>(),
            await get.getAsync<_i129.CreateIdentityStateUseCase>(),
          ));
  gh.factoryAsync<_i148.AddProfileUseCase>(() async => _i148.AddProfileUseCase(
        await get.getAsync<_i105.IdentityRepository>(),
        await get.getAsync<_i135.GetIdentityUseCase>(),
        await get.getAsync<_i119.GetDidUseCase>(),
        await get.getAsync<_i146.UpdateIdentityUseCase>(),
      ));
  ...
  gh.factoryAsync<_i150.CreateNewIdentityUseCase>(
      () async => _i150.CreateNewIdentityUseCase(
            get<String>(instanceName: 'accessMessage'),
            await get.getAsync<_i105.IdentityRepository>(),
            await get.getAsync<_i147.AddIdentityUseCase>(),
          ));
  ...
  gh.factoryAsync<_i153.RemoveProfileUseCase>(
      () async => _i153.RemoveProfileUseCase(
            await get.getAsync<_i105.IdentityRepository>(),
            await get.getAsync<_i135.GetIdentityUseCase>(),
            await get.getAsync<_i119.GetDidUseCase>(),
            await get.getAsync<_i146.UpdateIdentityUseCase>(),
          ));
  gh.factoryAsync<_i154.RestoreIdentityUseCase>(
      () async => _i154.RestoreIdentityUseCase(
            await get.getAsync<_i147.AddIdentityUseCase>(),
            await get.getAsync<_i135.GetIdentityUseCase>(),
            await get.getAsync<_i106.ImportIdentityUseCase>(),
            await get.getAsync<_i134.GetDidIdentifierUseCase>(),
          ));
  gh.factoryAsync<_i155.Credential>(() async => _i155.Credential(
        await get.getAsync<_i151.FetchAndSaveClaimsUseCase>(),
        get<_i101.GetClaimsUseCase>(),
        get<_i110.RemoveClaimsUseCase>(),
        get<_i113.UpdateClaimUseCase>(),
      ));
  gh.factoryAsync<_i156.Identity>(() async => _i156.Identity(
        await get.getAsync<_i139.CheckIdentityValidityUseCase>(),
        await get.getAsync<_i150.CreateNewIdentityUseCase>(),
        await get.getAsync<_i154.RestoreIdentityUseCase>(),
        await get.getAsync<_i138.BackupIdentityUseCase>(),
        await get.getAsync<_i135.GetIdentityUseCase>(),
        await get.getAsync<_i121.GetIdentitiesUseCase>(),
        await get.getAsync<_i137.RemoveIdentityUseCase>(),
        await get.getAsync<_i134.GetDidIdentifierUseCase>(),
        await get.getAsync<_i112.SignMessageUseCase>(),
        await get.getAsync<_i130.FetchIdentityStateUseCase>(),
        await get.getAsync<_i148.AddProfileUseCase>(),
        await get.getAsync<_i136.GetProfilesUseCase>(),
        await get.getAsync<_i153.RemoveProfileUseCase>(),
      ));
  return get;
}

class _$PlatformModule extends _i157.PlatformModule {}

class _$NetworkModule extends _i157.NetworkModule {}

class _$DatabaseModule extends _i157.DatabaseModule {}

class _$EncryptionModule extends _i157.EncryptionModule {}

class _$Sdk extends _i157.Sdk {}

class _$ZipDecoderModule extends _i157.ZipDecoderModule {}

class _$RepositoriesModule extends _i157.RepositoriesModule {}

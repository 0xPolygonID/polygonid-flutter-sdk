...
import '../../iden3comm/domain/use_cases/authenticate_use_case.dart' as _i140;
import '../../iden3comm/domain/use_cases/get_auth_inputs_use_case.dart'
    as _i134;
import '../../iden3comm/domain/use_cases/get_auth_token_use_case.dart' as _i135;
...
import '../../iden3comm/domain/use_cases/get_proof_requests_use_case.dart'
    as _i24;
import '../../iden3comm/domain/use_cases/get_proofs_use_case.dart' as _i137;
...
import '../../identity/domain/use_cases/backup_identity_use_case.dart' as _i128;
...
import '../../identity/domain/use_cases/get_identity_use_case.dart' as _i127;
...
import '../../proof/domain/use_cases/generate_proof_use_case.dart' as _i133;
...
import '../../proof/libs/witnesscalc/sig_v2_onchain/witness_sig_onchain.dart'
    as _i69;
import '../credential.dart' as _i144;
import '../iden3comm.dart' as _i142;
import '../identity.dart' as _i143;
import '../mappers/iden3_message_type_mapper.dart' as _i28;
import '../proof.dart' as _i138;
import 'injector.dart' as _i145; // ignore_for_file: unnecessary_lambdas
...
_i1.GetIt $initSDKGetIt(
  ...
  gh.factoryAsync<_i126.GetIdentitiesUseCase>(() async =>
      _i126.GetIdentitiesUseCase(
          await get.getAsync<_i113.IdentityRepository>()));
  gh.factoryAsync<_i127.GetIdentityUseCase>(
      () async => _i127.GetIdentityUseCase(
            await get.getAsync<_i113.IdentityRepository>(),
            await get.getAsync<_i124.GetDidUseCase>(),
          ));
  gh.factoryAsync<_i128.BackupIdentityUseCase>(
      () async => _i128.BackupIdentityUseCase(
            await get.getAsync<_i127.GetIdentityUseCase>(),
            await get.getAsync<_i120.ExportIdentityUseCase>(),
            await get.getAsync<_i123.GetDidIdentifierUseCase>(),
          ));
  gh.factoryAsync<_i129.CreateAndSaveIdentityFromPKUseCase>(
      () async => _i129.CreateAndSaveIdentityFromPKUseCase(
            await get.getAsync<_i113.IdentityRepository>(),
            await get.getAsync<_i124.GetDidUseCase>(),
            await get.getAsync<_i123.GetDidIdentifierUseCase>(),
          ));
  gh.factoryAsync<_i130.CreateAndSaveIdentityUseCase>(
      () async => _i130.CreateAndSaveIdentityUseCase(
  ...
  gh.factoryAsync<_i133.GenerateProofUseCase>(
      () async => _i133.GenerateProofUseCase(
            await get.getAsync<_i113.IdentityRepository>(),
  ...
  gh.factoryAsync<_i134.GetAuthInputsUseCase>(
      () async => _i134.GetAuthInputsUseCase(
            await get.getAsync<_i127.GetIdentityUseCase>(),
            get<_i98.GetAuthClaimUseCase>(),
            await get.getAsync<_i118.SignMessageUseCase>(),
            await get.getAsync<_i125.GetGistProofUseCase>(),
  ...
  gh.factoryAsync<_i135.GetAuthTokenUseCase>(
      () async => _i135.GetAuthTokenUseCase(
            get<_i116.LoadCircuitUseCase>(),
            get<_i112.GetJWZUseCase>(),
            await get.getAsync<_i122.GetAuthChallengeUseCase>(),
            await get.getAsync<_i134.GetAuthInputsUseCase>(),
            get<_i105.ProveUseCase>(),
          ));
  ...
  gh.factoryAsync<_i137.GetProofsUseCase>(() async => _i137.GetProofsUseCase(
        get<_i104.ProofRepository>(),
        await get.getAsync<_i113.IdentityRepository>(),
        get<_i99.GetClaimsUseCase>(),
        await get.getAsync<_i133.GenerateProofUseCase>(),
        get<_i115.IsProofCircuitSupportedUseCase>(),
        get<_i24.GetProofRequestsUseCase>(),
      ));
  gh.factoryAsync<_i138.Proof>(() async => _i138.Proof(
        await get.getAsync<_i133.GenerateProofUseCase>(),
        get<_i111.DownloadCircuitsUseCase>(),
        get<_i110.CircuitsFilesExistUseCase>(),
      ));
  gh.factoryAsync<_i139.RestoreIdentityUseCase>(
      () async => _i139.RestoreIdentityUseCase(
            await get.getAsync<_i129.CreateAndSaveIdentityFromPKUseCase>(),
            await get.getAsync<_i114.ImportIdentityUseCase>(),
            await get.getAsync<_i123.GetDidIdentifierUseCase>(),
          ));
  gh.factoryAsync<_i140.AuthenticateUseCase>(
      () async => _i140.AuthenticateUseCase(
            get<_i102.Iden3commRepository>(),
            await get.getAsync<_i137.GetProofsUseCase>(),
            await get.getAsync<_i135.GetAuthTokenUseCase>(),
            get<_i100.GetEnvConfigUseCase>(),
            await get.getAsync<_i91.GetPackageNameUseCase>(),
            await get.getAsync<_i123.GetDidIdentifierUseCase>(),
          ));
  gh.factoryAsync<_i141.FetchAndSaveClaimsUseCase>(
      () async => _i141.FetchAndSaveClaimsUseCase(
            get<_i20.GetFetchRequestsUseCase>(),
            await get.getAsync<_i135.GetAuthTokenUseCase>(),
            get<_i97.CredentialRepository>(),
          ));
  gh.factoryAsync<_i142.Iden3comm>(() async => _i142.Iden3comm(
        get<_i101.GetVocabsUseCase>(),
        await get.getAsync<_i140.AuthenticateUseCase>(),
        await get.getAsync<_i137.GetProofsUseCase>(),
        get<_i22.GetIden3MessageUseCase>(),
      ));
  gh.factoryAsync<_i143.Identity>(() async => _i143.Identity(
        await get.getAsync<_i119.CheckIdentityValidityUseCase>(),
        await get.getAsync<_i130.CreateAndSaveIdentityUseCase>(),
        await get.getAsync<_i139.RestoreIdentityUseCase>(),
        await get.getAsync<_i128.BackupIdentityUseCase>(),
        await get.getAsync<_i127.GetIdentityUseCase>(),
  ...
  gh.factoryAsync<_i144.Credential>(() async => _i144.Credential(
        await get.getAsync<_i141.FetchAndSaveClaimsUseCase>(),
        get<_i99.GetClaimsUseCase>(),
...
class _$PlatformModule extends _i145.PlatformModule {}

class _$NetworkModule extends _i145.NetworkModule {}

class _$DatabaseModule extends _i145.DatabaseModule {}

class _$EncryptionModule extends _i145.EncryptionModule {}

class _$Sdk extends _i145.Sdk {}

class _$ZipDecoderModule extends _i145.ZipDecoderModule {}

class _$RepositoriesModule extends _i145.RepositoriesModule {}

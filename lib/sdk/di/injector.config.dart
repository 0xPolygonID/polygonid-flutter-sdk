...
import '../../common/domain/repositories/package_info_repository.dart' as _i74;
...
import '../../identity/data/data_sources/remote_identity_data_source.dart'
    as _i52;
import '../../identity/data/data_sources/rpc_data_source.dart' as _i75;
...
import '../../identity/data/mappers/node_mapper.dart' as _i73;
...
import '../../identity/data/mappers/rhs_node_mapper.dart' as _i76;
...
_i1.GetIt $initSDKGetIt(
  ...
  gh.factory<_i72.LibPolygonIdCoreProofDataSource>(() =>
      _i72.LibPolygonIdCoreProofDataSource(get<_i42.PolygonIdCoreProof>()));
  gh.factory<_i73.NodeMapper>(() => _i73.NodeMapper(
        get<_i34.NodeTypeMapper>(),
        get<_i33.NodeTypeEntityMapper>(),
        get<_i32.NodeTypeDTOMapper>(),
        get<_i20.HashMapper>(),
      ));
  gh.factoryAsync<_i74.PackageInfoRepository>(() async =>
  ...
  gh.factory<_i75.RPCDataSource>(
      () => _i75.RPCDataSource(get<_i58.Web3Client>()));
  gh.factory<_i76.RhsNodeMapper>(
      () => _i76.RhsNodeMapper(get<_i54.RhsNodeTypeMapper>()));
  ...
  gh.factory<_i77.ConfigRepositoryImpl>(
      () => _i77.ConfigRepositoryImpl(get<_i66.EnvDataSource>()));
  ...
  gh.factoryAsync<_i79.GetPackageNameUseCase>(() async =>
      _i79.GetPackageNameUseCase(
          await get.getAsync<_i74.PackageInfoRepository>()));
  ...
  gh.factoryAsync<_i98.CreateAndSaveIdentityUseCase>(
      () async => _i98.CreateAndSaveIdentityUseCase(
            await get.getAsync<_i94.IdentityRepository>(),
  ...
  gh.factoryAsync<_i106.GetIdentityUseCase>(() async =>
      _i106.GetIdentityUseCase(await get.getAsync<_i94.IdentityRepository>()));

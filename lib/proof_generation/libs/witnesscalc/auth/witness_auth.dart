...
import 'native_witness_auth.dart';

@injectable
class WitnessAuthLib {
  static NativeWitnessAuthLib get _nativeWitnessAuthLib {
    return Platform.isAndroid
        ? NativeWitnessAuthLib(ffi.DynamicLibrary.open("libwitnesscalc.so"))
        : NativeWitnessAuthLib(ffi.DynamicLibrary.process());
  }
  ...
  Future<Uint8List?> calculateWitnessAuth(
    ...
    int result = _nativeWitnessAuthLib.witnesscalc(circuitBuffer, circuitSize,
        jsonBuffer, jsonSize, wtnsBuffer, wtnsSize, errorMsg, errorMaxSize);

...
class JWZBaseProof {
  ...
  factory JWZBaseProof.fromJson(Map<String, dynamic> json) => JWZBaseProof(
  ...
  @override
  String toString() =>
      "[JWZBaseProof] {piA: $piA, piB: $piB, piC: $piC, protocol: $protocol, curve: $curve}";

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is JWZBaseProof &&
...
class JWZProof {
  ...
  factory JWZProof.fromJson(Map<String, dynamic> json) => JWZProof(
  ...
  @override
  String toString() => "[JWZProof] {proof: $proof, pubSignals: $pubSignals}";

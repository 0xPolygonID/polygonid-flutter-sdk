...
class ProverLib {
  ...
  Future<Map<String, dynamic>?> proveZkeyFilePath(
    String circuitId,
    String zkeyFilePath,
    Uint8List wtnsBytes,
  ) async {
    ...
    ffi.Pointer<ffi.Char> zkeyFilePathPointer =
        zkeyFilePath.toNativeUtf8().cast<ffi.Char>();
    ...
    freeAllocatedMemory() {
      malloc.free(zkeyFilePathPointer);
      malloc.free(wtnsBuffer);
      malloc.free(proofSize);
      malloc.free(proofBuffer);
      malloc.free(publicSize);

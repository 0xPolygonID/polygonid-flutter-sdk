...
class NativeWitnessSigV2Lib {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  NativeWitnessSigV2Lib(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  NativeWitnessSigV2Lib.fromLookup(
  ...
  int witnesscalc_credentialAtomicQuerySigV2(
    ...
    return _witnesscalc_credentialAtomicQuerySigV2(
      circuit_buffer,
      circuit_size,
      json_buffer,
      json_size,
  ...
  late final _witnesscalc_credentialAtomicQuerySigV2Ptr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(
              ...
              ffi.Pointer<ffi.Char>,
              ffi.UnsignedLong)>>('witnesscalc_credentialAtomicQuerySigV2');
  late final _witnesscalc_credentialAtomicQuerySigV2 =
      _witnesscalc_credentialAtomicQuerySigV2Ptr.asFunction<
          int Function(
              ffi.Pointer<ffi.Char>,
              int,
              ffi.Pointer<ffi.Char>,

...
/// Bindings to `ios/Classes/witnesscalc_credentialAtomicQueryV3.h`.
class NativeWitnessV3Lib {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  NativeWitnessV3Lib(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  NativeWitnessV3Lib.fromLookup(
  ...
  int witnesscalc_credentialAtomicQueryV3(
    ...
    return _witnesscalc_credentialAtomicQueryV3(
      circuit_buffer,
      circuit_size,
      json_buffer,
      json_size,
  ...
  late final _witnesscalc_credentialAtomicQueryV3Ptr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(
              ...
              ffi.Pointer<ffi.Char>,
              ffi.UnsignedLong)>>('witnesscalc_credentialAtomicQueryV3');
  late final _witnesscalc_credentialAtomicQueryV3 =
      _witnesscalc_credentialAtomicQueryV3Ptr.asFunction<
          int Function(
              ffi.Pointer<ffi.Char>,
              int,
              ffi.Pointer<ffi.Char>,

...
/// Bindings to `ios/Classes/witnesscalc_credentialAtomicQueryMTPV2.h`.
class NativeWitnessMTPV2Lib {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  NativeWitnessMTPV2Lib(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  NativeWitnessMTPV2Lib.fromLookup(
  ...
  int witnesscalc_credentialAtomicQueryMTPV2(
    ...
    return _witnesscalc_credentialAtomicQueryMTPV2(
      circuit_buffer,
      circuit_size,
      json_buffer,
      json_size,
  ...
  late final _witnesscalc_credentialAtomicQueryMTPV2Ptr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(
              ...
              ffi.Pointer<ffi.Char>,
              ffi.UnsignedLong)>>('witnesscalc_credentialAtomicQueryMTPV2');
  late final _witnesscalc_credentialAtomicQueryMTPV2 =
      _witnesscalc_credentialAtomicQueryMTPV2Ptr.asFunction<
          int Function(
              ffi.Pointer<ffi.Char>,
              int,
              ffi.Pointer<ffi.Char>,

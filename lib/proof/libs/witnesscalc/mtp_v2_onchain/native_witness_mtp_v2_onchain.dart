...
/// Bindings to `ios/Classes/witnesscalc_credentialAtomicQueryMTPV2OnChain.h`.
class NativeWitnessMtpOnchainLib {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  NativeWitnessMtpOnchainLib(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  NativeWitnessMtpOnchainLib.fromLookup(
  ...
  int witnesscalc_credentialAtomicQueryMTPV2OnChain(
    ...
    return _witnesscalc_credentialAtomicQueryMTPV2OnChain(
      circuit_buffer,
      circuit_size,
      json_buffer,
      json_size,
  ...
  late final _witnesscalc_credentialAtomicQueryMTPV2OnChainPtr = _lookup<
          ffi.NativeFunction<
              ffi.Int Function(
  ...
  late final _witnesscalc_credentialAtomicQueryMTPV2OnChain =
      _witnesscalc_credentialAtomicQueryMTPV2OnChainPtr.asFunction<
          int Function(
              ffi.Pointer<ffi.Char>,
              int,
              ffi.Pointer<ffi.Char>,

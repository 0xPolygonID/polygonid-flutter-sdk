...
import 'native_witness_sig.dart';

@injectable
class WitnessSigLib {
  static NativeWitnessSigLib get _nativeWitnessSigLib {
    return Platform.isAndroid
        ? NativeWitnessSigLib(ffi.DynamicLibrary.open("libwitnesscalc_sig.so"))
        : NativeWitnessSigLib(ffi.DynamicLibrary.process());
  }
  ...
  Future<Uint8List?> calculateWitnessSig(
    ...
    int result = _nativeWitnessSigLib.witnesscalc_credentialAtomicQuerySig(
        circuitBuffer,
        circuitSize,
        jsonBuffer,
        jsonSize,

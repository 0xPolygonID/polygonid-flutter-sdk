...
/// Bindings to `ios/Classes/witnesscalc_credentialAtomicQuerySigV2OnChain.h`.
class NativeWitnessSigOnchainLib {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  NativeWitnessSigOnchainLib(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  NativeWitnessSigOnchainLib.fromLookup(
  ...
  int witnesscalc_credentialAtomicQuerySigV2OnChain(
    ...
    return _witnesscalc_credentialAtomicQuerySigV2OnChain(
      circuit_buffer,
      circuit_size,
      json_buffer,
      json_size,
  ...
  late final _witnesscalc_credentialAtomicQuerySigV2OnChainPtr = _lookup<
          ffi.NativeFunction<
              ffi.Int Function(
  ...
  late final _witnesscalc_credentialAtomicQuerySigV2OnChain =
      _witnesscalc_credentialAtomicQuerySigV2OnChainPtr.asFunction<
          int Function(
              ffi.Pointer<ffi.Char>,
              int,
              ffi.Pointer<ffi.Char>,

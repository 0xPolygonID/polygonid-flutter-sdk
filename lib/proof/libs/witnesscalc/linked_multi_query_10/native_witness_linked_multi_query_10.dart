...
/// Bindings to `ios/Classes/witnesscalc_linkedMultiQuery10.h`.
class NativeWitnessLinkedMultiQuery10Lib {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  NativeWitnessLinkedMultiQuery10Lib(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  NativeWitnessLinkedMultiQuery10Lib.fromLookup(
  ...
  int witnesscalc_linkedMultiQuery10(
    ...
    return _witnesscalc_linkedMultiQuery10(
      circuit_buffer,
      circuit_size,
      json_buffer,
      json_size,
  ...
  late final _witnesscalc_linkedMultiQuery10Ptr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(
              ...
              ffi.Pointer<ffi.Char>,
              ffi.UnsignedLong)>>('witnesscalc_linkedMultiQuery10');
  late final _witnesscalc_linkedMultiQuery10 =
      _witnesscalc_linkedMultiQuery10Ptr.asFunction<
          int Function(
              ffi.Pointer<ffi.Char>,
              int,
              ffi.Pointer<ffi.Char>,

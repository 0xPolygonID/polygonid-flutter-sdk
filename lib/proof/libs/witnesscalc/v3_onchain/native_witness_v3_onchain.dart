...
/// Bindings to `ios/Classes/witnesscalc_credentialAtomicQueryV3OnChain.h`.
class NativeWitnessV3OnchainLib {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  NativeWitnessV3OnchainLib(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  NativeWitnessV3OnchainLib.fromLookup(
  ...
  int witnesscalc_credentialAtomicQueryV3OnChain(
    ...
    return _witnesscalc_credentialAtomicQueryV3OnChain(
      circuit_buffer,
      circuit_size,
      json_buffer,
      json_size,
  ...
  late final _witnesscalc_credentialAtomicQueryV3OnChainPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(
              ...
              ffi.Pointer<ffi.Char>,
              ffi.UnsignedLong)>>('witnesscalc_credentialAtomicQueryV3OnChain');
  late final _witnesscalc_credentialAtomicQueryV3OnChain =
      _witnesscalc_credentialAtomicQueryV3OnChainPtr.asFunction<
          int Function(
              ffi.Pointer<ffi.Char>,
              int,
              ffi.Pointer<ffi.Char>,

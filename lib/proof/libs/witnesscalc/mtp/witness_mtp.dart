...
import 'native_witness_mtp.dart';

@injectable
class WitnessMtpLib {
  static NativeWitnessMtpLib get _nativeWitnessMtpLib {
    return Platform.isAndroid
        ? NativeWitnessMtpLib(ffi.DynamicLibrary.open("libwitnesscalc_mtp.so"))
        : NativeWitnessMtpLib(ffi.DynamicLibrary.process());
  }
  ...
  Future<Uint8List?> calculateWitnessMtp(
    ...
    int result = _nativeWitnessMtpLib.witnesscalc_credentialAtomicQueryMTP(
        circuitBuffer,
        circuitSize,
        jsonBuffer,
        jsonSize,
